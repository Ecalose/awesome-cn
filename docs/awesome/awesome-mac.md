...
* [Typora](http://www.typora.io/) - 真正最小的 Markdown 编辑器，具有无缝的实时预览.
...
* [Joplin](https://joplinapp.org/)  - 具有降价支持的跨平台开源记事本和具有同步功能的待办事项列表管理器.  [![开源软件][OSS图标]](https://github.com/laurent22/joplin) ![免费软件][免费软件图标]
...
+ [OutlineEdit 3](https://outlineedit.com)  - 功能齐全的大纲编辑器，适合所有喜欢结构化笔记的人.  [![App Store][app-store Icon]](https://apps.apple.com/us/app/outlineedit-3/id1608887438)
...
* [Journey](https://journey.cloud/)  - 具有许多功能的日记应用程序以及适用于每个可用平台的应用程序.  [![App Store][app-store Icon]](https://apps.apple.com/us/app/journey-diary-journal/id1300202543)
...
* [NetBeans IDE](https://netbeans.org/)  - 免费和开源的IDE，主要用于Java开发，但支持许多其他语言和框架.  [![开源软件][OSS图标]](https://github.com/apache/netbeans) ![免费软件][免费软件图标]
...
* [BetterRename](http://www.publicspace.net/BetterRename/)  - 市场上最强大、最完整的 Mac 文件重命名应用程序.  [![App Store][app-store 图标]](https://apps.apple.com/us/app/better-rename-11/id1501308038)
...
* [HTTPie](https://httpie.io/) - HTTPie 正在为那些构建我们这个时代的工具的人提供简单和直观的 API.！[免费软件][免费软件图标]
#### Network Analysis
...
* [Proxie](https://proxie.app)  - HTTP 调试代理.  [![App Store][app-store Icon]](https://apps.apple.com/us/app/proxie/id897814548)
...
* [Navicat Data Modeler](https://www.navicat.com/en/products/navicat-data-modeler) - 强大且具有成本效益的数据库设计工具，可帮助您构建高质量的概念、逻辑和物理数据模型.
...
* [Colorpicker](https://colorpicker.fr/)  - Colorpicker 是一个完整的开源颜色操作工具，带有挑选功能！  [![开源软件][OSS图标]](https://github.com/toinane/colorpicker) ![免费软件][免费软件图标]
...
* [System Color Picker](https://github.com/sindresorhus/System-Color-Picker)  - macOS 颜色选择器作为具有更多功能的应用程序.  [![开源软件][OSS图标]](https://github.com/sindresorhus/System-Color-Picker) ![免费软件][免费软件图标] [![App Store][app-store图标] ](https://apps.apple.com/app/id1545870783)
...
* [Assetizr](https://assetizr.com)  - 调整图像大小并针对 Web 和移动应用程序进行优化.  ![免费软件][免费软件图标]
...
* [JPEGmini](http://www.jpegmini.com/) - 在不影响质量的情况下将图像尺寸减小多达 80%. 
...
* [qView](https://interversehq.com/qview/)  - qView 是一款以极简主义和可用性为设计理念的图像查看器.  [![开源软件][OSS图标] ![免费软件][免费软件图标]](https://github.com/jurplel/qView)
...
* [Ferdium](https://ferdium.org/)  - 桌面应用程序可帮助您通过将喜爱的应用程序组合到一个应用程序中来组织您如何使用它们. 它基于 Franz，不同之处在于 Ferdium 为您提供了许多附加功能并且不限制其使用.  [![开源软件][OSS图标] ![免费软件][免费软件图标]](https://github.com/ferdium/ferdium-app)
...
* [Skiff Mail](https://skiff.com/mail)  - 加密和分散式电子邮件——可在网络、iOS/Android 和 macOS 上使用.  ![免费软件][免费软件图标] [![开源软件][OSS图标]](https://github.com/skiff-org/skiff-mail)
...
* [Aegisub](https://github.com/Aegisub/Aegisub)  - 用于创建和修改字幕的免费跨平台开源工具.  Aegisub 可以快速轻松地为音频设置字幕，并提供许多强大的工具来设置它们的样式，包括内置的实时视频预览.  [![开源软件][OSS图标]](https://github.com/Aegisub/Aegisub/) ![免费软件][免费软件图标]
...
* [BeMyEars](https://www.bemyears.io/) - 免费为听力受损者提供系统范围的设备上实时字幕，多语言支持，就像您在任何地方都有 YouTube 字幕一样.
...
* [Cog](http://cogx.org/)  - 免费的开源音频播放器.  [![Open-Source Software][OSS Icon]](https://github.com/losnoco/cog) ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https: //apps.apple.com/us/app/cog-kode54/id1630499622)
...
* [LMMS](https://lmms.io)  - 前身为“Linux MultiMedia Studio”，LMMS 是一个功能强大的数字音频工作站，其设计类似于 FL Studio（前身为 Fruity Loops）.  [![开源软件][OSS图标]](https://github.com/lmms/lmms) ![免费软件][免费软件图标]
...
* [LyricsX](https://github.com/ddddxxx/LyricsX)  - iTunes、Spotify 和 Vox 的歌词.  [![开源软件][OSS图标]](https://github.com/ddddxxx/LyricsX) ![免费软件][免费软件图标]
...
* [Metadatics](http://markvapps.com/metadatics)  - 高级音频元数据编辑器.  [![App Store][app-store 图标]](https://apps.apple.com/us/app/metadatics/id554883654?mt=12)
...
* [Mullvad VPN](https://mullvad.net) - 注重隐私的 VPN，无需个人信息即可使用，不保留日志，并允许使用现金比特币、门罗币等进行支付.
...
* [Pure Paste](https://sindresorhus.com/pure-paste)  - 默认粘贴为纯文本.  ![免费软件][免费软件图标] [![App Store][应用商店图标]](https://apps.apple.com/app/id1611378436)
...
* [The Unarchiver](https://theunarchiver.com/)  - 取消归档许多不同类型的归档文件.  ![免费软件][免费软件图标] [![App Store][app-store 图标]](https://apps.apple.com/us/app/the-unarchiver/id425424353)
...
* [DevUtils.app](https://devutils.com/)  - 开发人员的多合一工具箱. 格式化/验证 JSON、编码/解码 Base64、转换时间戳、调试 JWT……只需一键！ 本机 macOS 应用程序和离线工作.  [![开源软件][OSS图标]](https://github.com/DevUtilsApp/DevUtils-app) ![免费软件][免费软件图标] [![App Store][app-store图标]]( https://apps.apple.com/us/app/devutils-app/id1533756032）
...
* [Dissolv](https://www.7sols.com/dissolv/)  - 隐藏和关闭不活动的应用程序.  [![App Store][app-store Icon]](https://apps.apple.com/app/dissolv/id1640893012)
...
* [Dashlane](https://www.dashlane.com) - 屡获殊荣的基于云的密码管理器.
...
* [Actions](https://github.com/sindresorhus/Actions)  - 为快捷方式应用程序提供许多有用的操作.  [![开源软件][OSS图标]](https://github.com/sindresorhus/Actions) ![免费软件][免费软件图标] [![App Store][app-store图标]](https: //apps.apple.com/app/id1586435171)
...
* [Grayscale Mode](https://github.com/rkbhochalya/grayscale-mode)  - 一个开源 macOS 应用程序，可让您直接从菜单栏或使用键盘快捷键 (⌥⌘G) 快速切换灰度过滤器.  [![开源软件][OSS图标]](https://github.com/rkbhochalya/grayscale-mode) ![免费软件][免费软件图标]
...
* [Core Tunnel](https://codinn.com/tunnel/)  - 用于管理 SSH 连接的应用程序.  [![App Store][app-store 图标]](https://apps.apple.com/us/app/core-tunnel/id1354318707)
...
* [QLMarkdown](https://github.com/sbarex/QLMarkdown)  - Markdown 文件的快速查看扩展.  - ![免费软件][免费软件图标] ![开源软件][OSS图标]
...
* [Syntax Highlight](https://github.com/sbarex/SourceCodeSyntaxHighlight)  - 突出显示源代码文件的快速查看扩展.  - ![免费软件][免费软件图标] ![开源软件][OSS图标]
