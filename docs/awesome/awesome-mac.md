...
 现在我们已经变得很大了，跟当初的想法不一样了.
在这里，我们收集了各种类别的很棒的 macOS 软件. 随时 **star** 和 **fork**.

有什么意见、建议吗？ [Let us know!](https://github.com/jaywcjlove/awesome-mac/issues) 我们喜欢 PR :) 请看一下 [contributing](https://github.com/jaywcjlove/awesome-mac/blob/master/CONTRIBUTING.md) guidelines before opening one. Follow the [awesome](https://github.com/sindresorhus/awesome) 列表.
...
![Open-Source Software][OSS Icon]表示**open source**，点击打开**open source** repo；\
![免费软件][免费软件图标]表示**免费**使用，或**免费**个人许可；\
![App Store][app-store Icon] 表示 **App store** 超链接；\
![Awesome List][awesome-list Icon] 表示指向该项目相应的**Awesome list** 的超链接；

 **适用于 macOS 的出色 Mac 应用程序**.  Mac 最新稳定版本的安装程序可以是 [downloaded here](https://github.com/jaywcjlove/amac/releases).
...
* [Lapce](https://lapce.dev/)  - 快如闪电且功能强大的代码编辑器.  [![开源软件][OSS 图标]](https://github.com/lapce/lapce) ![免费软件][免费软件图标]
* [LightTable](http://lighttable.com/)  - 下一代代码编辑器.  [![开源软件][OSS 图标]](https://github.com/LightTable/LightTable) ![免费软件][免费软件图标]
...
* [Vimr](http://vimr.org/) - 优化了 OS X 的 Vim 体验.[![开源软件][OSS 图标]](https://github.com/qvacua/vimr/) ![免费软件][免费软件图标]

#### Office

* [LibreOffice](https://www.libreoffice.org)  - LibreOffice 是免费的开源软件办公软件. 软件每天都由大量忠实的用户社区进行测试和使用.  [![开源软件][OSS 图标]](https://www.libreoffice.org/about-us/source-code/) ![免费软件][免费软件图标]
* [WPS](https://www.wps.com/mac)  - 是一个跨平台的办公软件套件.  ![免费软件][免费软件图标]
* [Pages](https://apps.apple.com/app/pages/id409201541?mt=12)  - 与众不同的文件.  ![免费软件][免费软件图标] [![App Store][app-store 图标]](https://apps.apple.com/app/pages/id409201541?mt=12)
* [Keynote](https://apps.apple.com/app/keynote/id409183694?mt=12)  - 制作令人惊叹的演示文稿.  ![免费软件][免费软件图标] [![App Store][app-store 图标]](https://apps.apple.com/app/keynote/id409183694?mt=12)
* [Numbers](https://apps.apple.com/app/numbers/id409203825?mt=12)  - 创建令人印象深刻的电子表格.  ![免费软件][免费软件图标] [![App Store][app-store 图标]](https://apps.apple.com/app/numbers/id409203825?mt=12)
...
* [OnlyOffice](https://www.onlyoffice.com/)  - 结合了文本、电子表格和演示文稿编辑器的办公套件，允许创建、查看和编辑本地文档.  [![开源软件][OSS 图标]](https://github.com/ONLYOFFICE/DesktopEditors) ![免费软件][免费软件图标]
...
* [iA Writer](https://ia.net/writer/) - 编写强调简单性和设计的应用程序.
...
* [Obsidian](https://obsidian.md) - 第二个大脑，为你，永远.
...
* [Logseq](https://logseq.com/)  - 隐私优先的开源知识库，在本地纯文本 Markdown 和 Org-mode 文件之上运行.  [![开源软件][OSS 图标]](https://github.com/logseq/logseq) ![免费软件][免费软件图标]
* [MarginNote](https://marginnote.com/) - 深入的 PDF 和 EPUB 阅读、学习、管理和笔记应用程序.
* [massCode](https://github.com/massCodeIO/massCode)  - 跨平台开源代码片段管理器，适用于具有降价和美人鱼支持的开发人员.  [![开源软件][OSS 图标]](https://github.com/massCodeIO/massCode) ![免费软件][免费软件图标]
* [MiaoYan](https://miaoyan.app/) - 轻量级 Markdown 应用，助你写出精彩句子. 
* [Notable](https://github.com/notable/notable) - 基于 markdown 的笔记应用程序，不吸.
...
* [NotePlan 3](https://noteplan.co/)  - 您的任务、笔记和日历，纯文本降价文件.  [![应用商店][应用商店图标]](https://apps.apple.com/en/app/noteplan-3/id1505432629)
* [Noteship](https://noteship.com)  - 将笔记转化为知识（电子表格视图、标题摘要等）. 离线工作，一切都保存在本地.  [![应用商店][应用商店图标]](https://apps.apple.com/us/app/notesip/id1571711347?mt=12)
* [Notion](https://www.notion.so/)  - 概念是多合一的工作空间. 从笔记、任务、wiki 到数据库，您只需要 Notion. 非常适合团队和个人.
...
+ [OutlineEdit 3](https://outlineedit.com)  - 功能齐全的大纲编辑器，适合所有喜欢结构化笔记的人.  [![应用商店][应用商店图标]](https://apps.apple.com/us/app/outlineedit-3/id1608887438)
...
* [Day One](https://dayoneapp.com/)  - 使用文本、照片、视频、音频、位置数据等的优秀日记应用程序.  [![应用商店][应用商店图标]](https://apps.apple.com/us/app/day-one/id1055511498?mt=12)
* [Journey](https://journey.cloud/)  - 具有许多功能和适用于每个可用平台的应用程序的日记应用程序.  [![应用商店][应用商店图标]](https://apps.apple.com/us/app/journey-diary-journal/id1300202543)
...
* [Klib](http://klib.me/)  - 管理 Kindle 和 iBooks 亮点的新方法.  ![免费软件][免费软件图标] [![App Store][app-store 图标]](https://itunes.apple.com/app/id1196268448?mt=12&amp;at=1000lv4R&amp;ct=klib_me)
...
* [Elytra](https://elytra.app) - 一个简单且私密的 RSS Feed 阅读器，具有适用于 macOS 和 iOS 的本机呈现 [![App Store][app-store Icon]](https://apps.apple.com/app/apple-store/id1433266971?pt=119194029&amp;ct =很棒的mac&amp;mt=8)
...
* [texifier](https://www.texifier.com/) - 适用于 Mac 的出色 LaTeX 编辑器，具有自动更新 PDF 和自动完成 LaTeX 命令.
* [UPDF](https://updf.com/)  - 免费的 PDF 编辑器，可以在 Mac 上阅读、注释和编辑 PDF，更改文本和图像.  ![免费软件][免费软件图标] [![App Store][app-store 图标]](https://apps.apple.com/app/id1619925971)
...
* [CodeRunner](https://coderunnerapp.com) - 轻型、多语言编程文本编辑器和 IDE，用于快速构建、运行和调试代码.
* [Deco IDE](https://www.decoide.org)  - 构建 React Native 应用程序的最佳 IDE.  [![开源软件][OSS 图标]](https://github.com/decosoftware/deco-ide) ![免费软件][免费软件图标]
* [Eclipse](https://www.eclipse.org)  - 流行的开源 IDE，主要用于 Java，但具有对多种语言和平台的插件支持.  ![开源软件][OSS 图标] ![免费软件][免费软件图标]
* [Espresso](http://espressoapp.com/)  - Mac 的网络编辑器回来了. 适合制作令人愉悦、创新且快速的网站的人.
* [JetBrains Toolbox App](https://www.jetbrains.com/toolbox/)  - 管理已安装的 JetBrains 工具、下载新工具并打开最近的项目.  ![免费软件][免费软件图标]
  ...
  * [DataGrip](http://www.jetbrains.com/datagrip/)  - 用于数据库和 SQL 的跨平台 IDE.  **学生免费**，检查 [here](https://www.jetbrains.com/student/) 获取更多信息.
...
* [Spyder](https://www.spyder-ide.org/) - 用 Python 编写的强大的科学环境，适用于 Python.

#### Developer Utilities

* [BetterRename](http://www.publicspace.net/BetterRename/)  - 市场上最强大、最完整的 Mac 文件重命名应用程序.  [![应用商店][应用商店图标]](https://apps.apple.com/us/app/better-rename-11/id1501308038)
* [Beyond Compare](http://www.scootersoftware.com/)  - 使用简单、强大的命令比较文件和文件夹，这些命令专注于您感兴趣的差异并忽略您不感兴趣的差异.  ![免费软件][免费软件图标]
...
* [canSnippet](https://www.cansnippet.com/) - 强大的片段管理工具，适用于整个操作系统，始终可通过简单的键盘快捷键访问.
...
* [MacSystemColors](https://github.com/kaunteya/MacSystemColors)  - 为 Cocoa 开发人员在浅色和深色模式下显示所有系统颜色的 Mac 应用程序.  [![开源软件][OSS 图标] ![免费软件][免费软件图标]](https://github.com/kaunteya/MacSystemColors)
...
* [SYM](https://github.com/zqqf16/SYM)  - 用于象征 iOS 崩溃日志的 GUI 应用程序.  [![开源软件][OSS 图标] ![免费软件][免费软件图标]](https://github.com/zqqf16/SYM)
* [TeXstudio](http://www.texstudio.org)  - 用于创建 LaTeX 文档的集成编写环境.  [![开源软件][OSS 图标]](https://sourceforge.net/projects/texstudio/) ![免费软件][免费软件图标]
...
* [zeplin](https://www.zeplin.io/)  - 用于设计师和开发人员之间工作的协作工具.  ![免费软件][免费软件图标]
...
* [He3](https://he3.app)  - 免费和现代的开发人员实用工具箱.  ![免费软件][免费软件图标]
...
* [Cocoa Rest Client](https://mmattozzi.github.io/cocoa-rest-client/)  - 用于测试 HTTP/REST 端点的免费、开源、原生 Apple OS X 应用程序.  [![开源软件][OSS 图标]](https://github.com/mmattozzi/cocoa-rest-client) ![免费软件][免费软件图标]
...
* [James](https://github.com/james-proxy/james)  - 用于使用 http 和 https 检查和映射请求的开源代理工具.  [![开源软件][OSS 图标]](https://github.com/james-proxy/james) ![免费软件][免费软件图标]
...
* [alacritty](https://github.com/jwilm/alacritty)  - 跨平台、GPU 加速的终端仿真器.  [![开源软件][OSS 图标]](https://github.com/jwilm/alacritty) ![免费软件][免费软件图标]
...
* [asciinema](https://github.com/asciinema/asciinema)  - 轻松记录终端会话并在终端和网络浏览器中重播.  [![开源软件][OSS 图标]](https://github.com/asciinema/asciinema) ![免费软件][免费软件图标]
* [autojump](https://github.com/wting/autojump/wiki)  - 将 `cd` 替换为智能自动跳转，以便从命令行轻松导航目录.  [![开源软件][OSS 图标]](https://github.com/wting/autojump) ![免费软件][免费软件图标]
* [bash-it](https://github.com/Bash-it/bash-it)  - 无耻地抄袭 oh-my-zsh 用于 bash.  ![开源软件][OSS 图标] ![免费软件][免费软件图标]
* [bat](https://github.com/sharkdp/bat)  - 带有语法高亮显示和 Git 集成的 `cat(1)` 克隆.  [![开源软件][OSS 图标]](https://github.com/sharkdp/bat) ![免费软件][免费软件图标]
* [cmus](https://cmus.github.io/)  - 适用于类 Unix 操作系统的小型、快速且功能强大的控制台音乐播放器.  [![开源软件][OSS 图标]](https://github.com/cmus) ![免费软件][免费软件图标]
* [cool-retro-term](https://github.com/Swordfish90/cool-retro-term)  - 模仿旧阴极显示器的漂亮终端仿真器.  [![开源软件][OSS 图标] ![免费软件][免费软件图标]](https://github.com/Swordfish90/cool-retro-term)
* [dark-mode](https://github.com/sindresorhus/dark-mode)  - 从命令行控制黑暗模式.  ![开源软件][OSS 图标] ![免费软件][免费软件图标]
...
* [GitHub CLI](https://github.com/cli/cli)  - gh 是命令行上的 GitHub. 它将拉取请求、问题和其他 GitHub 概念带到您已经使用 git 和您的代码的终端旁边.  ![开源软件][OSS 图标] ![免费软件][免费软件图标]
...
* [job](https://github.com/liujianping/job)  - JOB，让你的短期命令成为一项长期工作.  [![开源软件][OSS图标]](https://github.com/liujianping/job) ![免费软件][免费软件图标]
...
* [mycli](https://github.com/dbcli/mycli)  - MySQL 的 CLI，可以进行自动完成和语法突出显示.  [![开源软件][OSS 图标]](https://github.com/dbcli/mycli) ![免费软件][免费软件图标]
* [ndm](https://720kb.github.io/ndm/) - 管理 [npm](http://npmjs.org/) 直接从沙发上.  [![开源软件][OSS 图标]](https://github.com/720kb/ndm) ![免费软件][免费软件图标]
* [nushell](https://github.com/nushell/nushell)  - nushell 是一个用 Rust 编写的现代 GitHub 时代的 shell.  [![开源软件][OSS 图标]](https://sourceforge.net/projects/zsh/) ![免费软件][免费软件图标]
* [pgcli](https://www.pgcli.com)  - Pgcli 是 Postgres 的命令行界面，具有自动完成和语法突出显示功能.  [![开源软件][OSS 图标]](https://github.com/dbcli/pgcli) ![免费软件][免费软件图标]
* [Rebound](https://github.com/shobrook/rebound/)  - 当您遇到编译器错误时，立即在您的终端中浏览 Stack Overflow 结果.  ![开源软件][OSS 图标] ![免费软件][免费软件图标]
* [ripgrep (rg)](https://github.com/BurntSushi/ripgrep) - 类似于（但比）ack、ag 或 grep 更快的文本搜索工具！[免费软件][免费软件图标]
...
* [silver searcher (ag)](https://github.com/ggreer/the_silver_searcher)  - 类似ack的代码搜索工具，注重速度.  [![开源软件][OSS 图标]](https://github.com/ggreer/the_silver_searcher) ![免费软件][免费软件图标]
* [spaceship](https://github.com/denysdovhan/spaceship-prompt)  - 宇航员的 Zsh 提示符.  [![开源软件][OSS 图标]](https://github.com/denysdovhan/spaceship-prompt) ![免费软件][免费软件图标]
* [Tabby (formerly Terminus)](https://github.com/Eugeny/tabby)  - 免费的终端工具，使用 TypeScript 构建，深受 Hyper 的启发.  [![开源软件][OSS 图标]](https://github.com/Eugeny/terminus) ![免费软件][免费软件图标]
...
* [Termius](https://www.termius.com/)  - 免费的终端工具，媲美windows平台的xshell.  ![免费软件][免费软件图标] [![App Store][app-store 图标]](https://apps.apple.com/us/app/termius-terminal-ssh-client/id549039908)
...
* [VisiData](https://visidata.org)  - 用于发现和安排数据的终端电子表格多功能工具.  [![开源软件][OSS 图标]](https://github.com/saulpw/visidata) ![免费软件][免费软件图标]
* [Warp](https://www.warp.dev) - Warp 是一款速度极快、基于 Rust 的终端，从头开始重新设计，可以像现代应用程序一样工作.
...
* [xcodes](https://github.com/RobotsAndPencils/xcodes)  - 用于安装和切换多个版本的 Xcode 的命令行工具.  [![开源软件][OSS 图标] ![免费软件][免费软件图标]](https://github.com/RobotsAndPencils/xcodes)
* [xxh](https://github.com/xxh/xxh)  - 无论您通过 SSH 走到哪里，都带上您最喜欢的 shell.  [![开源软件][OSS 图标]](https://sourceforge.net/projects/zsh/) ![免费软件][免费软件图标]
...
* [ionic](http://ionicframework.com/)  - 使用 Angular 和开放网络技术构建令人惊叹的原生和渐进式网络应用程序. 一个应用程序运行在一切之上.  [![开源软件][OSS 图标]](https://github.com/driftyco/ionic) ![免费软件][免费软件图标]
...
* [nw.js](http://nwjs.io)  - 使用 HTML 和 JavaScript 构建桌面应用程序. 它允许您直接从 DOM 调用所有 Node.js 模块，并启用一种使用所有 Web 技术编写应用程序的新方法.  [![开源软件][OSS 图标] ![免费软件][免费软件图标]](https://github.com/nwjs/nw.js)
...
* [ReactXP](https://microsoft.github.io/reactxp/)  - 微软官方出品，支持平台Web、iOS、Android和Windows UWP仍在进行中.  [![开源软件][OSS 图标]](https://github.com/microsoft/reactxp) ![免费软件][免费软件图标]
...
* [Gitbar](https://github.com/Shikkic/gitbar)  - 开源，在你的菜单栏显示GitHub贡献统计.  [![开源软件][OSS 图标] ![免费软件][免费软件图标]](https://github.com/Shikkic/gitbar)
* [GitFinder](https://gitfinder.com/)  - 用于 Mac 的快速轻量级 Git 客户端，带有 Finder 集成.  ![免费软件][免费软件图标]
* [Gitfox](https://www.gitfox.app)  - 更快地提交，通过卓越的差异提高您的代码质量 - 并且看起来做得很好.  [![应用商店][应用商店图标]](https://apps.apple.com/app/gitfox/id1475511261)
...
* [Multipass](https://multipass.run/)  - 适用于任何工作站的 Ubuntu 虚拟机.  [![开源软件][OSS图标]](https://github.com/canonical/multipass)
* [Parallels](http://www.parallels.com/)  - 功能强大、易于使用的虚拟机. 每个新的 Mac OS 都没有免费升级.
* [QEMU](https://www.qemu.org/)  - 可以执行硬件虚拟化的免费开源模拟器和虚拟器.  [![开源软件][OSS 图标]](https://github.com/qemu/qemu) ![免费软件][免费软件图标]
...
* [Veertu](https://veertu.com)  - Mac 上最轻的虚拟机. 在 Mac 上运行 VM 的响应式、沙盒化和原生方式.  ![免费软件][免费软件图标]
...
* [Chrome MySQL Admin](https://github.com/yoichiro/chrome_mysql_admin)  - 强大的 Chrome 应用程序来管理您的 MySQL.  [![开源软件][OSS 图标] ![免费软件][免费软件图标]](https://github.com/yoichiro/chrome_mysql_admin)
...
* [FastoRedis](https://fastoredis.com/)  - Redis 的跨平台专业 GUI 管理工具.  [![开源软件][OSS 图标]](https://github.com/fastogt/fastoredis) ![免费软件][免费软件图标]
* [JackDB](https://www.jackdb.com/)  - 为您的查询和数据驱动的见解提供安全的协作环境.  [![开源软件][OSS 图标] ![免费软件][免费软件图标]](https://github.com/yoichiro/chrome_mysql_admin)
* [Keylord](https://protonail.com) - 用于 Redis、Bolt、LevelDB 和 Memcached 键值数据库的桌面 GUI 客户端.
...
* [pgModeler](https://pgmodeler.io)  - pgModeler 是为 PostgreSQL 设计的开源数据建模工具.  [![开源软件][OSS 图标]](https://github.com/pgmodeler/pgmodeler) ![免费软件][免费软件图标]
...
* [Sequel Pro](http://www.sequelpro.com/) - 用于 Mac OS X 的 MySQL 数据库管理. [![开源软件][OSS 图标]](https://github.com/sequelpro/sequelpro) ![免费软件][免费软件图标]
...
* [TablePlus](https://tableplus.io)  - 支持：PostgreSQL、MySQL、RedShift、MariaDB……高端安全保障.  [![开源软件][OSS 图标]](https://github.com/TablePlus/TablePlus) ![免费软件][免费软件图标]
* [redis-pro](https://github.com/cmushroom/redis-pro)  - 小巧易用的Redis管理，使用SwiftUI编写，支持Dark模式.  [![开源软件][OSS 图标]](https://github.com/cmushroom/redis-pro) ![免费软件][免费软件图标]
...
* [Inkscape](https://inkscape.org/en/)  - 专业矢量图形编辑器.  [![开源软件][OSS 图标]](https://launchpad.net/inkscape)
...
* [Monodraw](http://monodraw.helftone.com)  - 专为 Mac 设计的强大 ASCII 艺术编辑器.  [![应用商店][应用商店图标]](https://itunes.apple.com/app/monodraw/id920404675)
...
* [Pencil2D](https://www.pencil2d.org)  - 一个简单、直观的工具，用于制作 2D 手绘动画.  [![开源软件][OSS 图标]](https://github.com/pencil2d/pencil) ![免费软件][免费软件图标]
...
* [Sculptris](http://pixologic.com/sculptris/#)  - 3D 雕刻软件.  ![免费软件][免费软件图标]
* [Sketch](http://www.sketchapp.com/) - Mac 的专业数字设计.
    * [Sketch Cache Cleaner](https://yo-op.github.io/sketchcachecleaner/)  - 删除隐藏的 Sketch 历史文件，这些文件会占用您硬盘上的大量空间并且您可能永远不会使用这些文件.  [![开源软件][OSS 图标]](https://github.com/yo-op/sketchcachecleaner) ![免费软件][免费软件图标]
...
* [Vectornator: Design Software](https://www.vectornator.io/)  - 银河系中最直观、最精确的插图软件.  [![应用商店][应用商店图标]](https://apps.apple.com/us/app/vectornator-design-software/id1219074514)
* [Vectr](https://vectr.com/)  - 免费图形编辑器，用于轻松直观地创建矢量图形.  ![免费软件][免费软件图标]

#### Prototyping and Mind-Mapping Tools

* [Adobe XD (Experience Design)](http://www.adobe.com/products/experience-design.html) - 第一个用于网站和移动应用程序设计和原型制作的一体化跨平台工具.
...
* [Justinmind](http://www.justinmind.com) - 用于网络和移动应用程序的原型设计平台.
* [Kite](https://kiteapp.co/) - 适用于 Mac 和 iOS 的强大动画和原型制作应用程序.
* [Lighten](http://lighten.xmind.net/) - 澄清思路、提高生产力、集思广益和形象化概念的最佳方式.
* [Marvel](https://marvelapp.com/) - 简单的设计、原型制作和协作.！[免费软件][免费软件图标]
* [MindNode](https://mindnode.com/) - 强调简单易用的思维导图软件.
...
* [CloudApp](https://www.getcloudapp.com/)  - 以视觉速度工作.  ![免费软件][免费软件图标]
* [Flameshot](https://github.com/flameshot-org/flameshot)  - 功能强大但简单易用的屏幕截图软件.  ![开源软件][OSS 图标] ![免费软件][免费软件图标]
* [Gifox](https://gifox.app) - Gif 记录和分享.
...
* [Lightshot](https://app.prntscr.com/)  - 拍摄可自定义屏幕截图的最快方式.  ![免费软件][免费软件图标]
* [Monosnap](https://monosnap.com/)  - 制作屏幕截图. 在上面画画. 拍摄视频并分享您的文件. 它快速、简单且免费.  ![免费软件][免费软件图标] [![App Store][app-store 图标]](https://itunes.apple.com/app/monosnap/id540348655)
...
* [Teampaper Snap](http://teampaper.me/snap/)  - 让您的屏幕截图说话.  ![免费软件][免费软件图标] [![App Store][app-store 图标]](https://itunes.apple.com/app/monosnap/id1199502670)
...
* [Iconset](https://iconset.io) - 适用于 Mac 和 Windows 的免费、跨平台且快速的 SVG 图标管理器和管理器.
...
* [qView](https://interversehq.com/qview/)  - qView 是一款以极简主义和可用性为设计理念的图像查看器.  [![开源软件][OSS 图标] ![免费软件][免费软件图标]](https://github.com/jurplel/qView)
* [Resize Master](http://www.boltnev.com/resizemaster/)  - 快速轻松地批量调整图像大小并为其添加水印.  [![应用商店][应用商店图标]](https://itunes.apple.com/app/resize-master/id1025306797)
...
* [TinyPNG4Mac](https://github.com/kyleduo/TinyPNG4Mac)  - 用于压缩图像的开源工具.  [![开源软件][OSS 图标] ![免费软件][免费软件图标]](https://github.com/kyleduo/TinyPNG4Mac)
* [Tropy](https://tropy.org/)  - 研究照片管理.  [![开源软件][OSS 图标]](https://github.com/tropy/tropy) ![免费软件][免费软件图标]
* [PicGo](https://github.com/Molunerfinn/PicGo)  - 支持常用的cdn图片托管工具.  [![开源软件][OSS图标]](https://github.com/Molunerfinn/PicGo)
* [AppIconBuilder](https://itunes.apple.com/app/shotbuilder/id1294179975?mt=12) - 导出多平台图标[![App Store][app-store Icon]](https://itunes.apple.com/app/shotbuilder/id1294179975?mt=12)
* [uPic](https://github.com/gee1k/uPic)  - macOS 原生应用程序，强大简洁的图像托管客户端.  [![开源软件][OSS 图标] ![免费软件][免费软件图标]](https://github.com/gee1k/uPic)
...
* [Muzzle](https://muzzleapp.com/) - 一个简单的 Mac 应用程序，可在屏幕共享时静音令人尴尬的通知.
* [BlurScreen App](https://www.blurscreen.app)  - 在录制或屏幕共享时立即模糊屏幕上任何位置的敏感数据. 无需后期编辑.
* [Rambox](http://rambox.pro/)  - 将常见网络应用程序合二为一的消息和电子邮件应用程序.  [![开源软件][OSS 图标]](https://github.com/saenzramiro/rambox) ![免费软件][免费软件图标]
* [Element](https://element.io/)  - 创建，分享交流. 安全地聊天和通话.  [![开源软件][OSS 图标] ![免费软件][免费软件图标]](https://github.com/vector-im)
* [Presentify](https://presentify.compzets.com/)  - 一款可在通话时在屏幕上绘图、突出显示光标等的 Mac 应用程序.  ![应用商店][应用商店图标]
* [Signal Desktop](https://signal.org/download/)  - 快速、简单、安全. 装在口袋里的隐私.  [![开源软件][OSS图标]](https://github.com/signalapp/Signal-Desktop)
...
* [WhatsApp Desktop](https://itunes.apple.com/us/app/whatsapp-desktop/id1147396723?mt=12)  - 在 Mac App Store、Whatsapp for Desktop 中可用.  ![应用商店][应用商店图标]

#### Email Clients

* [Airmail](http://airmailapp.com)  - 快速电子邮件客户端. 适用于 Mac 操作系统和 iOS.
* [ElectronMail](https://github.com/vladimiry/ElectronMail)  - ProtonMail 的基于 Electron 的非官方桌面客户端.  [![开源软件][OSS 图标]](https://github.com/vladimiry/ElectronMail) ![免费软件][免费软件图标]
* [Foxmail](http://www.foxmail.com/mac/en)  - 快速电子邮件客户端.  ![免费软件][免费软件图标]
* [MailTags](https://smallcubed.com/) - 使用标签来组织电子邮件和日程安排.
...
* [Nylas Mail](https://nylas.com/nylas-mail/)  - 基于现代网络构建的可扩展桌面邮件应用程序.  [![开源软件][OSS 图标]](https://github.com/nylas/nylas-mail) ![免费软件][免费软件图标]
* [Polymail](https://polymail.io/)  - 简单、美观且功能强大的电子邮件客户端.  ![免费软件][免费软件图标]
* [Postbox](https://www.postbox-inc.com) - 强大、简洁、美观的邮件客户端，需要付费授权.
...
* [Cyberduck](https://cyberduck.io)  - 免费的 FTP、SFTP、WebDAV、S3、Backblaze B2、Azure 和 OpenStack Swift 浏览器.  ![免费软件][免费软件图标]
...
* [Data Rescue](https://www.prosofteng.com/mac-data-recovery) - 适用于大多数情况的综合专业数据恢复工具.
* [DiskWarrior](http://www.alsoft.com/DiskWarrior/) - 世界上最先进的 Mac 修复和恢复工具.
* [R-Studio for Mac](http://www.r-studio.com/data_recovery_macintosh/) - 恢复磁盘数据的强大工具，即使它们的分区被格式化、损坏或删除.
* [SuperDuper!](https://shirt-pocket.com/SuperDuper/SuperDuperDescription.html) - 无痛的完全可引导磁盘备份.
...
* [Audio Hijack](http://www.rogueamoeba.com/audiohijack/) - 录制任何应用程序的音频，包括来自 Skype 的 VoIP 通话、来自 Safari 的网络流等等.
* [BeMyEars](https://www.bemyears.io/) - 听障人士免费，系统范围内的设备实时字幕，多语言支持，就像你到处都有 YouTube 字幕一样.
...
* [Carol](https://github.com/AnaghSharma/Carol)  - 适用于 macOS 的简约而优美的歌词应用程序.  [![开源软件][OSS 图标]](https://github.com/AnaghSharma/Carol) ![免费软件][免费软件图标]
* [Cog](http://cogx.org/)  - 免费的开源音频播放器.  [![开源软件][OSS 图标]](https://github.com/losnoco/cog) ![免费软件][免费软件图标] [![App Store][app-store 图标]](https: //apps.apple.com/us/app/cog-kode54/id1630499622)
* [DaVinci Resolve](https://www.blackmagicdesign.com/products/davinciresolve/)  - 免费的跨平台视频编辑、颜色分级、视频效果和音频编辑软件.
* [Elmedia Player](https://mac.eltima.com/media-player.html) - 这款媒体播放器是一款超级通用的应用程序，适用于您可能想到的任何文件格式：支持 FLV、MP4、AVI、MOV、DAT、MKV、MP3、FLAC、M4V 以及许多其他格式.
* [FreeTube](https://freetubeapp.io/)  - 考虑到隐私而构建的开源桌面 YouTube 客户端.  [![开源软件][OSS 图标]](https://github.com/FreeTubeApp/FreeTube) ![免费软件][免费软件图标]
* [Gifski](https://github.com/sindresorhus/gifski-app)  - 将视频转换为高质量的 GIF.  ![开源软件][OSS 图标] ![免费软件][免费软件图标] [![App Store][app-store 图标]](https://itunes.apple.com/no/app/gifski/id1351639930公吨=12)
* [HandBrake](https://handbrake.fr/)  - 用于将视频从几乎任何格式转换为一系列现代、广泛支持的编解码器的工具.  [![开源软件][OSS图标]](https://github.com/HandBrake/HandBrake)
* [Hydrogen](http://hydrogen-music.org/)  - 专业但简单直观的基于模式的 GNU/Linux 鼓编程.  [![开源软件][OSS图标]](https://github.com/hydrogen-music/hydrogen)
* [ffWorks](https://www.ffworks.net/)  - 适用于 macOS 的综合媒体工具. 使每个人都可以访问高质量的视频编码.
* [IINA](https://lhc70000.github.io/iina/)  - 适用于 macOS 的现代视频播放器. 基于 mpv，强大的媒体播放器项目.  [![开源软件][OSS 图标]](https://github.com/lhc70000/iina) ![免费软件][免费软件图标]
* [Kodi](https://kodi.tv/)  - 屡获殊荣的免费开源 (GPL) 软件媒体中心，用于播放视频、音乐、图片、游戏等.  [![开源软件][OSS 图标]](https://github.com/xbmc/xbmc) ![免费软件][免费软件图标]
* [LMMS](https://lmms.io)  - 以前称为“Linux MultiMedia Studio”，LMMS 是一个功能强大的数字音频工作站，设计类似于 FL Studio（以前称为 Fruity Loops）.  [![开源软件][OSS 图标]](https://github.com/lmms/lmms) ![免费软件][免费软件图标]
* [LosslessCut](https://github.com/mifi/lossless-cut)  - 使用 ffmpeg 进行快速无损视频和音频修剪的跨平台工具.  [![开源软件][OSS 图标] ![免费软件][免费软件图标]](https://github.com/mifi/lossless-cut)
* [LyricsX](https://github.com/ddddxxx/LyricsX)  - iTunes、Spotify 和 Vox 的歌词.  [![开源软件][OSS 图标]](https://github.com/ddddxxx/LyricsX) ![免费软件][免费软件图标]
...
* [Sonora](https://github.com/sonoramac/Sonora)  - 简约、设计精美的音乐播放器.  [![开源软件][OSS 图标] ![免费软件][免费软件图标]](https://github.com/sonoramac/Sonora)
* [SpotMenu](https://github.com/kmikiy/SpotMenu)  - 菜单栏中的 Spotify 和 iTunes.  [![开源软件][OSS 图标]](https://github.com/kmikiy/SpotMenu) ![免费软件][免费软件图标]
...
* [NextCloud](https://nextcloud.com/) - 积极维护 ownCloud 的分支，更快且完全开源 [![开源软件][OSS 图标]](https://github.com/nextcloud)
...
* [Rocket](http://matthewpalmer.net/rocket/)  - 使用 Slack 风格的快捷方式让输入表情符号更快更轻松.  ![免费软件][免费软件图标]
...
* [Min](https://minbrowser.org/)  - 快速、精简的浏览器，保护您的隐私.  [![开源软件][OSS 图标]](https://github.com/minbrowser/min) ![免费软件][免费软件图标]
...
* [TorBrowser](https://www.torproject.org/projects/torbrowser.html)  - 在线匿名. 保护您的隐私. 防御网络监视和流量分析.  [![开源软件][OSS 图标] ![免费软件][免费软件图标]](https://gitweb.torproject.org/tor-browser.git)
...
* [Deadbolt](https://github.com/alichtman/deadbolt)  - 您将使用过的最简单的文件加密工具. 与 macOS 兼容且开源，因此值得您信赖.  [![开源软件][OSS 图标]](https://github.com/alichtman/deadbolt) ![免费软件][免费软件图标]

## Security Tools

* [Antivirus One](https://cleanerone.trendmicro.com/antivirus-one-for-mac/?utm_source=github&utm_medium=referral&utm_campaign=githubproject)  - 值得信赖的 Mac 安全保护：保护您的 Mac 免受病毒、恶意软件和广告软件的侵害. 阻止潜在的 Web 威胁并保护您的 Mac 免受漏洞侵害.！[免费软件][免费软件图标] [![App Store][app-store 图标]](https://apps.apple.com/app/apple-store/id1068435535 ?pt=444218&amp;ct=GitHub&amp;mt=8)
* [BlockBlock](https://objective-see.com/products/blockblock.html)  - 我：“只要有任何东西被永久安装，请提醒我.”  BlockBlock：“你明白了”
...
* [tigerVPN](https://www.tigervpn.com/vpn-for-mac)  - 适用于 Mac 的 VPN 客户端.  [![应用商店][应用商店图标]](https://apps.apple.com/us/app/vpn-plus/id1202726435)
* [Lantern](https://getlantern.org)  - 提供快速、可靠和安全访问开放互联网的免费应用程序.  [![开源软件][OSS 图标] ![免费软件][免费软件图标]](https://github.com/getlantern/lantern)
* [ShadowsocksX-NG](https://github.com/qiuyuzhou/ShadowsocksX-NG)  - 下一代 ShadowsocksX.  [![开源软件][OSS图标] ![免费软件][免费软件图标]](https://github.com/qiuyuzhou/ShadowsocksX-NG)
...
* [Windscribe](https://windscribe.com)  - 每月当场免费提供 10gb，并提供有限（免费）的位置控制. 连接也需要非常少的时间.
...
* [Mullvad VPN](https://mullvad.net) - 注重隐私的 VPN，使用时不需要个人信息，不保留日志，并允许使用 Cash Bitcoin、Monero 等进行支付.
...
* [Clipy](https://clipy-app.com/)  - Clipy 是适用于 macOS 的剪贴板扩展应用程序. 基于剪辑菜单.  [![开源软件][OSS 图标]](https://github.com/Clipy/Clipy) ![免费软件][免费软件图标]
* [CopyQ](https://hluk.github.io/CopyQ)  - 具有高级功能的剪贴板管理器.  [![开源软件][OSS 图标]](https://github.com/hluk/CopyQ) ![免费软件][免费软件图标]
* [iPaste](https://en.toolinbox.net/iPaste)  - 轻巧高效的剪贴板工具.  ![免费软件][免费软件图标] [![App Store][app-store 图标]](https://itunes.apple.com/app/id1056935452?ls=1&amp;mt=12&amp;at=1000lv4R&amp;ct=iPaste_me)
...
* [Anvil](https://anvilformac.com/)  - Anvil 是一个用于管理本地网站的精美菜单栏应用程序. 使用简单的 URL 和零配置提供静态站点和 Rack 应用程序.  ![免费软件][免费软件图标]
* [Bartender](https://www.macbartender.com) - 整理或隐藏 Mac 上的菜单栏图标.
* [BeardedSpice](https://github.com/beardedspice/beardedspice)  - 允许您使用 Mac 键盘上的媒体键控制基于网络的媒体播放器（SoundCloud、YouTube 等）和一些本机应用程序.  [![开源软件][OSS 图标]](https://github.com/beardedspice/beardedspice) ![免费软件][免费软件图标]
* [BitBar](https://getbitbar.com/)  - 将任何脚本或程序的输出直接放在 Mac OS X 菜单栏中.  [![开源软件][OSS 图标]](https://github.com/matryer/bitbar) ![免费软件][免费软件图标]
* [Dato](https://sindresorhus.com/dato)  - 带有日历、事件和时区的更好的菜单栏时钟.  [![应用商店][应用商店图标]](https://apps.apple.com/us/app/dato/id1470584107)
* [Dozer](https://github.com/Mortennn/Dozer)  - 隐藏 MacOS 菜单栏项目.  [![开源软件][OSS 图标] ![免费软件][免费软件图标]](https://github.com/Mortennn/Dozer)
* [Eye Timer](https://adelmaer.com/eyetimer)  - 休息一下以防止 Mac 的眼睛疲劳计时器.  [![应用商店][应用商店图标]](https://apps.apple.com/us/app/eye-timer/id1485856873)
* [Fishing Funds](https://ff.1zilc.top)  - 菜单栏显示中国基金实时走势.  [![开源软件][OSS 图标]](https://github.com/1zilc/fishing-funds) ![免费软件][免费软件图标]
* [Hidden](https://github.com/dwarvesf/hidden)  - 帮助隐藏菜单栏图标的超轻型 MacOS 实用程序.  [![开源软件][OSS 图标]](https://github.com/dwarvesf/hidden) ![免费软件][免费软件图标]
* [Hue in the Menu](https://apps.apple.com/gb/app/hue-in-the-menu/id1534707384)  - 菜单栏中的飞利浦 Hue 灯光管理，支持多房间.  [![App Store][应用商店图标]](https://apps.apple.com/gb/app/hue-in-the-menu/id1534707384) ![免费软件][免费软件图标]
...
* [Cloudflare WARP](https://1.1.1.1/)  - 用现代、优化的协议替换您的设备和 Internet 之间的连接.  ![免费软件][免费软件图标]
* [DNS Heaven](https://github.com/greenboxal/dns-heaven)  - 统一了 macOS DNS，因此使用 glibc 的应用程序可以使用本机堆栈解析 DNS. 主要用于 VPN.  [![开源软件][OSS 图标]](https://github.com/greenboxal/dns-heaven) ![免费软件][免费软件图标]
...
* [Day-O 2](http://www.shauninman.com/archive/2016/10/20/day_o_2_mac_menu_bar_clock)  - 内置日历的菜单栏时钟替换.  ![免费软件][免费软件图标]
* [Fantastical](https://flexibits.com/fantastical) - 您离不开的日历应用程序.
* [Focus](https://masterbuilders.io)  - 漂亮的基于番茄钟的时间管理器.  [![应用商店][应用商店图标]](https://itunes.apple.com/us/app/focus-productivity-timer/id777233759?mt=12)
* [Focused Work: Focus Timer](https://focusedwork.app)  - 一个简单、灵活的 Focus Timer.  [![应用商店][应用商店图标]](https://apps.apple.com/us/app/focused-work-focus-timer/id1523968394?uo=4)
...
* [Nozbe](https://nozbe.com)  - 适用于个人和团队的强大 GTD 应用程序，支持所有 Apple 设备（Mac、iPhone、iPad、Watch）.  [![应用商店][应用商店图标]](https://itunes.apple.com/pl/app/nozbe-tasks-projects-team/id508957583?mt=12)
...
* [Clovery](https://clovery.app)  - 将您最喜爱的所有 Google 服务与您的 Mac 紧密集成，让您快速访问这些服务并提高工作效率.  [![开源软件][OSS 图标]](https://github.com/webcatalog/neutron) [![App Store][app-store 图标]](https://apps.apple.com/我们/app/clovery-for-google-apps/id1552618413）
...
* [Karabiner](https://pqrs.org/osx/karabiner/) - 适用于 OS X 的强大而稳定的键盘定制器.[![开源软件][OSS 图标] ![免费软件][免费软件图标]](https://github.com/tekezo/Karabiner)
* [Keyboard Maestro](http://www.keyboardmaestro.com) - 根据来自键盘、菜单、位置、添加的设备等的触发器自动执行例行操作.
...
* [SensibleSideButtons](http://sensible-side-buttons.archagon.net)  - 在许多应用程序中，例如在 Windows 中，使用鼠标的侧边按钮向前和向后移动.  [![开源软件][OSS 图标]](https://github.com/archagon/sensible-side-buttons)
* [nnScreenshots](https://www.nearnorthsoftware.com/software/screenshots.php)  - 一种超级简单的方法来保存您的工作效率的可视化记录，以便更轻松地填写时间表或只是帮助您回顾一天. 内置时间表编辑器.
...
* [Pomodoro Cycle](https://github.com/jet8a/pomodoro-cycle-app) - 番茄钟追踪器
* [Workspaces](https://www.apptorium.com/workspaces)  - 工作区使您能够在不同类型的任务之间快速切换. 它允许您在选择工作区时选择要打开和关闭的应用程序.  [![应用商店][应用商店图标]](https://apps.apple.com/se/app/workspaces-2/id1540284555?mt=12)
...
* [contexts](https://contexts.co/)  - 提供比原生 Mac Dock 更强大的功能. 特别是当你有多个屏幕时，它可以帮助你更快速地切换.
* [Dissolv](https://www.7sols.com/dissolv/)  - 隐藏和关闭不活动的应用程序.  [![应用商店][应用商店图标]](https://apps.apple.com/app/dissolv/id1640893012)
* [Divvy](http://mizage.com/divvy/) - 通过其惊人的 Divvy Grid 系统实现最佳的窗口管理.
* [Hummingbird](https://hummingbirdapp.site/) - 无需点击鼠标即可从窗口内的任何位置轻松移动窗口和调整窗口大小.
* [IntelliDock](https://mightymac.app/intellidock/) - 自动隐藏 Dock.
* [Magnet](http://magnet.crowdcafe.com/)  - 让您的工作空间井井有条的窗口管理器.  [![应用商店][应用商店图标]](https://itunes.apple.com/us/app/id441258766)
* [Moom](http://manytricks.com/moom/) - 允许您使用鼠标或键盘轻松移动和缩放窗口，或移动到另一个显示器.
* [rcmd](https://lowtechguys.com/rcmd/)  - 使用<kbd>⌘ Right Command</kbd>键根据名称切换应用程序.  [![应用商店][应用商店图标]](https://apps.apple.com/us/app/rcmd-app-switcher/id1596283165)
* [Rectangle](https://rectangleapp.com)  - 基于 Spectacle 的窗口管理应用程序，用 Swift 编写.  [![开源软件][OSS 图标]](https://github.com/rxhanson/Rectangle) ![免费软件][免费软件图标]
...
* [Authy](https://authy.com)  - 双因素身份验证令牌管理器，可在您的设备之间备份和同步.  ![免费软件][免费软件图标]
* [Bitwarden](https://bitwarden.com)  - 适用于 Mac OS、iOS 和浏览器的开源密码管理工具.  [![开源软件][OSS 图标]](https://github.com/bitwarden) ![免费软件][免费软件图标]
...
* [Actions](https://github.com/sindresorhus/Actions)  - 为快捷方式应用程序提供许多有用的操作.  [![开源软件][OSS 图标]](https://github.com/sindresorhus/Actions) ![免费软件][免费软件图标] [![App Store][app-store 图标]](https: //apps.apple.com/app/id1586435171)
* [CheatSheet](https://www.mediaatelier.com/CheatSheet/)  - 按住 ⌘ 键可获取当前应用程序所有活动快捷方式的列表. 就这么简单.  ![免费软件][免费软件图标]
* [DisplayBuddy](https://displaybuddy.app) - 直接从 Mac 控制外部显示器的亮度、对比度、输入源等.
* [f.lux](https://justgetflux.com/)  - 使计算机显示屏的颜色适应一天中的时间.  ![免费软件][免费软件图标]
* [Lunar](https://lunar.fyi/)  - 帮助您调整外部显示器的亮度、对比度和音量.  [![开源软件][OSS 图标]](https://github.com/alin23/Lunar) ![免费软件][免费软件图标]
* [Grayscale Mode](https://github.com/rkbhochalya/grayscale-mode)  - 一款开源 macOS 应用程序，可让您直接从菜单栏或使用键盘快捷键 (⌥⌘G) 快速切换灰度滤镜.  [![开源软件][OSS 图标]](https://github.com/rkbhochalya/grayscale-mode) ![免费软件][免费软件图标]
* [KeyCastr](https://github.com/keycastr/keycastr)  - 开源击键可视化工具.  [![开源软件][OSS 图标]](https://github.com/keycastr/keycastr) ![免费软件][免费软件图标]
* [NightOwl](https://nightowl.kramser.xyz/)  - 按一天中的时间或使用菜单栏或键盘快捷键在 macOS Mojave 的浅色和深色主题之间自动切换.  ![免费软件][免费软件图标]
* [One Switch](https://fireball.studio/oneswitch) - Mac 菜单栏应用程序，将各种开关添加到 Mac 的菜单栏.
* [Shifty](http://shifty.natethompson.io)  - 一款 macOS 菜单栏应用程序，可让您更好地控制 Night Shift.  [![开源软件][OSS 图标]](https://github.com/thompsonate/Shifty)
...
* [Shareful](https://sindresorhus.com/shareful)  - 通过复制、保存和打开操作增强系统共享菜单.  ![免费软件][免费软件图标] [![App Store][app-store 图标]](https://apps.apple.com/app/id1522267256)
...
* [Gray](https://github.com/zenangst/Gray)  - 单击按钮，在每个应用程序的基础上选择浅色外观和深色外观.  ![免费软件][免费软件图标] [![开源软件][OSS 图标]](https://github.com/zenangst/Gray)
...
* [Juice](https://github.com/brianmichel/Juice)  - 让你的电池信息更有趣一点.  [![开源软件][OSS 图标]](https://github.com/brianmichel/Juice) ![免费软件][免费软件图标]
* [KeepingYouAwake](https://github.com/newmarcel/KeepingYouAwake)  - 咖啡因的替代品，更好地支持 Mac 中的暗模式.  [![开源软件][OSS图标]](https://github.com/newmarcel/KeepingYouAwake)
* [Monity](http://www.monityapp.com/) - 适用于 OS X 的系统监控小部件.
* [Mounty](http://enjoygineering.com/mounty/)  - 在 Mac OS X 10.9+ 下以读写模式重新安装写保护的 NTFS 卷的微型工具.  ![免费软件][免费软件图标]
...
* [PPSSPP](https://www.ppsspp.org)  - 适用于您梦寐以求的任何操作系统的超棒 PSP 模拟器！  [![开源软件][OSS 图标] ![免费软件][免费软件图标]](https://github.com/hrydgard/ppsspp)
* [RPCS3](https://rpcs3.net) - 开源 PlayStation 3 模拟器 [![开源软件][OSS 图标] ![免费软件][免费软件图标]](https://github.com/RPCS3/rpcs3)

## Remote Login Software

* [RustDesk](https://rustdesk.com/)  - 另一个远程桌面软件.  [![开源软件][OSS 图标]](https://github.com/rustdesk/rustdesk) ![免费软件][免费软件图标]
* [AnyDesk](https://anydesk.com) - 提供跨多台机器的远程访问.
* [Microsoft Remote Desktop](https://apps.apple.com/us/app/microsoft-remote-desktop/id1295203466)  - 连接到管理员提供的远程 PC 或虚拟应用程序和桌面.  ![免费软件][免费软件图标]
* [RealVNC](https://www.realvnc.com) - 用于跨桌面和移动设备进行远程访问的原创和最佳软件.
* [RoyalTSX](https://www.royalapps.com/ts/mac/features)  - Royal TSX 是系统工程师和其他需要使用不同协议远程访问系统的 IT 专业人员的理想工具.  ![免费软件][免费软件图标]
* [TeamViewer](https://www.teamviewer.com/en)  - 专有的计算机软件包，用于远程控制、桌面共享、在线会议、网络会议和计算机之间的文件传输.  ![免费软件][免费软件图标]
...
* [QLMarkdown](https://github.com/sbarex/QLMarkdown)  - Markdown 文件的快速查看扩展.  - ![免费软件][免费软件图标] ![开源软件][OSS 图标]
...
* [Syntax Highlight](https://github.com/sbarex/SourceCodeSyntaxHighlight)  - 突出显示源代码文件的快速查看扩展.  - ![免费软件][免费软件图标] ![开源软件][OSS 图标]

## Third Party App Markets

如果您遇到提供盗版软件或破解软件的网站，请发帖 [HERE](https://github.com/jaywcjlove/awesome-mac/issues/17). We love apps, but only authentic ones. :)

* [Setapp](https://setapp.com) - 一个套件中适用于 Mac 的最佳应用程序.
...
* [Homebrew](https://brew.sh/)  - 缺少 macOS 包管理器.  ![免费软件][免费软件图标] [![开源软件][OSS 图标]](https://github.com/Homebrew/brew/)
* [MacPorts](https://www.macports.org/)  - 开源社区倡议，旨在设计一个易于使用的系统，用于在 Mac OS X 操作系统上编译、安装和升级基于命令行、X11 或 Aqua 的开源软件.  ![免费软件][免费软件图标] [![开源软件][OSS 图标]](https://github.com/macports/)
...
* [alternativeTo](http://alternativeto.net/)  - 也是一个非常好的社区. 如果您正在寻找一些**用于** Windows 或其他平台的替代应用程序，请查看此站点.
* [Slant](https://www.slant.co)  - 我个人推荐这个. 这是一个您可以并排比较应用程序的平台，您可能会通过查看其他用户的推荐来获得一个想法. 如果您从此列表中找到应用程序，请贡献！
...
* [Mac Power Users](https://www.relay.fm/mpu)  - 通过重点主题和工作流程来宾，了解如何充分利用您的 Apple 技术.  ![免费软件][免费软件图标] [![App Store][app-store 图标]](https://itunes.apple.com/podcast/mac-power-users/id458066753)
