...
* [snowball](https://github.com/tebeka/snowball) - Go 的滚雪球投票.
...
* [CogcompNLP](https://github.com/CogComp/cogcomp-nlp) - 该项目收集了伊利诺伊大学认知计算组开发的多个用于自然语言处理（NLP）的核心库，例如 `illinois-core-utilities`，它提供了一组对 NLP 友好的数据结构和一些支持编写 NLP 应用程序、运行实验等的 NLP 相关实用程序，`illinois-edison` 是一个用于从 illinois-core-utilities 数据结构和许多其他包中提取特征的库.
...
* [Auto ML](https://github.com/ClimbsRocks/auto_ml)  - 用于竞赛和探索的自动机器学习、数据格式化、集成和超参数优化 - 只需给它一个 .csv 文件！  **[弃用]**
...
* [Pattern Recognition and Machine Learning](https://github.com/PRML/PRMLT) - 该软件包包含 C. Bishop 的模式识别和机器学习一书中描述的算法的 matlab 实现.
...
* [PyNLPl](https://github.com/proycon/pynlpl)  - Python 自然语言处理库. 用于 Python 的通用 NLP 库. 还包含一些用于解析常见 NLP 格式的特定模块，最值得注意的是 [FoLiA](https://proycon.github.io/folia/), but also ARPA language models, Moses phrasetables, GIZA++ alignments.
 ...
 * [PyTorch Geometric Temporal](https://github.com/benedekrozemberczki/pytorch_geometric_temporal) -&gt; PyTorch Geometric 的时间扩展，用于动态图形表示学习.
...
* [Auto_ViML](https://github.com/AutoViML/Auto_ViML)  -&gt; 快速自动构建变体可解释 ML 模型！  Auto_ViML 发音为“auto vimal”，是一个全面且可扩展的 Python AutoML 工具包，具有不平衡处理、集成、堆叠和内置功能选择. 在<a href="https://towardsdatascience.com/why-automl-is-an-essential-new-tool-for-data-scientists-2d9ab4e25e46?source=friends_link&sk=d03a0cc55c23deb497d546d6b9be0653">Medium 文章中</a>精选.
* [PyOD](https://github.com/yzhao062/pyod)  -&gt; Python 异常值检测，全面且可扩展的 Python 工具包，用于检测多变量数据中的异常对象. 以高级模型为特色，包括神经网络/深度学习和异常值集成.
* [steppy](https://github.com/neptune-ml/steppy)  -&gt; 轻量级的 Python 库，用于快速且可重现的机器学习实验. 引入了一个非常简单的界面，可以实现干净的机器学习管道设计.
...
* [auto_ml](https://github.com/ClimbsRocks/auto_ml)  - 用于生产和分析的自动化机器学习. 让您专注于 ML 的有趣部分，同时输出生产就绪代码以及数据集和结果的详细分析. 包括对 NLP、XGBoost、CatBoost、LightGBM 以及即将推出的深度学习的支持.
* [dtaidistance](https://github.com/wannesm/dtaidistance) - 用于时间序列距离 (DTW) 和时间序列聚类的高性能库.
* [einops](https://github.com/arogozhnikov/einops) - 重塑深度学习操作（针对 pytorch、tensorflow、jax 等）.
...
* [XGBoost](https://github.com/dmlc/xgboost) - 用于 eXtreme Gradient Boosting（树）库的 Python 绑定.
* [ChefBoost](https://github.com/serengil/chefboost)  - 用于 Python 的轻型决策树框架，具有分类特征支持，涵盖常规决策树算法，如 ID3、C4.5、CART、CHAID 和回归树； 还有一些先进的 bagging 和 boosting 技术，例如 gradient boosting、random forest 和 adaboost.
...
* [scikit-learn](https://scikit-learn.org/) - 一个建立在 SciPy 之上的用于机器学习的 Python 模块.
...
* [Intel(R) Extension for Scikit-learn](https://github.com/intel/scikit-learn-intelex) - 一种无缝方式来加速您的 Scikit-learn 应用程序，而不会损失准确性和更改代码.
* [SimpleAI](https://github.com/simpleai-team/simpleai)  《人工智能，一种现代方法》一书中描述的许多人工智能算法的 Python 实现. 它专注于提供易于使用、文档齐全且经过测试的库.
* [astroML](https://www.astroml.org/) - 天文学机器学习和数据挖掘.
* [graphlab-create](https://turi.com/products/create/docs/) - 在磁盘支持的 DataFrame 之上实现的具有各种机器学习模型（回归、聚类、推荐系统、图形分析等）的库.
* [BigML](https://bigml.com) - 联系外部服务器的图书馆.
* [pattern](https://github.com/clips/pattern) - 用于 Python 的 Web 挖掘模块.
* [NuPIC](https://github.com/numenta/nupic) - Numenta 智能计算平台.
* [Pylearn2](https://github.com/lisa-lab/pylearn2) - 基于的机器学习库 [Theano](https://github.com/Theano/Theano) .  **[弃用]**
...
* [hebel](https://github.com/hannes-brt/hebel)  - Python 中的 GPU 加速深度学习库.  **[弃用]**
...
* [topik](https://github.com/ContinuumIO/topik)  - 主题建模工具包.  **[弃用]**
...
* [Bolt](https://github.com/pprett/bolt)  - 螺栓在线学习工具箱.  **[弃用]**
* [CoverTree](https://github.com/patvarilly/CoverTree) - 覆盖树的 Python 实现，scipy.spatial.kdtree 的近距离替换 **[已弃用]**
* [nilearn](https://github.com/nilearn/nilearn) - Python 神经成像机器学习.
* [neuropredict](https://github.com/raamana/neuropredict)  - 针对新手机器学习者和非专家程序员，此软件包提供简单（无需编码）和全面的机器学习（评估和预测性能的完整报告，无需您编写代码）用于神经成像和任何其他类型的功能的 Python. 与 nilearn 和 pymvpa 等其他软件包不同，这旨在吸收大部分 ML 工作流，后者需要您学习它们的 API 和代码才能生成任何有用的东西.
...
* [Shogun](https://github.com/shogun-toolbox/shogun) - Shogun 机器学习工具箱.
* [Pyevolve](https://github.com/perone/Pyevolve)  - 遗传算法框架.  **[弃用]**
* [Caffe](https://github.com/BVLC/caffe) - 一个深度学习框架，开发时考虑到了简洁性、可读性和速度.
* [breze](https://github.com/breze-no-salt/breze) - 基于 Theano 的深度和递归神经网络库.
* [Cortex](https://github.com/cortexlabs/cortex) - 用于在生产中部署机器学习模型的开源平台.
* [pyhsmm](https://github.com/mattjj/pyhsmm) - 用于贝叶斯隐马尔可夫模型 (HMM) 和显式持续时间隐半马尔可夫模型 (HSMM) 中的近似无监督推理的库，侧重于贝叶斯非参数扩展、HDP-HMM 和 HDP-HSMM，主要具有弱极限近似.
* [SKLL](https://github.com/EducationalTestingService/skll) - 围绕 scikit-learn 的包装器，使进行实验变得更简单.
* [neurolab](https://github.com/zueve/neurolab)
* [Spearmint](https://github.com/HIPS/Spearmint)  - Spearmint 是一个根据论文中概述的算法执行贝叶斯优化的包：机器学习算法的实用贝叶斯优化.  Jasper Snoek、Hugo Larochelle 和 Ryan P. Adams. 神经信息处理系统进展，2012 年.**[已弃用]**
* [Pebl](https://github.com/abhik/pebl/)  - 用于贝叶斯学习的 Python 环境.  **[弃用]**
...
* [python-timbl](https://github.com/proycon/python-timbl)  - 一个包含完整 TiMBL C++ 编程接口的 Python 扩展模块.  Timbl 是一个精心设计的 k-最近邻机器学习工具包.
* [deap](https://github.com/deap/deap) - 进化算法框架.
* [pydeep](https://github.com/andersbll/deeppy)  - Python 深度学习.  **[弃用]**
* [mlxtend](https://github.com/rasbt/mlxtend) - 一个包含用于数据科学和机器学习任务的有用工具的库.
* [neon](https://github.com/NervanaSystems/neon) - 涅瓦纳 [high-performance](https://github.com/soumith/convnet-benchmarks) 基于 Python 的深度学习框架 [DEEP LEARNING].  **[弃用]**
* [Optunity](https://optunity.readthedocs.io/en/latest/) - 一个专门用于自动超参数优化的库，具有简单、轻量级的 API，以促进网格搜索的直接替换.
* [Neural Networks and Deep Learning](https://github.com/mnielsen/neural-networks-and-deep-learning) - 我的书“神经网络和深度学习”[深度学习] 的代码示例.
* [Annoy](https://github.com/spotify/annoy) - 近似最近邻实施.
* [TPOT](https://github.com/EpistasisLab/tpot)  - 使用遗传编程自动创建和优化机器学习管道的工具. 将其视为您的个人数据科学助手，自动执行机器学习中繁琐的部分.
...
* [MXNet](https://github.com/apache/incubator-mxnet)  - 轻量级、便携、灵活的分布式/移动深度学习，具有动态、变异感知数据流 Dep 调度程序； 适用于 Python、R、Julia、Go、JavaScript 等.
* [milk](https://github.com/luispedro/milk)  - 专注于监督分类的机器学习工具包.  **[弃用]**
* [TFLearn](https://github.com/tflearn/tflearn) - 深度学习库，具有更高级别的 TensorFlow API.
* [REP](https://github.com/yandex/rep)  - 基于 IPython 的环境，用于以一致且可重现的方式进行数据驱动的研究.  REP 并不是要替代 scikit-learn，而是要对其进行扩展并提供更好的用户体验.  **[弃用]**
* [rgf_python](https://github.com/RGF-team/rgf) - 正则化贪婪森林（树）库的 Python 绑定.
* [skbayes](https://github.com/AmazaspShumik/sklearn-bayes) - 用于带有 scikit-learn API 的贝叶斯机器学习的 Python 包.
* [fuku-ml](https://github.com/fukuball/fuku-ml) - 简单的机器学习库，包括Perceptron、Regression、Support Vector Machine、Decision Tree等，对于初学者来说简单易学.
...
* [PyTorch Lightning Bolts](https://github.com/PyTorchLightning/pytorch-lightning-bolts) - AI/ML 研究人员的模型、回调和数据集工具箱.
* [skorch](https://github.com/skorch-dev/skorch) - 包装 PyTorch 的 scikit-learn 兼容神经网络库.
* [ML-From-Scratch](https://github.com/eriklindernoren/ML-From-Scratch)  - 在 Python 中从头开始实施机器学习模型，重点是透明度. 旨在以易于访问的方式展示 ML 的具体细节.
...
* [CatBoost](https://github.com/catboost/catboost)  - 开箱即用的具有分类特征支持的决策树库的通用梯度提升. 它易于安装，文档齐全，支持 CPU 和 GPU（甚至是多 GPU）计算.
* [stacked_generalization](https://github.com/fukatani/stacked_generalization) - 机器学习堆叠技术的实现作为 Python 中的一个方便的库.
* [modAL](https://github.com/modAL-python/modAL) - 基于 scikit-learn 构建的 Python 模块化主动学习框架.
* [Cogitare](https://github.com/cogitare-ai/cogitare)：一个现代、快速、模块化的 Python 深度学习和机器学习框架.
...
* [xLearn](https://github.com/aksnzhy/xlearn)  - 高性能、易用、可扩展的机器学习包，可用于解决大规模机器学习问题.  xLearn 对于解决大规模稀疏数据上的机器学习问题特别有用，这在在线广告和推荐系统等互联网服务中非常常见.
* [mlens](https://github.com/flennerhag/mlens) - 高性能、内存高效、最大程度并行化的集成学习，与 scikit-learn 集成.
...
* [StellarGraph](https://github.com/stellargraph/stellargraph): Machine Learning on Graphs，一个用于图结构（网络结构）数据机器学习的 Python 库.
* [BentoML](https://github.com/bentoml/bentoml): 用于打包和部署用于生产服务的机器学习模型的工具包
...
* [Neuraxle](https://github.com/Neuraxio/Neuraxle)：一个提供正确抽象以简化 ML 管道的研究、开发和部署的框架.
...
* [Gradio](https://github.com/gradio-app/gradio)  - 用于快速创建和共享模型演示的 Python 库. 在浏览器中以交互方式调试模型，从协作者那里获得反馈，并在不部署任何东西的情况下生成公共链接.
* [Hub](https://github.com/activeloopai/Hub)  - TensorFlow/PyTorch 最快的非结构化数据集管理. 流和版本控制数据. 甚至可以将 PB 级数据存储在云端的单个类似 numpy 的数组中，任何机器都可以访问. 访问 [activeloop.ai](https://activeloop.ai) 获取更多信息.
* [Synthia](https://github.com/dmey/synthia) - Python 中的多维合成数据生成.
* [ByteHub](https://github.com/bytehub-ai/bytehub)  - 一个易于使用的、基于 Python 的特征存储. 针对时间序列数据进行了优化.
* [Backprop](https://github.com/backprop-ai/backprop) - Backprop 使最先进的 ML 模型的使用、微调和部署变得简单.
...
* [Deepchecks](https://github.com/deepchecks/deepchecks) ：在模型开发、部署和生产期间验证和测试机器学习模型和数据. 这包括与各种问题相关的检查和套件，例如模型性能、数据完整性、分布不匹配等.
* [Shapash](https://github.com/MAIF/shapash) ：Shapash 是一个 Python 库，它提供多种类型的可视化，显示每个人都能理解的明确标签.
...
* [AutoViz](https://github.com/AutoViML/AutoViz)  AutoViz 使用单行 Python 代码对任何数据集执行自动可视化. 给它任何大小的任何输入文件（CSV、txt 或 JSON），AutoViz 将可视化它. 请参阅<a href="https://towardsdatascience.com/autoviz-a-new-tool-for-automated-visualization-ec9c1744a6ad?source=friends_link&sk=c9e9503ec424b191c6096d7e3f515d10">中篇文章</a>.
* [Numba](https://numba.pydata.org/) - Python JIT（及时）编译器到 LLVM，旨在由 Cython 和 NumPy 的开发人员开发科学 Python.
...
* [ParaMonte](https://github.com/cdslaborg/paramonte)  - 通过串行/并行蒙特卡洛和 MCMC 模拟进行贝叶斯数据分析和可视化的通用 Python 库. 可以找到文档 [here](https://www.cdslab.org/paramonte/).
* [Vaex](https://github.com/vaexio/vaex)  - 用于惰性 Out-of-Core DataFrames（类似于 Pandas）的高性能 Python 库，用于可视化和探索大型表格数据集. 可以找到文档 [here](https://vaex.io/docs/index.html).
...
* [PyDy](https://www.pydy.org/) - Python Dynamics 的缩写，用于协助基于 NumPy、SciPy、IPython 和 matplotlib 的动态运动建模工作流.
...
* [pycascading](https://github.com/twitter/pycascading) **[弃用]**
...
* [cerebro2](https://github.com/numenta/nupic.cerebro2) 一个基于网络的 NuPIC 可视化和调试平台.  **[弃用]**
* [NuPIC Studio](https://github.com/htm-community/nupic.studio) 一个一体化的 NuPIC 分层时间记忆可视化和调试超级工具！  **[弃用]**
* [SparklingPandas](https://github.com/sparklingpandas/sparklingpandas) PySpark 上的熊猫 (POPS).
...
* [Dora](https://github.com/nathanepstein/dora) - Python 探索性数据分析工具.
* [Ruffus](http://www.ruffus.org.uk) - python 的计算管道库.
* [SOMPY](https://github.com/sevamoo/SOMPY) - 用 Python 编写的自组织地图（使用神经网络进行数据分析）.
* [somoclu](https://github.com/peterwittek/somoclu) 大规模并行自组织映射：加速多核 CPU、GPU 和集群的训练，具有 Python API.
* [HDBScan](https://github.com/lmcinnes/hdbscan) - 在 Python 中实现 hdbscan 算法 - 用于聚类
* [visualize_ML](https://github.com/ayush1997/visualize_ML)  - 用于数据探索和数据分析的 python 包.  **[弃用]**
...
* [lime](https://github.com/marcotcr/lime)  - Lime 是关于解释机器学习分类器（或模型）在做什么. 它能够解释任何具有两个或更多类别的黑盒分类器.
* [PyCM](https://github.com/sepandhaghighi/pycm) - PyCM是一个用Python编写的多类混淆矩阵库，同时支持输入数据向量和直接矩阵，是一个合适的分类后模型评估工具，支持大多数类和整体统计参数
...
* [Lambdo](https://github.com/asavinov/lambdo) - 一种用于解决机器学习问题的工作流引擎，通过在一个分析管道中结合 (i) 特征工程和机器学习 (ii) 模型训练和预测 (iii) 通过用户定义的 (Python) 函数进行表填充和列评估.
...
* [MiniGrad](https://github.com/kennysong/minigrad) – autograd 的最小化、教育性、Pythonic 实现（~100 loc）.
* [Map/Reduce implementations of common ML algorithms](https://github.com/Yannael/BigDataAnalytics_INFOH515)：Jupyter 笔记本，涵盖如何使用 Python NumPy 从头开始​​实现不同的 ML 算法（普通最小二乘法、梯度下降法、k 均值、交替最小二乘法），以及如何使用 Map/Reduce 和 Spark 使这些实现可扩展.
* [BioPy](https://github.com/jaredthecoder/BioPy)  - Python 中的生物启发和机器学习算法.  **[弃用]**
...
* [Sarah Palin LDA](https://github.com/Wavelets/sarah-palin-lda) - 主题建模 Sarah Palin 电子邮件.
...
* [group-lasso](https://github.com/fabianp/group_lasso) - 对（稀疏）组套索模型中使用的坐标下降算法进行了一些实验.
* [jProcessing](https://github.com/kevincobain2000/jProcessing)  - 汉字/平假名/片假名到罗马字转换器. 法令词典和平行句搜索. 两个 JP 句子之间的句子相似度. 日本文本的情感分析. 在 Python 中运行 Cabocha（已配置 ISO--8859-1）.
* [mne-python-notebooks](https://github.com/mne-tools/mne-python-notebooks) - 使用 mne-python 进行 EEG/MEG 数据处理的 IPython 笔记本.
* [Neon Course](https://github.com/NervanaSystems/neon_course) - IPython 笔记本，用于了解 Nervana 的 Neon 的完整课程.
* [pandas cookbook](https://github.com/jvns/pandas-cookbook) - 使用 Python 的 pandas 库的方法.
* [climin](https://github.com/BRML/climin) - 专注于机器学习的优化库、梯度下降的 pythonic 实现、LBFGS、rmsprop、adadelta 等.
* [Allen Downey’s Data Science Course](https://github.com/AllenDowney/DataScience) - 奥林学院数据科学规范，2014 年春季.
...
* [Dive into Machine Learning  with Python Jupyter notebook and scikit-learn](https://github.com/hangtwenty/dive-into-machine-learning) - “我首先通过黑客学习 Python，*后来才开始认真学习.*我想通过机器学习来做到这一点.如果这是你的风格，请加入我，让自己变得有点超前.”
* [TDB](https://github.com/ericjang/tdb)  - TensorDebugger (TDB) 是用于深度学习的可视化调试器. 它具有针对 TensorFlow 的交互式逐节点调试和可视化功能.
* [Suiron](https://github.com/kendricktan/suiron/) - 遥控汽车的机器学习.
* [Introduction to machine learning with scikit-learn](https://github.com/justmarkham/scikit-learn-videos) - Data School 关于 scikit-learn 的视频教程中的 IPython 笔记本.
...
* [Pydata book](https://github.com/wesm/pydata-book) - 由 O&#39;Reilly Media 出版的 Wes McKinney 的“用于数据分析的 Python”的材料和 IPython 笔记本
* [Homemade Machine Learning](https://github.com/trekhleb/homemade-machine-learning) - 流行的机器学习算法的 Python 示例，解释了交互式 Jupyter 演示和数学
* [Prodmodel](https://github.com/prodmodel/prodmodel) - 为数据科学管道构建工具.
* [the-elements-of-statistical-learning](https://github.com/maitbayev/the-elements-of-statistical-learning) - 此存储库包含实现本书和教科书摘要中算法的 Jupyter 笔记本.
...
* [Heart_Disease-Prediction](https://github.com/ShivamChoudhary17/Heart_Disease) - 根据患者的临床参数，我们能否预测他们是否患有心脏病？
...
* [nn_builder](https://github.com/p-christ/nn_builder) - nn_builder 是一个 python 包，可让您在一行中构建神经网络
* [NeuralTalk](https://github.com/karpathy/neuraltalk) - NeuralTalk 是一个 Python+numpy 项目，用于学习用句子描述图像的多模式递归神经网络.
...
* [NeuralTalk](https://github.com/karpathy/neuraltalk2)  - NeuralTalk 是一个 Python+numpy 项目，用于学习用句子描述图像的多模式递归神经网络.  **[弃用]**
* [Neuron](https://github.com/molcik/python-neuron)  - 神经元是时间序列预测的简单类. 它利用 LNU（线性神经单元）、QNU（二次神经单元）、RBF（径向基函数）、MLP（多层感知器）、MLP-ELM（多层感知器 - 极限学习机）神经网络通过梯度下降或 LeLevenberg 学习——马夸特算法.  **[弃用]**
* [Data Driven Code](https://github.com/atmb4u/data-driven-code) - 在不使用任何库的情况下，在 python 中非常简单地实现神经网络的假人，并附有详细的评论.
* [Machine Learning, Data Science and Deep Learning with Python](https://www.manning.com/livevideo/machine-learning-data-science-and-deep-learning-with-python) - 涵盖机器学习、Tensorflow、人工智能和神经网络的 LiveVideo 课程.
...
* [TResNet: Simple and powerful neural network library for python](https://github.com/zueve/neurolab) - 多种支持类型的人工神经网络和学习算法.
...
* [Rockpool](https://github.com/synsense/rockpool)  - 用于尖峰神经网络的机器学习库. 支持使用 torch 和 jax 管道进行训练，并支持部署到神经形态硬件. 
* [Sinabs](https://github.com/synsense/sinabs) - 一个基于 PyTorch 的脉冲神经网络深度学习库，专注于快速训练并支持对神经形态硬件的推理.
* [Tonic](https://github.com/neuromorphs/tonic) - 一个库，可以轻而易举地下载公开可用的神经形态数据集，并提供基于事件的数据转换/增强管道.
...
* [Scikit-Survival](https://github.com/sebp/scikit-survival)  - scikit-survival 是一个基于 scikit-learn 构建的用于生存分析的 Python 模块. 它允许在利用 scikit-learn 的强大功能的同时进行生存分析，例如，用于预处理或进行交叉验证.
...
* [open-solution-toxic-comments](https://github.com/neptune-ml/open-solution-toxic-comments) -&gt; 的源代码 [Toxic Comment Classification Challenge](https://www.kaggle.com/c/jigsaw-toxic-comment-classification-challenge).
* [wiki challenge](https://github.com/hammer/wikichallenge) - 执行 Dell Zhang 的维基百科 Kaggle 参与挑战解决方案.
* [kaggle insults](https://github.com/amueller/kaggle_insults) - Kaggle 提交的“检测社会评论中的侮辱”.
* [kaggle_acquire-valued-shoppers-challenge](https://github.com/MLWave/kaggle_acquire-valued-shoppers-challenge) - Kaggle 的代码获得有价值的购物者挑战.
...
* [Kaggle Dogs vs. Cats](https://github.com/kastnerkyle/kaggle-dogs-vs-cats) - Kaggle Dogs vs. Cats 竞赛代码.
* [Kaggle Galaxy Challenge](https://github.com/benanne/kaggle-galaxies) - Kaggle 上 Galaxy Challenge 的获胜解决方案.
* [Kaggle Gender](https://github.com/zygmuntz/kaggle-gender) - Kaggle 竞赛：根据笔迹区分性别.
* [Kaggle Merck](https://github.com/zygmuntz/kaggle-merck) - Kaggle 的默克挑战赛.
...
#### Reinforcement Learning
* [DeepMind Lab](https://github.com/deepmind/lab)  - DeepMind Lab 是一个基于 id Software 的 Quake III Arena 的 3D 学习环境，通过 ioquake3 和其他开源软件. 它的主要目的是作为人工智能研究的试验台，尤其是深度强化学习.
* [Gym](https://github.com/openai/gym) - OpenAI Gym 是一个用于开发和比较强化学习算法的工具包.
* [Serpent.AI](https://github.com/SerpentAI/SerpentAI)  - Serpent.AI 是一个游戏代理框架，允许您将您拥有的任何视频游戏变成沙盒，以开发 AI 和机器学习实验. 对于研究人员和爱好者.
* [ViZDoom](https://github.com/mwydmuch/ViZDoom)  - ViZDoom 允许开发仅使用视觉信息（屏幕缓冲区）播放 Doom 的 AI 机器人. 它主要用于机器视觉学习的研究，尤其是深度强化学习.
* [Roboschool](https://github.com/openai/roboschool) - 用于机器人仿真的开源软件，与 OpenAI Gym 集成.
...
* [Maze](https://github.com/enlite-ai/maze) - 面向应用的深度强化学习框架解决现实世界的决策问题.
* [RLlib](https://github.com/ray-project/ray)  - RLlib 是基于 Ray 的用于 tf 和 torch 的行业级、高度可扩展的 RL 库. 亚马逊和微软等公司使用它来大规模解决现实世界的决策问题.
* [DI-engine](https://github.com/opendilab/DI-engine)  - DI 引擎是一个通用的决策智能引擎. 它支持大多数基本的深度强化学习 (DRL) 算法，例如 DQN、PPO、SAC，以及特定领域的算法，例如多代理 RL 中的 QMIX、逆向 RL 中的 GAIL 和探索问题中的 RND.
...
* [Treat](https://github.com/louismullie/treat) - Text Retrieval and Annotation Toolkit，绝对是迄今为止我遇到过的最全面的 Ruby 工具包.
* [Stemmer](https://github.com/aurelian/ruby-stemmer)  - 将 libstemmer_c 暴露给 Ruby.  **[弃用]**
* [Raspell](https://sourceforge.net/projects/raspell/)  - raspell 是 ruby​​ 的接口绑定.  **[弃用]**
* [UEA Stemmer](https://github.com/ealdent/uea-stemmer) - UEALite Stemmer 的 Ruby 端口 - 一种用于搜索和索引的保守词干分析器.
...
* [Awesome Machine Learning with Ruby](https://github.com/arbox/machine-learning-with-ruby) - 用于 Ruby 的 ML 相关资源的精选列表.
* [Ruby Machine Learning](https://github.com/tsycho/ruby-machine-learning)  - 一些机器学习算法，用 Ruby 实现.  **[弃用]**
* [Machine Learning Ruby](https://github.com/mizoR/machine-learning-ruby) **[弃用]**
* [jRuby Mahout](https://github.com/vasinov/jruby_mahout)  - JRuby Mahout 是在 JRuby 世界中释放 Apache Mahout 力量的瑰宝.  **[弃用]**
...
* [ruby-plot](https://www.ruby-toolbox.com/projects/ruby-plot)  - Ruby 的 gnuplot 包装器，特别是用于将 ROC 曲线绘制成 SVG 文件.  **[弃用]**
* [plot-rb](https://github.com/zuhao/plotrb)  - 基于 Vega 和 D3 构建的 Ruby 绘图库.  **[弃用]**
* [scruffy](https://github.com/delano/scruffy) - 一个漂亮的 Ruby 图形工具包.
* [SciRuby](http://sciruby.com/)
* [Glean](https://github.com/glean/glean)  - 人类数据管理工具.  **[弃用]**
* [Bioruby](https://github.com/bioruby/bioruby)
* [Arel](https://github.com/nkallen/arel) **[弃用]**

<a name="ruby-misc"></a>
#### Misc

* [Big Data For Chimps](https://github.com/infochimps-labs/big_data_for_chimps)
* [Listof](https://github.com/kevincobain2000/listof)  - 基于社区的数据收集，打包在 gem 中. 获取 txt、JSON 或哈希中几乎所有内容（停用词、国家/地区、非词）的列表. [Demo/Search for a list](http://kevincobain2000.github.io/listof/)
...
* [deeplearn-rs](https://github.com/tedsta/deeplearn-rs) - deeplearn-rs 提供在 MIT 许可下使用矩阵乘法、加法和 ReLU 的简单网络.
...
* [rusty-machine](https://github.com/AtheMathmo/rusty-machine) - 纯 Rust 机器学习库.
...
* [RustNN](https://github.com/jackm321/RustNN)  - RustNN 是一个前馈神经网络库.  **[弃用]**
...
* [ahaz](https://cran.r-project.org/web/packages/ahaz/index.html)  - ahaz：半参数加性风险回归的正则化.  **[弃用]**
* [arules](https://cran.r-project.org/web/packages/arules/index.html) - arules：挖掘关联规则和频繁项集
...
* [caretEnsemble](https://cran.r-project.org/web/packages/caretEnsemble/index.html)  - caretEnsemble：用于拟合多个插入符号模型以及创建此类模型的集合的框架.  **[弃用]**
* [CatBoost](https://github.com/catboost/catboost) - 决策树库的通用梯度提升，具有 R 开箱即用的分类特征支持.
* [Clever Algorithms For Machine Learning](https://machinelearningmastery.com/)
* [CORElearn](https://cran.r-project.org/web/packages/CORElearn/index.html) - CORElearn：分类、回归、特征评估和顺序评估.
-* [CoxBoost](https://cran.r-project.org/web/packages/CoxBoost/index.html) - CoxBoost：通过基于可能性的 Cox 模型提升单个生存终点或竞争风险 **[已弃用]**
* [Cubist](https://cran.r-project.org/web/packages/Cubist/index.html) - Cubist：基于规则和实例的回归建模.
* [e1071](https://cran.r-project.org/web/packages/e1071/index.html) - e1071：统计系的杂项职能 (e1071)，TU Wien
...
* [ElemStatLearn](https://cran.r-project.org/web/packages/ElemStatLearn/index.html) - ElemStatLearn：书中的数据集、函数和示例：Trevor Hastie、Robert Tibshirani 和 Jerome Friedman 撰写的“统计学习、数据挖掘、推理和预测的要素” Trevor Hastie、Robert Tibshirani 和 Jerome Friedman 撰写的预测.
...
* [GMMBoost](https://cran.r-project.org/web/packages/GMMBoost/index.html)  - GMMBoost：广义混合模型的基于似然的提升.  **[弃用]**
* [grplasso](https://cran.r-project.org/web/packages/grplasso/index.html) - grplasso：使用 Group Lasso 惩罚来拟合用户指定的模型.
...
* [hda](https://cran.r-project.org/web/packages/hda/index.html)  - hda：异方差判别分析.  **[弃用]**
...
* [lars](https://cran.r-project.org/web/packages/lars/index.html)  - lars：最小角度回归、Lasso 和 Forward Stagewise.  **[弃用]**
...
* [maptree](https://cran.r-project.org/web/packages/maptree/index.html)  - maptree：映射、修剪和绘图树模型.  **[弃用]**
* [mboost](https://cran.r-project.org/web/packages/mboost/index.html) - mboost：基于模型的提升.
* [medley](https://www.kaggle.com/general/3661) - 混合泳：混合回归模型，使用贪婪的逐步方法.
...
* [nnet](https://cran.r-project.org/web/packages/nnet/index.html)  - nnet：前馈神经网络和多项对数线性模型.  **[弃用]**
* [pamr](https://cran.r-project.org/web/packages/pamr/index.html)  - pamr：Pam：微阵列的预测分析.  **[弃用]**
...
* [penalized](https://cran.r-project.org/web/packages/penalized/index.html) - 惩罚：L1（套索和融合套索）和 L2（脊）惩罚了 GLM 和 Cox 模型中的估计.
* [penalizedLDA](https://cran.r-project.org/web/packages/penalizedLDA/index.html)  - penalizedLDA：使用 Fisher 线性判别式进行惩罚分类.  **[弃用]**
...
* [randomForest](https://cran.r-project.org/web/packages/randomForest/index.html) - randomForest：用于分类和回归的 Breiman 和 Cutler 的随机森林.
...
* [rdetools](https://cran.r-project.org/web/packages/rdetools/index.html)  - rdetools：特征空间中的相关维度估计（RDE）.  **[弃用]**
* [REEMtree](https://cran.r-project.org/web/packages/REEMtree/index.html)  - REEMtree：对纵向（面板）数据具有随机效应的回归树.  **[弃用]**
* [relaxo](https://cran.r-project.org/web/packages/relaxo/index.html)  - relaxo：放松套索.  **[弃用]**
* [rgenoud](https://cran.r-project.org/web/packages/rgenoud/index.html) - rgenoud：R 版本的使用导数的遗传优化
* [Rmalschains](https://cran.r-project.org/web/packages/Rmalschains/index.html) - Rmalschains：使用模因算法和 R 中的本地搜索链 (MA-LS-Chains) 进行持续优化.
* [rminer](https://cran.r-project.org/web/packages/rminer/index.html)  - rminer：在分类和回归中更简单地使用数据挖掘方法（例如 NN 和 SVM）.  **[弃用]**
* [ROCR](https://cran.r-project.org/web/packages/ROCR/index.html)  - ROCR：可视化评分分类器的性能.  **[弃用]**
* [RoughSets](https://cran.r-project.org/web/packages/RoughSets/index.html)  - RoughSets：使用粗糙集和模糊粗糙集理论进行数据分析.  **[弃用]**
...
* [RSNNS](https://cran.r-project.org/web/packages/RSNNS/index.html) - RSNNS：使用 Stuttgart 神经网络模拟器 (SNNS) 的 R 神经网络.
* [RWeka](https://cran.r-project.org/web/packages/RWeka/index.html) - RWeka：R/Weka 接口.
* [RXshrink](https://cran.r-project.org/web/packages/RXshrink/index.html) - RXshrink：通过广义岭回归或最小角度回归的最大似然收缩.
* [sda](https://cran.r-project.org/web/packages/sda/index.html)  - sda：收缩判别分析和 CAT 评分变量选择.  **[弃用]**
* [spectralGraphTopology](https://cran.r-project.org/web/packages/spectralGraphTopology/index.html) - spectralGraphTopology：通过频谱约束从数据中学习图形.
* [SuperLearner](https://github.com/ecpolley/SuperLearner) - 多算法集成学习包.
* [svmpath](https://cran.r-project.org/web/packages/svmpath/index.html)  - svmpath: svmpath: SVM 路径算法.  **[弃用]**
* [tgp](https://cran.r-project.org/web/packages/tgp/index.html)  - tgp：贝叶斯树高斯过程模型.  **[弃用]**
...
* [XGBoost.R](https://github.com/tqchen/xgboost/tree/master/R-package) - 极端梯度提升（树）库的 R 绑定.
* [Optunity](https://optunity.readthedocs.io/en/latest/)  - 一个专门用于自动超参数优化的库，具有简单、轻量级的 API，以促进网格搜索的直接替换.  Optunity 是用 Python 编写的，但可以无缝连接到 R.
...
* [shiny](https://shiny.rstudio.com/) 是 R 中真正交互式显示和仪表板的基础.但是，可以通过以下方式实现某种程度的交互性 [htmlwidgets](https://www.htmlwidgets.org/) 将 javascript 库引入 R.这些包括， [plotly](https://plot.ly/r/), [dygraphs](http://rstudio.github.io/dygraphs), [highcharter](http://jkunst.com/highcharter/), 和其他几个.
...
* [Visual Data Mining and Machine Learning](https://www.sas.com/en_us/software/visual-data-mining-machine-learning.html)  - 从数据准备到部署，在端到端分析环境中使用最新的机器学习算法进行交互式、自动化和程序化建模. 提供免费试用.
* [Enterprise Miner](https://www.sas.com/en_us/software/enterprise-miner.html) - 使用 GUI 或代码创建可部署模型的数据挖掘和机器学习.
* [Factory Miner](https://www.sas.com/en_us/software/factory-miner.html) - 使用 GUI 在众多市场或客户群中自动创建可部署的机器学习模型.
...
* [Contextual Analysis](https://www.sas.com/en_us/software/contextual-analysis.html) - 使用 GUI 向非结构化文本添加结构.
...
* [dm-flow](https://github.com/sassoftware/dm-flow) - SAS Enterprise Miner 过程流程图库可帮助您通过示例了解特定的数据挖掘主题.
...
* [NDScala](https://github.com/SciScala/NDScala) - Scala 3 中的 N 维数组.想想 NumPy ndarray，但对形状、张量/轴标签和数字数据类型进行编译时类型检查/推理
* [MLlib in Apache Spark](https://spark.apache.org/docs/latest/mllib-guide.html) - Spark 中的分布式机器学习库
* [Hydrosphere Mist](https://github.com/Hydrospheredata/mist) - 用于将 Apache Spark MLLib 机器学习模型部署为实时、批处理或反应式 Web 服务的服务.
* [Scalding](https://github.com/twitter/scalding) - 用于级联的 Scala API.
* [Summing Bird](https://github.com/twitter/summingbird) - 使用 Scalding 和 Storm 流式处理 MapReduce.
* [Algebird](https://github.com/twitter/algebird) - Scala 的抽象代数.
* [xerial](https://github.com/xerial/xerial)  - Scala 的数据管理实用程序.  **[弃用]**
...
* [ganitha](https://github.com/tresata/ganitha)  - 烫伤动力机器学习.  **[弃用]**
...
* [SwiftLearner](https://github.com/valdanylchuk/swiftlearner/) - 简单编写算法以帮助学习 ML 或编写您自己的实现.
* [Smile](https://haifengl.github.io/) - 统计机器智能和学习引擎.
...
* [swix](https://github.com/stsievert/swix)  - 一个基本的库，包括通用矩阵语言并包装了一些用于 iOS 开发的 OpenCV.  **[弃用]**
* [AIToolbox](https://github.com/KevinCoble/AIToolbox) - 用 Swift 编写的 AI 模块的工具箱框架：图形/树、线性回归、支持向量机、神经网络、PCA、KMeans、遗传算法、MDP、高斯混合.
* [MLKit](https://github.com/Somnibyte/MLKit)  - 一个用 Swift 编写的简单机器学习框架. 当前具有简单线性回归、多项式回归和岭回归.
* [Swift Brain](https://github.com/vlall/Swift-Brain)  - 第一个用 Swift 编写的神经网络/机器学习库. 这是一个用于 iOS 和 OS X 开发的 Swift AI 算法项目. 该项目包括专注于贝叶斯定理、神经网络、支持向量机、矩阵等的算法……
...
* [PredictionBuilder](https://github.com/denissimon/prediction-builder-swift) - 机器学习库，使用线性回归构建预测.
* [Awesome CoreML](https://github.com/SwiftBrain/awesome-CoreML-models) - 预训练 CoreML 模型的精选列表.
* [Awesome Core ML Models](https://github.com/likedan/Awesome-CoreML-Models) - CoreML 格式的精选机器学习模型列表.
...
#### General-Purpose Machine Learning
* [Awesome Keras](https://github.com/markusschanta/awesome-keras) - 很棒的 Keras 项目、库和资源的精选列表.
...
#### Neural Networks
* [layer](https://github.com/cloudkj/layer) - 来自命令行的神经网络推理

<a name="tools-misc"></a>
#### Misc

* [Qdrant](https://qdrant.tech) – Qdrant 是 [open source](https://github.com/qdrant/qdrant) 具有扩展过滤支持的矢量相似性搜索引擎，用 Rust 编写.
* [milvus](https://milvus.io) - 他是一只风筝 [open source](https://github.com/milvus-io/milvus) 用于生产 AI 的矢量数据库，用 Go 和 C++ 编写，可扩展且速度极快，可容纳数十亿个嵌入矢量.
* [Weaviate](https://www.semi.technology/developers/weaviate/current/) – Weaviate 是一个 [open source](https://github.com/semi-technologies/weaviate) 矢量搜索引擎和矢量数据库.  Weaviate 使用机器学习来矢量化​​和存储数据，并找到自然语言查询的答案. 借助 Weaviate，您还可以将自定义 ML 模型用于生产规模.
* [txtai](https://github.com/neuml/txtai) - 构建语义搜索应用程序和工作流程.
* [MLReef](https://about.mlreef.com/) - MLReef 是一个端到端的开发平台，使用 git 的力量为 ML 开发过程提供结构和深度协作的可能性.
...
* [Notebooks](https://github.com/rlan/notebooks)  - 用于 Jupyter 笔记本和机器学习的入门套件.  Companion docker 镜像包含 python 版本、机器学习框架（Keras、PyTorch 和 Tensorflow）和 CPU/CUDA 版本的所有组合.
* [DVC](https://github.com/iterative/dvc)  - Data Science Version Control 是一个开源版本控制系统，用于支持管道的机器学习项目. 它使 ML 项目可重现和共享.
* [DVClive](https://github.com/iterative/dvclive) - 用于将实验指标记录到简单格式化的本地文件中的 Python 库.
* [VDP](https://github.com/instill-ai/vdp) - 开源视觉数据 ETL 以简化端到端视觉数据处理管道：从预建数据源中提取非结构化视觉数据，通过从各种 ML 平台导入的 Vision AI 模型将其转化为可分析的结构化洞察，并加载洞察进入仓库或应用程序.
...
* [Sacred](https://github.com/IDSIA/sacred)  - 帮助您配置、组织、记录和重现实验的 Python 工具. 就像化学/生物学背景下的笔记本实验室. 社区已经利用提议的标准构建了多个附加组件.
* [Comet](https://www.comet.com/)  - 用于跟踪实验、超参数、工件等的 ML 平台. 它与超过 15 个深度学习框架和编排工具深度集成. 用户还可以使用该平台来监控生产中的模型.
* [MLFlow](https://mlflow.org/)  - 管理 ML 生命周期的平台，包括实验、再现性和部署. 与框架和语言无关，看看所有内置集成.
* [Weights & Biases](https://www.wandb.com/) - 机器学习实验跟踪、数据集版本控制、超参数搜索、可视化和协作
* 改进 ML 生命周期的更多工具： [Catalyst](https://github.com/catalyst-team/catalyst), [PachydermIO](https://www.pachyderm.io/) . 以下是 GitHub-like 和 targeting 团队 [Weights & Biases](https://www.wandb.com/), [Neptune.ai](https://neptune.ai/), [Comet.ml](https://www.comet.ml/), [Valohai.ai](https://valohai.com/), [DAGsHub](https://DAGsHub.com/).
...
* [CML](https://github.com/iterative/cml)  - 用于与 ML 项目进行持续集成的库. 使用 GitHub Actions 和 GitLab CI 在生产环境中训练和评估模型，并在拉取/合并请求中自动生成包含指标和图表的可视化报告. 框架和语言无关.
* [Pythonizr](https://pythonizr.com) - 一个使用 scikit-learn 生成样板机器学习代码的在线工具.
...
* [Distributed Machine Learning Patterns](https://github.com/terrytangyuan/distributed-ml-patterns)   - 这本书教你如何将机器学习模型从你的个人笔记本电脑带到大型分布式集群. 您将探索成功的分布式机器学习系统背后的关键概念和模式，并直接从主要维护者和贡献者那里学习 TensorFlow、Kubernetes、Kubeflow 和 Argo Workflows 等技术，以及真实场景和实践项目.
...
<a name="credits"></a>
* [Netron](https://netron.app/) - 神经网络、深度学习和机器学习模型的开源查看器
