...
- [Void2D](https://github.com/xzripper/Void2D) - 基于 Swing 的内置物理高级 2D 游戏引擎.
...
- [Deezpatch](https://github.com/joeljeremy7/deezpatch) - 用于解耦消息（请求和事件）和消息处理程序的简单、轻量级和高性能调度库.
...
- [Passay](http://www.passay.org/) - 通过根据可配置的规则集验证候选密码来执行密码策略.
