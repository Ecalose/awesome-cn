...
- [Auto](https://github.com/davidjbradshaw/eslint-config-auto) - 根据项目的依赖项自动配置 ESLint.
...
- [Standard](https://github.com/feross/eslint-config-standard) - 可共享的 JavaScript 配置 [Standard Style](https://github.com/feross/standard).
- [XO](https://github.com/xojs/eslint-config-xo) - 可共享的配置 [XO](https://github.com/xojs/xo).

### Other Configs

- [Adjunct](https://github.com/davidjbradshaw/eslint-config-adjunct) - 一个合理的插件集合，可以与你的主要 ESLint 配置一起使用.
...
- [prettier-standard](https://github.com/sheerun/prettier-standard) - 允许使用自定义 eslint 规则的更漂亮的格式化程序.
- [Standard](https://github.com/feross/standard) - JavaScript 标准样式.
- [Superlint](https://github.com/supermind/superlint) - JavaScript 超级思维风格.
- [XO](https://github.com/sindresorhus/xo) - JavaScript 幸福风格 linter ❤️.
- [Healthier](https://github.com/KidkArolis/healthier) - Standard 的代码风格不可知版本，是 Prettier 的完美伴侣.
...
- [Compat](https://github.com/amilajack/eslint-plugin-compat) - 所用 API 的 Lint 浏览器兼容性 ([caniuse](http://caniuse.com/#search=fetch) 作为 ESLint 插件）.
...
- 样式组件
  ...
  - [styled-components-a11y](https://github.com/brendanmorrell/eslint-plugin-styled-components-a11y) - 样式化组件的 A11y.

### Deprecation

- [deprecate](https://github.com/AlexMost/eslint-plugin-deprecate) - 将函数或模块标记为已弃用，并在使用时获取 lint 消息.
- [deprecation](https://github.com/gund/eslint-plugin-deprecation) - 标识使用
  jsdoc `@deprecated` 函数.
- [disable](https://github.com/mradionov/eslint-plugin-disable) - 使用文件路径模式和内联注释禁用指定的插件.

### Embedded

- [HTML](https://github.com/BenoitZugmeyer/eslint-plugin-html) - 对 HTML 中的 JavaScript 进行检查 ` <script>` tags.
- [Markdown](https://github.com/eslint/eslint-plugin-markdown) - Markdown 内的 JavaScript 代码检查.
...
Lodash
  ...
  - [Lodash template](https://github.com/ota-meshi/eslint-plugin-lodash-template) - Lodash 模板/Underscore 模板的插件.
...
- [Misc](https://github.com/ilyub/eslint-plugin-misc) - 杂项规则，包括用于创建自定义检查和包装（修改）第三方规则的规则.
...
- [eslint-plugin-write-good-comments](https://github.com/kantord/eslint-plugin-write-good-comments) - 在评论中强制执行良好的写作风格.
- [fp](https://github.com/jfmengels/eslint-plugin-fp) - 函数式编程的 ESLint 规则.
- [functional](https://github.com/jonaskello/eslint-plugin-functional) - ESLint 规则禁用突变并在 JavaScript 和 TypeScript 中提升 fp.
- [Immutable](https://github.com/jhusain/eslint-plugin-immutable) - 禁用 JavaScript 中的所有突变.
- [import](https://github.com/benmosher/eslint-plugin-import) - 检查 ES2015+ 导入/导出语法，并防止文件路径和导入名称拼写错误的问题.
...
- [this](https://github.com/matijs/eslint-plugin-this) - 编写纯函数，不允许 `this`.
...
- [const case](https://www.npmjs.com/package/eslint-plugin-const-case) - 强制对常量原始文字进行大写.
...
- [AVA](https://github.com/avajs/eslint-plugin-ava) - AVA 的检查规则.
- 柴
...
- [Cucumber](https://github.com/darrinholst/eslint-plugin-cucumber) - Cucumber 的检查规则.
- [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) - Cypress 的 Linting 规则.
- [Jasmine](https://github.com/tlvince/eslint-plugin-jasmine) - Jasmine 的检查规则.
- 是
  ...
  - [Jest-DOM](https://github.com/testing-library/eslint-plugin-jest-dom) - Is-HOME 的检查规则.
- 摩卡
...
- [mo](https://github.com/fengzilong/eslint-formatter-mo) - 好看的 ESLint 格式化程序，也提供愉快的阅读体验.
- [SARIF](https://www.npmjs.com/package/@microsoft/eslint-formatter-sarif) - 以 SARIF 格式生成结果，以便将其导入 GitHub Advanced Security 等工具.
...
- [codacy-eslint](https://github.com/codacy/codacy-eslint) - Docker用于 [Codacy](https://www.codacy.com) 运行 ESLint.
...
- [editor-info](https://github.com/fisker/editor-info) - 检测一个是否在编辑器/IDE 中以及是哪种类型，允许相应地调整 ESLint 配置.
...
- [Linting React JSX with ESLint (in ES6)](https://egghead.io/lessons/react-linting-react-jsx-with-eslint-in-es6) - 展示如何将 React 和 JSX 与 ESLint 结合使用的视频.
- [Plugin Module with Mixins](https://chrysanthium.com/eslint-integration) - 关于如何将插件编写为包含模块化混合配置的节点模块的文章.
...
- [Lintier](https://github.com/josh-stillman/lintier) - 用于在 TypeScript 项目中快速构建 ESLint 和 Prettier 设置的 CLI.
