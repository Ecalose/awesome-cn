...
- [Static Typing Python Decorators](https://rednafi.github.io/reflections/static-typing-python-decorators.html)  - 在 Python 中准确的静态类型装饰器是一件令人讨厌的事情. 包装函数混淆了静态确定参数类型和被包装函数的返回值所需的类型信息.
