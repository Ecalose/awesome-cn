...
在计算机科学中，人工智能 (AI) 是由机器展示的智能. 它的定义，人工智能研究作为对“智能代理”的研究：任何感知其环境并采取行动以实现其目标的设备_Russell et. 人（2016）_.   

 Withal，数据挖掘 (DM) 是在数据集（或数据集）中发现模式的过程，涉及机器学习、统计和数据库系统的方法；  DM专注于提取数据集的信息_Han (2011)_.  

此存储库可作为任何想要使用数字游戏中应用的**人工智能**或**数据挖掘**的人的指南！ 在这里，您将找到一系列可用于构建您的_应用程序_或_数据集_的数据集、工具和材料.  

**Contributing**  

任何建议或疑问，请打开“问题”. 如果你想贡献，请阅读 [this](https://github.com/leomaurodesenv/game-datasets/blob/master/CONTRIBUTING.md) 并发出“拉取请求”.  
...
API 是_“一组功能和过程，允许创建访问操作系统、应用程序或其他服务的功能或数据的应用程序”_（Google）.  
...
- [smm-course-search](https://github.com/leomaurodesenv/smm-course-search) - 从 Super Mario Maker 游戏中搜索课程.
...
- [Steam Database](https://github.com/SteamDatabase) - Steam数据系列工具. [Website](https://steamdb.info/).
- [Steam Spy](https://github.com/topics/steamspy) - 来自 Steam 用户个人资料的游戏统计数据.
...
- [vgchartzScrape](https://github.com/GregorUT/vgchartzScrape) - 爬行者来自 [VGChartz](http://www.vgchartz.com).
- [WhatoPlay](https://whatoplay.com) - 游戏评论和评分聚合器，以及发现游戏的推荐器.
- [Xbox LIVE API](https://github.com/xboxapi) - 游戏、应用程序、用户统计数据和消息. [Website](https://xboxapi.com/), [paper](https://doi.org/10.1145/1943552.1943569).
...
- [Infinite Mario Bros](http://www.marioai.org/)  - 超级马里奥比赛. 平台游戏 AI 的前身. [Website](http://julian.togelius.com/mariocompetition2009/).
- [irrlamb](https://github.com/jazztickets/irrlamb) - 具有 3D 物理效果的益智游戏.
- [Malmo](https://github.com/Microsoft/malmo) - 建立在之上的平台 [Minecraft](https://www.minecraft.net/en-us/) 游戏.
- [microRTS](https://github.com/santiontanon/microrts) - RTS游戏比赛. [PT-BR](https://github.com/rubensolv/MicroRTS).
- [MiniDungeons](http://minidungeons.com/) - 程序地牢式游戏.
...
- [openmw](https://gitlab.com/OpenMW/openmw) - 开放世界的角色扮演游戏. [Website](https://openmw.org/en/).
...
- [Showdown AI Competition](https://github.com/scotchkorean27/showdownaiclient) - 口袋妖怪战斗的比赛. [Website](http://game.engineering.nyu.edu/showdown-ai-competition/), [paper](http://game.engineering.nyu.edu/wp-content/uploads/2017/02/CIG_2017_paper_87-1.pdf).
...
- [Vindinium](https://github.com/leomaurodesenv/vindinium) - 基于roguelike竞争的多人回合. [Documentation](https://pythonhosted.org/vindinium/).
...
## Books
 ...
 - El-Nasr, S. Drachen, A. Canossa, A. (2013).  _游戏分析：最大化玩家数据的价值_. 喷头.
 - Han, J., Pei, J., Kamber, M. (2011).  _数据挖掘：概念和技术_. 爱思唯尔.
 - Hennig-Thurau, T. Houston, M. (2018).  _娱乐科学：电影、游戏、音乐和书籍的数据分析和实践理论_. 施普林格.
 - Loh, A. Sheng, Y. Ifenthaler, D. (2015).  _严肃游戏分析：绩效衡量、评估和改进的方法_. 施普林格.
...
- [Boardgaming Online Game Records](https://www.kaggle.com/jingking/boardgaming-online-processed-game-records) - 棋盘游戏的播放.
- [bravefrontier_data](https://github.com/cheahjs/bravefrontier_data) - 手机游戏数据、物品和任务信息.
- [CartolaFC](https://www.kaggle.com/schiller/cartolafc) - 流行的巴西梦幻足球（从 2014 年到 2017 年）.
- [Chess Game Dataset (Lichess)](https://www.kaggle.com/datasets/datasnaek/chess) - 国际象棋游戏，包括走法、胜者、评级、开局细节等.
...
- [CS:GO Competitive Matchmaking Data](https://www.kaggle.com/skihikingkevin/csgo-matchmaking-damage) - 比赛回合的伤害条目.
- [Data Game ClashRoyale](https://www.kaggle.com/lucianomartins/data-game-clashroyale) - 皇室战争游戏的玩家数据.
...
- [GamingVideoSET](https://kingston.app.box.com/v/GamingVideoSET) - 游戏视频流应用程序的数据集. [Paper](https://ieeexplore.ieee.org/document/8463362)
- [GOSU.AI Dota 2 Game Chats](https://www.kaggle.com/romovpa/gosuai-dota-2-game-chats) - 从比赛重播聊天.
- [GTA-3D Dataset](https://github.com/oscarmcnulty/gta-3d-dataset) - Grand Theft Auto 5 游戏中的 2D 和 3D 图像.
- [Hearthstone Cards](https://www.kaggle.com/jeradrose/hearthstone-cards) - 卡片的集合.
...
- [NBA Players](https://www.kaggle.com/datasets/justinas/nba-players-data) - 1996 年至 2019 赛季的生物特征、传记和基本评分功能.
...
- [Pokémon for Data Mining and Machine Learning](https://www.kaggle.com/datasets/alopez247/pokemon) - 前六代的 721 只神奇宝贝的统计数据.
...
- [Scrabble](https://github.com/onzie9/Quackle_Self_Play) - Data Quackle 游戏比赛.
...
- [SMMnet](https://www.kaggle.com/leomauro/smmnet) - 来自 Super Mario Maker 的网络数据.
...
- [StarCraft II Replay Analysis](https://www.kaggle.com/sfu-summit/starcraft-ii-replay-analysis) - 回放的聚合.
...
- [World of Warcraft Battlegrounds](https://www.kaggle.com/cblesa/world-of-warcraft-battlegrounds) - 战场的细节.
...
- [Google Play Store Apps](https://www.kaggle.com/lava18/google-play-store-apps) - 来自 Play 商店应用程序的数据.
...
- [Over 13,000 Steam Games](https://www.kaggle.com/kingburrito666/over-13000-steam-games) - Steam 的视频游戏价格.
...
- [Steam Store Games](https://www.kaggle.com/datasets/nikdavis/steam-store-games) - 从 Steam 和 SteamSpy API 中抓取的 27,000 款游戏的信息.
...
- [Video Game DATA](https://www.kaggle.com/juttugarakesh/video-game-data) - 发布视频游戏.
...
- [Games on GitHub](https://github.com/leereilly/games) - 托管在 GitHub 上的流行视频游戏.
