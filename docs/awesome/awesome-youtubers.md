...
内容：一般 Web 开发、JavaScript、React、CSS \
...
精选播放列表：“从零开始的网页设计课程（完成）”、“从零开始的网页开发课程（完成）”、“学习编程（从零开始）”.
...
内容关于：机器学习工程、实用视频、书评 \
精选播放列表：“机器学习系统”、“图神经网络”、“更多视频！”.  \
<br />


## DevOps

 DevOps 是软件 **dev**elopment 和 IT **operation**s** 的组合. 本节列出了一些让学习 DevOps 主题变得容易的 YouTube 用户. 主题可能包括 Docker、Kubernetes、系统设计、Kafka、Ansible、Cassandra、Zookeeper、Hadoop、云（AWS、GCP、Azure）等.
...
关于内容：GitOps、持续集成、持续交付、IaC、Kubernetes、Docker \
...
内容有关：Kubernetes、Docker、Terraform \
精选播放列表：`DevOps Pre-requisites`、`Docker for the Absolute Beginners`、`Kubernetes for the Absolute Beginners`.
...
关于内容：DevOps、Docker、Kubernetes、Ansible \
精选播放列表：`完成 Docker 课程`、`完成 Ansible 课程`、`完成 Vagrant 课程`.  \
<br />
...
内容：Kubernetes、AWS、Google Cloud Platform、Docker、Linux 容器、Jenkins、数据库 (MySQL/MongoDB/Postgres)、Elasticsearch Stack、Red Hat、Devops \
...
内容有关：软件架构和设计、消息传递、CQRS、事件溯源和 HTTP API \
精选播放列表：“架构”、“软件设计”.  \
<br />
...
Content about: 网络安全 \
精选播放列表：“闯入网络安全视频 - 简单网络”、“与招聘人员一起进行网络安全求职 QA”、“免费 Pentester 列表伴侣”.
...
关于内容：Adobe Illustrator、Adobe Photoshop \
...
## Hardware
 ...
 CPU、主板、显示器、键盘、鼠标、PC/笔记本电脑以及所有关于硬件的东西. 调制解调器和路由器也可以在这里找到，以及最新的手机和其他技术小工具. 获取有关这些产品的建议和价格/质量比较.
...
内容：所有硬件\
精选播放列表：“硬件新闻”、“PC 机箱评论”、“预建游戏 PC 评论”、“更多”.  \
<br />
...
大多数公司的面试过程都涉及编码挑战. 竞争性编程就像在 Internet 上举行的一项运动，程序员将在其中相互竞争. 下面的列表包含一些您可以关注的频道，以提高您的竞争性编程技能.
...
Content about: 数据结构与算法、动态规划、Leetcode \
精选播放列表：“动态编程”、“图形算法”、“二叉树”.  \
<br />
...
Content about: 大型系统设计 \
精选播放列表：“系统设计你应该知道的算法”、“系统设计基础”、“系统设计面试”.
...
内容有关：通过来源创作、无权利且无广告的方式向好奇的公众普及计算.  \
