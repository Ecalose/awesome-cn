...
内容关于：Python \
特色播放列表：`Python - 中级和高级功能`、`Python 中的函数式编程`、`有效 Python 开发的工具`、`如何建立你的 Python 职业生涯`.
...
内容关于：前端，后端\
精选播放列表：`Vue.js 课程`、`完整的 CSS3 和 Flexbox 课程`、`Bootstrap 4 完整课程`、`JavaScript 和 React.js 视频`、`Firebase / Firestore 从头开始​​课程`.
...
精选播放列表：`从零开始的 Web 设计课程（完整）`、`从零开始的 Web 开发课程（完整）`、`学习编程（从头开始）`.
...
精选播放列表：`Course ARM since 0`、`Personalización de Linux`、`Curso de electronics`.  🇧🇷
<br />
...
内容关于：C/C++语言、数据结构、算法\
精选播放列表：`排序算法`、`数据结构`、`C/C++ 中的指针`、`通过“C”进行编程的介绍.
...
特色播放列表：“线性回归和线性模型”、“机器学习”、“高通量测序”、“统计基础”和“更多！”.
...
内容关于： 数学 \
精选播放列表：`Algebra`、`Statastics`、`Calculus`.  \
<br />
...
查找在深度学习、自然语言处理、神经网络以及与这一广泛类别相关的更多主题方面经验丰富的 YouTube 用户. 机器学习的一个好处是它可以使用不同的编程语言来应用，并且核心概念对于不同的编程语言都符合相同的结构.
...
内容关于：实用视频、讲座 \
精选播放列表：`应用机器学习框架`、`机器学习的技巧与窍门`、`更多视频！`.
...
内容关于：机器学习\
精选播放列表：`Applied Machine Learning 2020`.  \
<br />
...
内容关于：Python、机器学习、理论\
精选播放列表：“机器学习播放列表简介”、“使用 Pandas 在 Python 中进行数据分析”、“其他谈话视频和 Python 视频”.
...
内容关于：NLP、机器学习、AI \
精选播放列表：`Events and Talks`、`Research Releases`、`Robotics`.  \
<br />
...
内容：机器学习和 AI 研究、科学论文 \
特色播放列表：“两分钟论文”、“AlphaGo”、“流体、布料和头发模拟”、“AI 和深度学习”、“光传输、光线追踪和全局照明”.
...
特色播放列表：`FORMATION DEEP LEARNING`、`SKLEARN tutoriel français Machine Learning`、`PYTHON SPÉCIAL MACHINE LEARNING`.
...
## DevOps
 ...
 DevOps 是软件**开发**开发和 IT **操作**的组合. 本节列出了一些使学习 DevOps 主题变得容易的 YouTube 用户. 主题可能包括 Docker、Kubernetes、系统设计、Kafka、Ansible、Cassandra、Zookeeper、Hadoop、云（AWS、GCP、Azure）等.
...
内容关于：GitOps、持续集成、持续交付、IaC、Kubernetes、Docker \
精选播放列表：`DevOps 概念解释`、`基础架构即代码 (IaC) 教程`、`DevOps 训练营`.
...
内容关于：Kubernetes、Docker、Terraform \
精选播放列表：`DevOps 先决条件`、`绝对初学者的 Docker`、`绝对初学者的 Kubernetes`.
...
内容关于：DevOps、Docker、Kubernetes、Ansible \
...
内容涉及：Kubernetes、AWS、谷歌云平台、Docker、Linux 容器、Jenkins、数据库（MySQL/MongoDB/Postgres）、Elasticsearch Stack、Red Hat、DevOps \
精选播放列表：`Kubernetes Provisioning`、`Learn AWS`、`Google Cloud Platform for Beginners`.
...
内容关于：DevOps 云、体系结构、提示和技巧 \
精选播放列表：`System Design Primer`、`AWS primer`、`Google Cloud Primer`、`Sprint Cloud Primer`.  \
<br />
...
内容关于：软件架构与设计、消息传递、CQRS、事件溯源和 HTTP API \
精选播放列表：`Architecture`、`Software Design`.  \
<br />


## Game development

这是一个广泛的话题. 在本节中，您可以找到教授游戏开发程序（Unity、虚幻引擎等）、不同编程语言（JavaScript、HTML5、Java）和艺术/设计创作、3D 建模等核心概念的 YouTube 用户.
...
内容关于：GameMaker Studio、技巧和规划播放列表 \
精选播放列表：`Will You Snail?  - 全面开发.`，`游戏开发技巧`，`如何开始游戏开发.`.
...
特色播放列表：`Java 基础编程`、`Cool Game Maker 教程`、`Java 游戏开发初学者`、`Java 平台游戏编程`.
...
精选播放列表：`HTML5 Canvas 初学者教程 | 成为 Canvas Pro`、`其他与 JavaScript 相关的视频`.
...
内容关于：Unity、Unreal Engine、Godot \
...
内容关于： Pygame \
特色播放列表：`Pygame 教程系列（初学者）`、`Pygame 教程系列（业余）`、`Pygame 教程系列（高级）`、`更多 Pygame 视频！`.
...
内容关于：C++、DirextX、3D \
精选播放列表：`初级 C++ 游戏编程`、`中级 C++ 游戏编程`、`高级 C++ 游戏编程`、`3D 编程基础知识`、`C++ 3D DirextX 编程`.
...
内容关于：JavaScript \
特色播放列表：“用 JavaScript 编写的超级马里奥兄弟”、“用 Javascript 创建俄罗斯方块在线多人游戏”.
...
精选播放列表：`教程`、`我们的会议`、`为什么它很酷？`、`Journal de bord`.  \
<br />
...
内容关于：Python \
精选播放列表：`Pygame 基础知识`、`在 Pygame 中创建 Pong`、`通过制作 Flappy Bird 学习 pygame`、`Godot 中的 Google 恐龙赛跑者`.
...
如今，我们无法想象没有智能手机的生活，而实现智能手机体验的人是移动应用程序开发人员. 在本节中，您可以了解如何从头开始构建面向消费者的移动应用程序. 了解如何遵循行业最佳实践. 学习 Kotlin 或 Swift 以在 Android/iOS 中进行原生开发，或学习 React Native 和 Flutter 等技术以进行跨平台移动开发.
...
内容关于：Android、Kotlin、Jetpack Compose \
精选播放列表：`ANDROID FUNDAMENTALS FOR BEGINNERS`、`KOTLIN NEWBIE TO PRO`、`Jetpack Compose`.  \
<br />
...
安全是我们所有人都应该关心的事情. 了解如何保护自己免受攻击者或恶意软件的侵害. 还可以通过道德黑客教程了解黑客是如何深入了解内部发生的事情的.
...
内容关于： 安全 \
精选播放列表：`CompTIA Security+ SY0-501 培训课程`、`CompTIA N10-007 网络+ 学习小组`、`还有更多类似的内容！`.
...
精选播放列表：`Malware Analysis`、`TryHackMe`、`FORENSICS`.  \
<br />
...
## Internet/networking
 ...
 Internet 连接和网络是一个广泛的话题，在了解它时经常会遇到困难. 获取有关软件和硬件的精彩播放列表和视频，了解互联网连接和网络的工作原理. 如何正确设置调制解调器/路由器以及 IP、DNS 等.
...
内容：网络硬件与其他概念，有助于视觉效果. 还有一个关于 A+ 和 Net+ 的速成班.  \
精选播放列表：`Information Technology`、`CompTIA Certification`.
...
此类别中列出的 YouTuber 可能不是编程教程或炫酷的设计卡片，而是其他一些有用的软件和应用程序，每个人每天都在使用. 掌握您经常使用的套件，或了解有关公司为您提供的特定服务的更多信息.
...
精选播放列表：`Google 表格 - 基础技能`、`Google Apps 脚本 - 基础`.  \
<br />
...
包括正确管理和理解 Windows、Linux、Mac 和其他操作系统的视频和教程. 了解有用的命令和设置，让您的操作系统保持最新和安全. 深入了解这些系统是如何工作的，以便您可以使用最佳方法控制它们.
...
精选播放列表：`隐私与安全`、`Emacs 教会`、`命令行`、`Arch 方式`.  \
<br />
...
内容关于：Linux 教程、发行版评论、Linux 指南 \
精选播放列表：`硬件评论`、`Linux 基础知识`、`Linux 初学者命令`.  \
<br />
...
内容：Adobe Illustrator、Adobe Photoshop、手绘图\
精选播放列表：`Adobe Illustrator 教程`、`角色插图 Illustrator 教程`、`Adobe Illustrator 工具教程`.
...
内容关于：Procreate, Ipad/平板绘图 \
精选播放列表：`PROCREATE TUTORIALS`、`DIGITAL ART TUTORIALS`、`iPad Pro 上的数字绘图 |  Easy Drawing Tutorials`，`更多播放列表！`.
...
内容：全部设计、插画、网页设计\
特色播放列表：`学习 Adob​​e Photoshop`、`了解字体`、`照片和视频处理播放列表`、`Figma 视频`、`学习照片效果`.
...
内容关于：Inkscape、Gimp \
精选播放列表：`Inkscape 初学者教程`、`GIMP 教程`、`Inkscape 字体教程`、`Inkscape 徽标设计教程`.
...
内容关于：网页、平面设计\
精选播放列表：“设计职业”、“工作流程”、“设计聊天”、“作为设计师的自由职业”.  \
<br />
...
有关音频和视频制作的教程. 包括广泛的主题，例如设计、动画、渲染、硬件等. 使用最流行和最好的软件来制作令人惊叹的视频动画、制作精良的歌曲以及与这些主题相关的内容.
...
内容关于：视频、照片 \
精选播放列表：`Video Editing`、`Manipulation PicsArt`、`许多其他视频/照片编辑视频`.  \
<br />
...
内容关于：Blender，3D建模\
精选播放列表：`Blender 新手教程系列`、`Blender 椅子造型教程`、`沙发教程系列`.
...
内容关于：视频、照片 \
特色播放列表：`Shading with nodes`.`Making looping animations with Blender in Eevee engine` \
<br />


## Hardware

 CPU、主板、显示器、键盘、鼠标、个人电脑/笔记本电脑和所有硬件. 调制解调器和路由器也可以在这里找到，以及最新的电话和其他技术产品. 获取有关这些产品的建议和价格/质量比较.
...
内容关于：印刷\
精选播放列表：`3D 打印初学者`、`3D 打印`、`Ender 播放列表`、`Onshape 3D 建模`、`打印机评论播放列表`.
...
内容：所有硬件\
精选播放列表：`构建指南、购买者指南和终极指南`、`计算机系统和一体机`、`CPU、主板、内存视频`、`更多`.
...
内容：所有硬件\
特色播放列表：“硬件新闻”、“PC 机箱评论”、“预制游戏 PC 评论”、“更多”.  \
<br />
...
内容：所有硬件\
精选播放列表：`PC Building`、`GPU`、`Custom Builds`.  \
<br />
...
内容：树莓派、电子、操作系统 \
特色播放列表：`人工智能`、`Pi 零项目`、`迁移到 Linux`、`更多`.  \
<br />
...
内容关于：Raspberry Pi、电子产品、操作系统、单板计算机、游戏 \
...
大多数公司的面试过程都涉及编码挑战. 竞争性编程就像在 Internet 上举行的一项运动，程序员将在其中相互竞争. 下面的列表包含一些您可以遵循的渠道，以提高您的竞争性编程技能.
...
内容：系统设计、数据结构和算法 \
精选播放列表：`System Design`、`Competitive Programming AZ`.  \
<br />
...
内容关于： 大规模系统设计 \
精选播放列表：`系统设计应了解的算法`、`系统设计基础知识`、`系统设计面试`.
...
内容关于：Leetcode，软件工程面试 \
精选播放列表：`树、二叉树和二叉搜索树`、`排序、搜索和堆`、`动态编程、递归和回溯`、`图、贪心算法和其他`. 
<br />
...
内容关于：Leetcode，Codeforces \
精选播放列表：`Codeforces Problems`、`Leetcode Coding Interview Problems`.  \
<br />
...
内容关于：Leetcode，编程面试 \
精选播放列表：`LeetCode East`、`LeetCode Medium`、`LeetCode Hard`.  \
<br />
...
内容关于：Leetcode, HackerRank, Coding Interview \
精选播放列表：`LeetCode 解决方案`、`HackerRank 解决方案`.  \
<br />
...
内容关于：Code Chef，Codeforces \
精选播放列表：`Codeforces Screencasts`.  \
<br />
...
内容关于：算法，数据结构\
精选播放列表：`Network Flow 播放列表`、`Data structures 播放列表`、`Graph Theory 播放列表`、`Tree Algoritms`、`Dynamic Programming`.
...
在观看这些教程时，您的专业方面可以得到加强. 重要的是要知道如何管理您的钱并跟踪它，以及获得您想要的工作或自己开始一份工作的技巧. 还可以找到编码/设计/科技公司的面试方法.
...
内容：求职、通用技能、生活小窍门 \
特色播放列表：`寻找工作`、`经济思维播放列表`、`办公套件教程`、`做决定`、`生活技能播放列表`、`等等！`.
...
内容关于：通过来源创作、免费且无广告向好奇的公众普及计算.  \
精选播放列表：`Man`、`Rumors`、`Hot`、`Questions GEEKes`.


<details>
	<summary>学分</summary>
	<sub>请注意，这<strong>不是</strong>任何类型的促销列表.</sub>
	<br />
	<sub>列表样式深受<a href="https://github.com/mhxion">mhxion</a>创建的<a href="https://github.com/mhxion/awesome-discord-communities">awesome-discord-communities</a>的启发.</sub> <sub>这个存储库是我的灵感，因为我认为<a href="https://github.com/JoseDeFreitas/awesome-youtubers">这个列表</a>在这个文件中使用相同的表格样式以及有用的<a href="/badges/README.md">badges/README</a>看起来也不错.</sub>
	<br />
	awesome-youtubers 标志和相应的徽章/README 图标由<a href="https://github.com/JoseDeFreitas/">José De Freitas</a>制作.
	<br />
	 badges/README 是在没有遵循任何设计结构的情况下创建的，尽管<a href="/badges/logo.svg">awesome-youtubers 徽标</a>的灵感来自<a href="https://github.com/sindresorhus/awesome/blob/main/badges/logo.svg">awesome 徽标</a>和<a href="https://github.com/sindresorhus/awesome-nodejs/blob/master/badges/logo.svg">awesome-nodejs 徽标</a>. 这两个播放图标是在<a href="https://lh3.googleusercontent.com/z6Sl4j9zQ88oUKNy0G3PAMiVwy8DzQLh_ygyvBXv0zVNUZ_wQPN_n7EAR2By3dhoUpX7kTpaHjRPni1MHwKpaBJbpNqdEsHZsH4q">YouTube 徽标</a>的播放按钮之后创建的. 这只是一种表现形式，我并没有使用 YouTube 徽标本身.
</details>
