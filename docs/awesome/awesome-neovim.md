...
- [wbthomason/packer.nvim](https://github.com/wbthomason/packer.nvim)  - 受使用包启发的插件管理器. 使用原生包，支持 Luarock 依赖，用 Lua 编写，允许表达性配置.
...
- [neovim/nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) - LSP 客户端的快速入门配置.
...
- [onsails/lspkind.nvim](https://github.com/onsails/lspkind.nvim) - 该插件为 Neovim LSP 完成添加了类似 vscode 的图标.
- [ojroques/nvim-lspfuzzy](https://github.com/ojroques/nvim-lspfuzzy) - 一个让 LSP 客户端使用 FZF 的小插件.
- [gfanto/fzf-lsp.nvim](https://github.com/gfanto/fzf-lsp.nvim) - 为内置 LSP 的 Neovim 启用 FZF 模糊搜索功能.
...
- [tamago324/nlsp-settings.nvim](https://github.com/tamago324/nlsp-settings.nvim) - 使用 JSON 文件设置 LSP 的插件.
...
- [mfussenegger/nvim-lint](https://github.com/mfussenegger/nvim-lint) - 一个异步 linter 插件，补充内置的语言服务器协议支持.
- [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) - 提供访问 [SchemaStore](https://github.com/SchemaStore/schemastore) 目录.
...
- [Kasama/nvim-custom-diagnostic-highlight](https://github.com/Kasama/nvim-custom-diagnostic-highlight) - 内联诊断弹出高亮非常类似于 coc-nvim，但基于 `vim.diagnostic`.
...
- [ranjithshegde/ccls.nvim](https://github.com/ranjithshegde/ccls.nvim) - 使用不合规格的 ccls LSP 扩展并浏览 AST.
...
- [~whynothugo/lsp_lines.nvim](https://git.sr.ht/~whynothugo/lsp_lines.nvim) - 在真实代码行之上使用虚拟行渲染诊断.
...
- [hrsh7th/nvim-cmp](https://github.com/hrsh7th/nvim-cmp)  - 用 Lua 编写的完成插件. 新版本的 nvim-compe.
  - [hrsh7th/cmp-nvim-lsp](https://github.com/hrsh7th/cmp-nvim-lsp) - 一个 nvim-cmp 源内置 LSP 客户端.
...
- [brendalf/mix.nvim](https://github.com/brendalf/mix.nvim) - 混合（来自 Elixir）包装插件.
...
- [crusj/hierarchy-tree-go.nvim](https://github.com/crusj/hierarchy-tree-go.nvim) - 用于 Golang 的 Neovim 插件，callHierarchy UI 树.
...
- [ofirgall/open.nvim](https://github.com/ofirgall/open.nvim) - 使用自定义打开器打开当前单词，例如 GitHub 速记.
...
- [vijaymarupudi/nvim-fzf](https://github.com/vijaymarupudi/nvim-fzf)  - 用于使用 FZF (Neovim &gt;= 0.5) 的 Lua API. 允许 UI 速度和可用性的完全异步.
...
- [kevinhwang91/rnvimr](https://github.com/kevinhwang91/rnvimr) - 一个简单而神奇的文件浏览器.
- [Xuyuanp/yanil](https://github.com/Xuyuanp/yanil) - Lua 中的又一棵书呆子树.
- [ms-jpq/chadtree](https://github.com/ms-jpq/chadtree)  - 文件管理器. 比NERDTree好.
- [is0n/fm-nvim](https://github.com/is0n/fm-nvim) - Neovim 插件，可让您使用您最喜欢的终端文件管理器（和模糊查找器）.
...
- [NvChad/nvim-colorizer.lua](https://github.com/NvChad/nvim-colorizer.lua) - 没有外部依赖的高性能彩色荧光笔！.
...
- [shaeinst/roshnivim-cs](https://github.com/shaeinst/roshnivim-cs) - 用 Lua 编写的配色方案，专为 roshnivim 制作，支持 Tree-sitter.
...
- [Mofiqul/vscode.nvim](https://github.com/Mofiqul/vscode.nvim) - 带有 vscode 浅色和深色主题的 vim-code-dark 色彩方案的 Lua 端口.
- [marko-cerovac/material.nvim](https://github.com/marko-cerovac/material.nvim) - Material.nvim 是一个高度可配置的配色方案，用 Lua 编写并基于材质调色板.
- [bluz71/vim-nightfly-colors](https://github.com/bluz71/vim-nightfly-colors) - 具有现代 Neovim 支持的黑暗午夜配色方案，包括 Tree-sitter.
- [bluz71/vim-moonfly-colors](https://github.com/bluz71/vim-moonfly-colors) - 带有现代 Neovim 支持的深木炭配色方案，包括 Tree-sitter.
...
- [rockerBOO/boo-colorscheme-nvim](https://github.com/rockerBOO/boo-colorscheme-nvim) - 一种对 LSP、Tree-sitter 的手工支持的配色方案.
...
- [bkegley/gloombuddy](https://github.com/bkegley/gloombuddy) - 忧郁灵感的主题.
- [Th3Whit3Wolf/one-nvim](https://github.com/Th3Whit3Wolf/one-nvim) - Atom One 启发了深色和浅色配色方案.
- [PHSix/nvim-hybrid](https://github.com/PHSix/nvim-hybrid) - 用 Lua 编写的 Neovim 配色方案.
- [Th3Whit3Wolf/space-nvim](https://github.com/Th3Whit3Wolf/space-nvim) - spacemacs 启发了深色和浅色配色方案.
...
- [savq/melange](https://github.com/savq/melange) - 深色方案和 Vim ️.
...
- [ishan9299/nvim-solarized-lua](https://github.com/ishan9299/nvim-solarized-lua) - Lua 中的日晒配色方案（Neovim &gt;= 0.5）.
- [shaunsingh/moonlight.nvim](https://github.com/shaunsingh/moonlight.nvim) - 移植 VSCode 的 Moonlight 色彩方案，用 Lua 编写，内置支持原生 LSP、Tree-sitter 和更多插件.
...
- [adisen99/codeschool.nvim](https://github.com/adisen99/codeschool.nvim) - 使用 Lua 编写的 Codeschool 配色方案，具有 Tree-sitter 和内置 lsp 支持.
...
- [kvrohit/substrata.nvim](https://github.com/kvrohit/substrata.nvim) - 用 Lua 编写的冷色、深色配色方案，移植自 [arzg/vim-substrata](https://github.com/arzg/vim-substrata) 主题.
...
- [adisen99/apprentice.nvim](https://github.com/adisen99/apprentice.nvim) - 基于 Lua 编写的配色方案 [Apprentice](https://github.com/romainl/Apprentice) 具有 Tree-sitter 和内置 lsp 支持的颜色模式.
- [olimorris/onedarkpro.nvim](https://github.com/olimorris/onedarkpro.nvim)  - 一个 Dark Pro 主题，用 Lua 编写，基于 VS Code 主题. 包括具有完全可定制的颜色、样式和亮点的深色和浅色主题.
...
- [tiagovla/tokyodark.nvim](https://github.com/tiagovla/tokyodark.nvim) - 用 Lua (Neovim &gt;= 0.5) 及更高版本编写的干净的黑暗主题.
...
- [kvrohit/rasmus.nvim](https://github.com/kvrohit/rasmus.nvim) - 用 Lua 编写的深色方案，移植自 [rsms/sublime-theme](https://github.com/rsms/sublime-theme) 主题.
...
- [meliora-theme/neovim](https://github.com/meliora-theme/neovim) - 温暖舒适的主题.
...
- [kvrohit/mellow.nvim](https://github.com/kvrohit/mellow.nvim) - 舒缓的深色配色方案，支持护树员.
...
- [metalelf0/jellybeans-nvim](https://github.com/metalelf0/jellybeans-nvim) - 软糖配色方案的港口.
- [lalitmee/cobalt2.nvim](https://github.com/lalitmee/cobalt2.nvim) - 使用 colorbuddy 的 Cobalt2 配色方案端口.
...
- [adelarsq/neoline.vim](https://github.com/adelarsq/neoline.vim) - 使用 Lua 的轻量状态栏/表格插件.
...
- [datwaft/bubbly.nvim](https://github.com/datwaft/bubbly.nvim) - 气泡状态行.
- [beauwilliams/statusline.lua](https://github.com/beauwilliams/statusline.lua) - 用 Lua 编写的零配置最小状态行，具有出色的集成和超快的速度！
- [tamton-aquib/staline.nvim](https://github.com/tamton-aquib/staline.nvim)  - Lua 中的现代轻量级状态栏. 主要使用 unicode 符号来显示信息.
- [feline-nvim/feline.nvim](https://github.com/feline-nvim/feline.nvim) - 用 Lua 编写的简约、时尚和可定制的状态栏.
- [windwp/windline.nvim](https://github.com/windwp/windline.nvim)  - 下一代状态栏. 动画状态栏.
...
- [yamatsum/nvim-cursorline](https://github.com/yamatsum/nvim-cursorline) - 一个突出光标词和行的插件.
...
- [glepnir/dashboard-nvim](https://github.com/glepnir/dashboard-nvim) - 受doom-emacs 启发的简约仪表板.
- [goolord/alpha-nvim](https://github.com/goolord/alpha-nvim) - 一个快速且高度可定制的迎宾员，例如 [vim-startify](https://github.com/mhinz/vim-startify)/dashboard-nvim.
...
- [ziontee113/icon-picker.nvim](https://github.com/ziontee113/icon-picker.nvim) - 帮助您挑选字体字符、符号 Σ、Nerd 字体图标  和表情符号✨.
...
- [andweeb/presence.nvim](https://github.com/andweeb/presence.nvim) - 用 Lua 编写的快速和精简的 Discord Rich Presence 插件.
- [Chaitanyabsrip/present.nvim](https://github.com/Chaitanyabsprip/present.nvim) - 一个用 Lua 编写的演示插件.
...
- [rcarriga/nvim-notify](https://github.com/rcarriga/nvim-notify) - 一个花哨的、可配置的通知管理器.
- [folke/noice.nvim](https://github.com/folke/noice.nvim) - 高度实验性的插件，完全取代了消息、命令行和弹出菜单的 UI.
- [saifulapm/chartoggle.nvim](https://github.com/saifulapm/chartoggle.nvim) - 在行尾切换任何字符.
...
- [nguyenvukhang/nvim-toggler](https://github.com/nguyenvukhang/nvim-toggler) - 反转文本，例如在“真”和“假”之间切换.
...
- [jbyuki/instant.nvim](https://github.com/jbyuki/instant.nvim) - 一个用 Lua 编写的协作编辑插件，没有依赖关系.
- [numToStr/BufOnly.nvim](https://github.com/numToStr/BufOnly.nvim) - BufOnly.vim 的 Lua/Neovim 端口进行了一些更改.
- [zbirenbaum/neodim](https://github.com/zbirenbaum/neodim) - 使未使用的函数、变量、参数等的亮点变暗.
- [bfredl/nvim-miniyank](https://github.com/bfredl/nvim-miniyank) - 没有默认映射的类似 killring 的插件.
...
- [norcalli/nvim-terminal.lua](https://github.com/norcalli/nvim-terminal.lua) - 一种高性能文件类型模式，利用正确的颜色代码隐藏和突出显示缓冲区.
...
- [hkupty/iron.nvim](https://github.com/hkupty/iron.nvim) - 嵌入了超过 30 种语言的交互式 REPL.

### Neovim Lua Development

- [tjdevries/nlua.nvim](https://github.com/tjdevries/nlua.nvim) - Lua 开发.
...
- [bfredl/nvim-luadev](https://github.com/bfredl/nvim-luadev)  - REPL/调试控制台 Lua 插件.  `:Luadev` 命令将打开一个临时窗口，该窗口将显示执行 Lua 代码的输出.
...
- [udayvir-singh/tangerine.nvim](https://github.com/udayvir-singh/tangerine.nvim) - Sweet :tangerine: Fennel 集成，旨在尽可能快.
- [udayvir-singh/hibiscus.nvim](https://github.com/udayvir-singh/hibiscus.nvim) - 调味 :hibiscus: Fennel 宏库.
...
- [TimUntersberger/neogit](https://github.com/TimUntersberger/neogit) - 一个 Magit 克隆，它可能会改变一些东西以适应 Vim 哲学.
...
- [tanvirtin/vgit.nvim](https://github.com/tanvirtin/vgit.nvim) - 可视化 Git 插件来增强您的 git 体验.
- [sindrets/diffview.nvim](https://github.com/sindrets/diffview.nvim) - 单个标签页界面，可轻松循环浏览任何 git rev 的所有修改文件的差异.
- [kdheepak/lazygit.nvim](https://github.com/kdheepak/lazygit.nvim) - 调用lazygit的插件.
...
- [Weissle/easy-action](https://github.com/Weissle/easy-action) - 在您可以看到的地方轻松执行操作.
...
- [mrjones2014/legendary.nvim](https://github.com/mrjones2014/legendary.nvim) - 将您的键盘映射、命令和自动命令定义为简单的 Lua 表，并同时为它们创建一个图例（如 VS Code 的命令面板），与 `which-key.nvim` 集成.
...
- [gorbit99/codewindow.nvim](https://github.com/gorbit99/codewindow.nvim) - Minimap 插件，与treesitter 和内置LSP 紧密集成，向用户显示更多信息.
...
- [ZhiyuanLck/smart-pairs](https://github.com/ZhiyuanLck/smart-pairs) - Lua 编写的终极智能配对.
...
- [p00f/nvim-ts-rainbow](https://github.com/p00f/nvim-ts-rainbow) - Rainbow :rainbow: 括号使用 tree-sitter :rainbow:.
...
- [Pocco81/HighStr.nvim](https://github.com/Pocco81/HighStr.nvim) - 突出显示视觉选择，就像在普通文档编辑器中一样！
...
- [numToStr/Comment.nvim](https://github.com/numToStr/Comment.nvim)  - 智能强大的评论插件. 支持注释字符串、动作、点重复等.
...
- [mhartington/formatter.nvim](https://github.com/mhartington/formatter.nvim) - 用 Lua 编写的格式运行器.
...
- [beauwilliams/focus.nvim](https://github.com/beauwilliams/focus.nvim)  - 用 Lua 编写的自动聚焦和自动调整分割/窗口大小！  Vim 在类固醇上分裂.
...
- [nyngwang/NeoNoName.lua](https://github.com/nyngwang/NeoNoName.lua) - 保留布局的缓冲区删除器.
...
- [aserowy/tmux.nvim](https://github.com/aserowy/tmux.nvim) - Tmux 集成功能窗格移动和调整大小.
...
- [Neovimcraft](https://neovimcraft.com) - 一个专门用于搜索特定插件和在 Lua 中构建插件的指南的站点.
