...
- [rktjmp/pact.nvim](https://github.com/rktjmp/pact.nvim) - 语义版本感知插件管理器.
...
- [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) - 提供对 [SchemaStore](https://github.com/SchemaStore/schemastore) catalog.
...
- [GitHub/copilot.vim](https://github.com/github/copilot.vim) - GitHub 副驾驶.
...
- [ray-x/web-tools.nvim](https://github.com/ray-x/web-tools.nvim) - 启动具有静态和动态页面实时重新加载功能的本地开发服务器，使用 LSP 重命名 HTTP 和 CSS 标签.
...
- [rmehri01/onenord.nvim](https://github.com/rmehri01/onenord.nvim) - 结合了 Nord 和 Atom One Dark 调色板的 Neovim 主题，提供更生动的编程体验.
...
- [feline-nvim/feline.nvim](https://github.com/feline-nvim/feline.nvim) - 用 Lua 编写的最小、时尚和可定制的状态栏.
...
- [folke/lua-dev.nvim](https://github.com/folke/lua-dev.nvim) - init.Lua 的开发设置和插件开发，具有完整的签名帮助、文档和 Neovim Lua API 的完成.
...
- [p00f/nvim-ts-rainbow](https://github.com/p00f/nvim-ts-rainbow) - Rainbow :rainbow: 圆括号使用 tree-sitter :rainbow:.
...
- [emileferreira/nvim-strict](https://github.com/emileferreira/nvim-strict) - 通过暴露深层嵌套、超长行、尾随空格、尾随空行和不一致的缩进，严格执行可配置的最佳实践代码风格.
