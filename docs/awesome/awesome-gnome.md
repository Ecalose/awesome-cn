...
- [Junction](https://junction.sonny.re/)  - Junction 允许您选择打开文件和链接的应用程序.  ![GNOME 圈子][GNOME 圈子]
...
- [Arc Menu](https://gitlab.com/arcmenu/Arc-Menu) - 类似 Windows7 的应用程序菜单，灵感来自 Zorin OS 中的菜单.
...
- [Compiz alike windows effect](https://github.com/hermes83/compiz-alike-windows-effect) - 为窗户添加摇晃效果.
- [Useless Gaps](https://github.com/mipmip/gnome-shell-extensions-useless-gaps) - 出于审美目的，在平铺和最大化的窗口周围添加无用的间隙.
