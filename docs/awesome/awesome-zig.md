...
* [fengb/zee_alloc](https://github.com/fengb/zee_alloc) - 主要针对 WebAssembly 的微型分配器.
...
* [markfirmware/zig-bare-metal-microbit](https://github.com/markfirmware/zig-bare-metal-microbit) - 裸机微位程序.
...
* [oven-sh/bun](https://github.com/oven-sh/bun) - 令人难以置信的快速 JavaScript 运行时、捆绑器、转译器和包管理器 – 集于一身.
...
## Database
* [coilhq/tigerbeetle](https://github.com/coilhq/tigerbeetle) - 专为关键任务安全性和性能而设计的分布式财务会计数据库.
* [kristoff-it/redis-cuckoofilter](https://github.com/kristoff-it/redis-cuckoofilter) - 用于 Redis 的散列函数不可知的布谷鸟过滤器.
...
* [vrischmann/zig-cassandra](https://github.com/vrischmann/zig-cassandra) - Cassandra 2.1+ 客户端.
...
* [Tetralux/sublime-zig](https://github.com/Tetralux/sublime-zig) - 我自己的，更轻量级的 Zig 语法突出显示.
...
## Games
* [Akuli/curses-minesweeper](https://github.com/Akuli/curses-minesweeper) - 用 curses 编写的扫雷游戏.
...
* [MasterQ32/ZigPaint](https://github.com/MasterQ32/ZigPaint)  - 一个简单的油漆应用程序. 用于创建 OpenGL 加载器/包装器和最小 UI 系统.
...
* [kprotty/zap](https://github.com/kprotty/zap) - 一组库，提供系统接口以编写高性能应用程序.
...
* [ynuwenhof/zigbraten](https://github.com/ynuwenhof/zigbraten) - Cube 2 的概念内部作弊证明：Sauerbraten.
