...
## What is Magento?
 ...
 Magento 是一个开源电子商务应用程序，可让您创建网上商店. 我们经常谈到前端（
客户购买产品的店面）和后端（客户和产品所在的 Magento 管理面板
管理）. 开源位是指 Magento 的源代码（PHP、HTML、CSS、JS、XML 等）
是根据开源许可证 (OSLv3) 分发的，允许任何人重用代码并对其进行更改. 这个
开源方面导致 Magento 产品大受欢迎，以至于我们经常使用 Magento 这个词来
指产品、产品周围的社区或两者兼而有之.

Magento 由一家名为 Varien 的公司创立，随着 Magento 版本 1（2008 年首次发布）的推出，人气开始增长.
...
- [MageUnconference 🇩🇪](https://www.mageunconference.org/) - 在德国举行的 Magento Unconference.
...
认识 Magento 活动将商家、开发人员、解决方案和技术提供商等所有人聚集在一起，以及 
营销人员——我们还在继续扩张. 

- [Meet Magento New York](https://meetmagentonyc.com/) - 认识纽约 Magento 
...
- [mage2.docker](https://github.com/aliuosio/mage2.docker) - Nginx(Pagespeed)、MariaDB、PHP、Redis、弹性搜索
  带有 Magento 2 安装程序的配置器（更新：2020 年 4 月 19 日）
- [markshust/docker-magento](https://github.com/markshust/docker-magento) - Mark Shust 的 Docker 配置
  Magento
- [Warden](https://github.com/davidalger/warden) - 用于 docker-compose 环境的 CLI 实用程序
...
- [Magento 2 Composer patches helper](https://chrome.google.com/webstore/detail/magento-2-composer-patche/gfndadbceejgfjahpfaijcacnmdloiad)
    - Chrome 扩展为 vaimo/composer-patches 创建可复制粘贴的作曲家补丁定义.
...
- [Magento Cache Clean](https://github.com/mage2tv/magento-cache-clean) - 更换 bin/magento 的速度更快
  缓存：通过 Vinai Kopp 使用文件观察器清理](https://twitter.com/vinaikopp)
...
- Scopehints](https://github.com/avstudnitz/AvS_ScopeHint2) - 在存储配置中显示附加信息
  [安德烈亚斯·冯·斯图德尼茨.
- [Magento 2 Configurator](https://github.com/ctidigital/magento2-configurator) - 一个 Magento 模块最初由
...
- [Magento 2 PHPStorm File Templates](https://github.com/lfolco/phpstorm-m2-filetemplates) - PHPStorm Magento 2 文件
  模板.
- [MageVulnDB](https://github.com/gwillem/magevulndb) - 已知第三方 Magento 扩展的中央存储库
  安全问题.
...
- [Mageplaza Blog Extension](https://github.com/mageplaza/magento-2-blog-extension) - 简单但运行良好的博客
  扩大.
...
- [Opengento GDPR](https://github.com/opengento/magento2-gdpr) - Magento 2 GDPR 模块是必须具有的扩展
  世界上使用的最大的电子商务CMS. 该模块有助于符合 GDPR.
...
- [Magento 2 Import Framework](https://github.com/techdivision/import) - 支持通用 Magento 2 导入的库
  功能性
- [Menu Editor](https://github.com/SnowdogApps/magento2-menu) - 提供强大的菜单编辑器来替换基于类别
  Magento 2 中的菜单.
...
- [Reset Customer Password](https://github.com/Vinai/module-customer-password-command) - 设置客户密码
  bin/magento 由 [Vinai Kopp](https://github.com/Vinai/).
...
- [Reset UI Bookmarks](https://github.com/magenizr/Magenizr_ResetUiBookmarks) - 重置 UI 书签允许管理员用户
  重置他们自己的 UI 书签，例如过滤器状态、列位置和应用排序（例如 Sales &gt; Orders）.
...
- [Magicento](http://magicento.com/) - [PHPStorm](https://www.jetbrains.com/phpstorm/) 添加 Magento 2 相关的插件
  功能.
...
- [magento-notes/magento2-exam-notes](https://github.com/magento-notes/magento2-exam-notes) - 准备说明
...
- [magento-notes/magento2-cloud-developer-notes](https://github.com/magento-notes/magento2-cloud-developer-notes) -
  Magento 2 Certified Professional Cloud Developer 考试的备考说明
- [roma-glushko/magento2-dev-plus-exam](https://github.com/roma-glushko/magento2-dev-plus-exam) - 准备说明
...
- [Magento 2 data migration tool](https://github.com/magento/data-migration-tool) - 官方 Magento 1 到 Magento 2
  迁移工具.
- [Magento Coding Standards](https://github.com/magento/magento-coding-standard) - 官方 Magento2 高级套装
  PHP_CodeSniffer 的规则.
...
- [Awesome Magento](https://github.com/sunel/awesome-magento) - 具有混合 M1 和 M2 内容的超棒 Magento 列表
...
在法律允许的范围内，David Lambauer 已放弃本文档的所有版权和相关或邻接权
work.
