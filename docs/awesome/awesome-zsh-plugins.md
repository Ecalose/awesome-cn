...
- [fd](https://github.com/aubreypwd/zsh-plugin-fd) - 利用 [fzf](https://github.com/junegunn/fzf) to browse directories.
...
- [znvm](https://github.com/Ajnasz/znvm) - 如同 [nvm.sh](https://github.com/nvm-sh/nvm) 但更快.
