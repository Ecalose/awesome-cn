...
<div align="center">
	...
	<br>
	<p>
		<a href="https://en.wikipedia.org/wiki/Node.js">Node.js</a>是一种开源、跨平台的 JavaScript 运行时，用于编写服务器和命令行工具.
	</p>
	<br>
</div>
...
- [webtorrent](https://github.com/webtorrent/webtorrent) - 用于 Node.js 和浏览器的流式 torrent 客户端.
...
- [npm-name](https://github.com/sindresorhus/npm-name) - 检查包名称在 npm 上的可用性.
- [gh-home](https://github.com/sindresorhus/gh-home) - 打开当前目录中 repo 的 GitHub 页面.
- [npm-home](https://github.com/sindresorhus/npm-home) - 打开包的 npm 页面.
- [trash](https://github.com/sindresorhus/trash) - 比 rm 更安全的替代品.
...
- [fkill](https://github.com/sindresorhus/fkill-cli)  - 出色地终止进程. 跨平台.
...
- [tmpin](https://github.com/sindresorhus/tmpin) - 为接受文件输入的任何 CLI 应用程序添加标准输入支持.
...
- [cost-of-modules](https://github.com/siddharthkp/cost-of-modules) - 找出哪些依赖项正在减慢你的速度.
...
- [themer](https://github.com/themerdev/themer) - 为您的编辑器、终端、墙纸、Slack 等生成主题.
- [carbon-now-cli](https://github.com/mixn/carbon-now-cli) - 代码的精美图片——来自您的终端.
- [cash-cli](https://github.com/xxczaki/cash-cli) - 在 170 种货币之间进行转换.
...
- [lodash](https://github.com/lodash/lodash)  - 提供一致性、定制化、性能和附加功能的实用程序库. 更好更快的 Underscore.js.
...
- [undici](https://github.com/nodejs/undici) - 从头开始​​编写的高性能 HTTP 客户端，具有零依赖性.
...
- [axios](https://github.com/axios/axios) - 基于承诺的 HTTP 客户端（也适用于浏览器）.
...
- [cacheable-request](https://github.com/lukechilds/cacheable-request) - 使用符合 RFC 的缓存支持包装本机 HTTP 请求.
- [gotql](https://github.com/khaosdoctor/gotql) - GraphQL 请求库建立在 [got](https://github.com/sindresorhus/got).
- [global-agent](https://github.com/gajus/global-agent) - 可使用环境变量配置的全局 HTTP/HTTPS 代理程序.
- [smoke](https://github.com/sinedied/smoke) - 具有记录功能的基于文件的 HTTP 模拟服务器.
- [purest](https://github.com/simov/purest) - 休息客户端.

### Debugging / Profiling

- [debug](https://github.com/debug-js/debug) - 微型调试工具.
- [why-is-node-running](https://github.com/mafintosh/why-is-node-running) - Node.js 正在运行但您不知道为什么？
- [njsTrace](https://github.com/valyouw/njstrace) - 检测和跟踪您的代码，查看所有函数调用、参数、返回值，以及每个函数花费的时间.
- [vstream](https://github.com/joyent/node-vstream) - 可检测的流混合插件以检查流管道.
...
- [yargs](https://github.com/yargs/yargs) - 自动生成优雅的用户界面的命令行解析器.
...
- [cli-columns](https://github.com/shannonmoeller/cli-columns) - 列式 unicode 和 ansi 安全文本列表.
...
- [serialport](https://github.com/serialport/node-serialport) - 访问串口进行读写.
...
- [Fastify](https://github.com/fastify/fastify) - 快速且低开销的网络框架.
- [Next.js](https://github.com/vercel/next.js) - 服务器呈现的通用 JavaScript Web 应用程序的简约框架.
- [Nuxt.js](https://github.com/nuxt/nuxt.js) - 服务器呈现的 Vue.js 应用程序的简约框架.
...
- [LoopBack](https://github.com/loopbackio/loopback-next) - 用于创建 REST API 和轻松连接到后端数据源的强大框架.
...
- [documentation.js](https://github.com/documentationjs/documentation) - 支持 ES2015+ 和流注释的 API 文档生成器.
- [Docco](https://github.com/jashkenas/docco) - 生成 HTML 文档的文档生成器，该文档显示您的评论与您的​​代码混合在一起.
...
- 承诺
	...
	- [promise-memoize](https://github.com/nodeca/promise-memoize) - Memoize 承诺返回函数，带有过期和预取.
...
- [from2](https://github.com/hughsk/from2) - 受 `through2` 启发的 ReadableStream 的便利包装器.
- [into-stream](https://github.com/sindresorhus/into-stream) - 将缓冲区/字符串/数组/对象转换为流.
- [duplexify](https://github.com/mafintosh/duplexify) - 将可写和可读流转换为单个 streams2 双工流.
- [pumpify](https://github.com/mafintosh/pumpify) - 将一系列流组合成单个双工流.
- [peek-stream](https://github.com/mafintosh/peek-stream) - 转换流，让您在决定如何解析它之前查看第一行.
- [binary-split](https://github.com/maxogden/binary-split) - 换行符（或任何定界符）拆分流.
...
- [rpc-websockets](https://github.com/elpheria/rpc-websockets) - 通过 WebSockets 实现 JSON-RPC 2.0.
...
- [qrcode](https://github.com/soldair/node-qrcode) - QR 码和条形码生成器.
...
- [StegCloak](https://github.com/kurolabs/stegcloak) - 将秘密隐藏在字符串中，一目了然.
...
- [normalize-url](https://github.com/sindresorhus/normalize-url) - 标准化 URL.
...
- [remark](https://github.com/remarkjs/remark) - 由插件提供支持的 Markdown 处理器.
...
- [@parcel/css](https://github.com/parcel-bundler/parcel-css) - 用 Rust 编写的 CSS 解析器、转换器和缩小器.
- [strip-json-comments](https://github.com/sindresorhus/strip-json-comments) - 从 JSON 中删除注释.
- [strip-css-comments](https://github.com/sindresorhus/strip-css-comments) - 从 CSS 中删除注释.
- [parse-json](https://github.com/sindresorhus/parse-json) - 解析带有更多有用错误的 JSON.
...
- [neat-csv](https://github.com/sindresorhus/neat-csv)  - 快速 CSV 解析器. 以上的回调接口.
...
- [x-ray](https://github.com/matthewmueller/x-ray) - 网络抓取实用程序.
...
- [pretty-error](https://github.com/AriaMinaei/pretty-error) - 更少混乱的错误.
...
- [Archiver](https://github.com/archiverjs/node-archiver) - 存档生成的流接口，支持 ZIP 和 TAR.
- [pako](https://github.com/nodeca/pako) - 高速 zlib 端口到纯 js（放气、膨胀、gzip）.
- [tar-stream](https://github.com/mafintosh/tar-stream)  - 流式 tar 解析器和生成器. 另见 [tar-fs](https://github.com/mafintosh/tar-fs).
- [decompress](https://github.com/kevva/decompress) - 支持开箱即用的“tar”、“tar.gz”和“zip”文件的解压缩模块.
...
- ODM / ORM
	...
	- [Bookshelf](https://github.com/bookshelf/bookshelf) - Backbone.js 风格的 PostgreSQL、MySQL 和 SQLite3 的 ORM.
	...
	- [OpenRecord](https://github.com/PhilWaldmann/openrecord)  - 用于 PostgreSQL、MySQL、SQLite3 和 RESTful 数据存储的 ORM. 类似于活动记录.
	- [pg-promise](https://github.com/vitaly-t/pg-promise) - 使用承诺的原生 SQL 的 PostgreSQL 框架.
	- [slonik](https://github.com/gajus/slonik) - 具有严格类型、详细日志记录和断言的 PostgreSQL 客户端.
	- [Objection.js](https://github.com/Vincit/objection.js) - 基于 SQL 查询生成器 Knex 构建的轻量级 ORM.
...
- 其他
	...
	- [Finale](https://github.com/tommybananas/finale) - 用于您的 Sequelize 模型的 RESTful 端点生成器.
	...
	- [pg-mem](https://github.com/oguimbal/pg-mem) - 用于测试的内存中 PostgreSQL 实例.

### Testing

- [AVA](https://github.com/avajs/ava) - 未来的测试赛跑者.
- [Mocha](https://github.com/mochajs/mocha) - 功能丰富的测试框架使异步测试变得简单而有趣.
- [nyc](https://github.com/istanbuljs/nyc) - 基于 istanbul 构建的代码覆盖工具，可与子流程一起使用.
- [tap](https://github.com/tapjs/node-tap) - TAP 测试框架.
- [tape](https://github.com/substack/tape) - TAP 生产测试线束.
- [power-assert](https://github.com/power-assert-js/power-assert) - 通过标准断言接口提供描述性断言消息.
- [Mochify](https://github.com/mantoni/mochify.js) - 使用 Browserify、Mocha、PhantomJS 和 WebDriver 的 TDD.
- [trevor](https://github.com/vadimdemedes/trevor) - 针对多个版本的 Node.js 运行测试，无需手动切换版本或推送到 Travis CI.
- [loadtest](https://github.com/alexfernandez/loadtest) - 使用用于自动化的 API 为您的 Web 应用程序运行负载测试.
...
- [hook-std](https://github.com/sindresorhus/hook-std) - 挂钩并修改标准输出/标准错误.
...
- [Benchmark.js](https://github.com/bestiejs/benchmark.js) - 支持高分辨率计时器并返回统计显着结果的基准库.
...
- [fnm](https://github.com/Schniz/fnm) - 内置 Rust 的跨平台 Node.js 版本管理器.
...
- [nodemon](https://github.com/remy/nodemon) - 监控应用程序的变化并自动重启服务器.
- [node-mac](https://github.com/coreybutler/node-mac) - 将脚本作为本机 Mac 守护程序运行并登录到控制台应用程序.
- [node-linux](https://github.com/coreybutler/node-linux) - 将脚本作为本机系统服务运行并记录到系统日志.
- [node-windows](https://github.com/coreybutler/node-windows) - 将脚本作为本机 Windows 服务运行并记录到事件查看器.
- [supervisor](https://github.com/petruisfan/node-supervisor) - 当脚本崩溃时重新启动脚本，或者当 `*.js` 文件更改时重新启动.
- [Phusion Passenger](https://github.com/phusion/passenger) - 直接集成到 Nginx 中的友好流程管理器.

### Automation

- [robotjs](https://github.com/octalmage/robotjs) - 桌面自动化：控制鼠标、键盘和阅读屏幕.
- [nut.js](https://github.com/nut-tree/nut.js) - 跨平台原生 GUI 自动化/测试框架，具有与 Jest 集成的图像匹配功能.
...
- [ApostropheCMS](https://github.com/apostrophecms/apostrophe) - 内容管理系统，强调基于 Express 和 MongoDB 构建的直观前端内容编辑和管理.
...
- [supervillains](https://github.com/sindresorhus/supervillains) - 获取超级反派的名字.
- [cool-ascii-faces](https://github.com/maxogden/cool-ascii-faces) - 获得一些很酷的 ascii 面孔.
- [cat-ascii-faces](https://github.com/melaniecebula/cat-ascii-faces) - `₍˄ ͈༝ ͈˄₎◞ ̑̑ෆ⃛ (=ↀωↀ=)✧ (^･o･^)ﾉ”`.
- [nerds](https://github.com/SkyHacks/nerds) - 从哈利波特、星球大战和神奇宝贝等书呆子话题中获取数据.

### Serialization

- [snappy](https://github.com/kesla/node-snappy) - Google 的 Snappy 压缩库的本机绑定.
- [protobuf](https://github.com/protobufjs/protobuf.js) - 协议缓冲区的实施.
...
- [mem](https://github.com/sindresorhus/mem) - Memoize 函数 - 一种优化技术，用于通过缓存具有相同输入的调用结果来加速连续函数调用.
- [strip-bom](https://github.com/sindresorhus/strip-bom) - 从字符串/缓冲区/流中剥离 UTF-8 字节顺序标记 (BOM).
...
- [nodegit](https://github.com/nodegit/nodegit) - 本地绑定到 Git.
...
- [Node.js Best Practices](https://github.com/goldbergyoni/nodebestpractices) - 对 Node.js 最佳实践排名靠前的内容的总结和管理，提供多种语言版本.
...
- [Google I/O 2013 - Accelerating Oz with V8: Follow the Yellow Brick Road to JavaScript Performance](https://www.youtube.com/watch?v=VhpdsjBUS3g) - 如何使用 V8 知识检测应用程序瓶颈并优化性能.
- [Node.js Internal Architecture | Ignition, Turbofan, Libuv](https://www.youtube.com/watch?v=OCjvhCFFPTw) - Node.js 是如何在内部工作的，重点是 V8 和 libuv.
...
- [You Don't Know Node - ForwardJS San Francisco](https://www.youtube.com/watch?v=oPo4EQmkjvY) - 通过有关 V8、libuv、事件循环、模块、流和集群的测验来解释 Node.js 的内部结构.
...
- [webapplog.com](https://webapplog.com/tag/node-js/) - 来自 Practical Node.js 和 Pro Express.js Azat Mardan 作者的关于 Node.js 和 JavaScript 的博客文章.
...
- [Stream FAQs](https://github.com/stephenplusplus/stream-faqs) - 回答有关流的常见问题，涵盖分页、事件等.
- [Strong Node.js](https://github.com/jesusprubio/strong-node) - Node.js Web 服务的源代码安全分析清单.

### Tools

- [OctoLinker](https://chrome.google.com/webstore/detail/octolinker/jlmafbaeoofdegohdhinkhilhclaklkp) - 链接 GitHub 上 package.json、.js、.jsx、.coffee 和 .md 文件中依赖项的 Chrome 扩展.
...
- [Module Requests & Ideas](https://github.com/sindresorhus/project-ideas) - 请求一个你希望存在的 JavaScript 模块或获得模块的想法.
- [v8-perf](https://github.com/thlorenz/v8-perf) - 与 V8 和 Node.js 性能相关的注释和资源.
