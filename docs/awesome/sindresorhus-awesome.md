...
- [Electron](https://github.com/sindresorhus/awesome-electron#readme) - 使用 JavaScript/HTML/CSS 的跨平台本地桌面应用程序.
- [Cordova](https://github.com/busterc/awesome-cordova#readme) - 用于混合应用程序的 JavaScript API.
- [React Native](https://github.com/jondot/awesome-react-native#readme) - 用于为 iOS 和 Android 编写本机呈现移动应用程序的 JavaScript 框架.
...
- [Flutter](https://github.com/Solido/awesome-flutter#readme) - Google 的移动 SDK，用于从用 Dart 编写的单个代码库构建本机 iOS 和 Android 应用程序.
...
- [Firebase](https://github.com/jthegedus/awesome-firebase#readme) - 基于谷歌云平台构建的应用程序开发平台.
...
- [JavaScript](https://github.com/sorrycc/awesome-javascript#readme)
	...
	- [Standard Style](https://github.com/standard/awesome-standard#readme) - 风格指南和 linter.
	- [Must Watch Talks](https://github.com/bolshchikov/js-must-watch#readme)
	- [Tips](https://github.com/loverajoel/jstips#readme)
	- [Network Layer](https://github.com/Kikobeats/awesome-network-js#readme)
	- [Micro npm Packages](https://github.com/parro-it/awesome-micro-npm-packages#readme)
	- [Mad Science npm Packages](https://github.com/feross/awesome-mad-science#readme) - 存在的听起来不可能的项目.
	...
	- [npm scripts](https://github.com/RyanZim/awesome-npm-scripts#readme) - 任务亚军.
	- [30 Seconds of Code](https://github.com/30-seconds/30-seconds-of-code#readme) - 您可以在 30 秒内理解的代码片段.
	- [Ponyfills](https://github.com/Richienb/awesome-ponyfills#readme) - 类似于 polyfill，但不覆盖本机 API.
- [Swift](https://github.com/matteocrippa/awesome-swift#readme) - Apple 的编译编程语言，安全、现代、对程序员友好且快速.
...
- [Scala](https://github.com/lauris/awesome-scala#readme)
	- [Scala Native](https://github.com/tindzk/awesome-scala-native#readme) - 基于 LLVM 优化 Scala 的提前编译器.
...
- [Common Lisp](https://github.com/CodyReichert/awesome-cl#readme) - 促进迭代和交互式开发的强大的动态多范式语言.
	- [Learning](https://github.com/GustavBertram/awesome-common-lisp-learning#readme)
- [Perl](https://github.com/hachiojipm/awesome-perl#readme)
- [Groovy](https://github.com/kdabir/awesome-groovy#readme)
- [Dart](https://github.com/yissachar/awesome-dart#readme)
- [Java](https://github.com/akullpp/awesome-java#readme) - 流行的安全面向对象语言，专为“一次编写，随处运行”的灵活性而设计.
...
- [Ada/SPARK](https://github.com/ohenley/awesome-ada#readme) - 专为可靠性和效率至关重要的大型、长期应用程序而设计的现代编程语言.
...
- [jQuery](https://github.com/petk/awesome-jquery#readme) - 易于使用 JavaScript 库进行 DOM 操作.
...
- [Web Animation](https://github.com/sergey-pimenov/awesome-web-animation#readme) - 浏览器中使用 JavaScript、CSS、SVG 等的动画.
...
- [Lumen](https://github.com/unicodeveloper/awesome-lumen#readme) - PHP 微型框架.
...
- [Slim](https://github.com/nekofar/awesome-slim#readme) - PHP框架.
- [Fiber](https://github.com/gofiber/awesome-fiber#readme) - 建立在 Fasthttp 之上的 Web 框架，Fasthttp 是 Go 最快的 HTTP 引擎.
...
- [Machine Learning](https://github.com/josephmisiti/awesome-machine-learning#readme)
	...
	- [H2O](https://github.com/h2oai/awesome-h2o#readme) - 用 Ja​​va 编写的开源分布式机器学习平台，带有 R、Python 和 Scala 中的 API.
	...
	- [JAX](https://github.com/n2cholas/awesome-jax#readme) - 自动微分和 XLA 编译结合在一起用于高性能机器学习研究.
	- [XAI](https://github.com/altamiracorp/awesome-xai#readme) - 为机器学习方法提供洞察力、解释和可解释性.
- [Speech and Natural Language Processing](https://github.com/edobashira/speech-language-processing#readme)
	- [Spanish](https://github.com/dav009/awesome-spanish-nlp#readme)
	- [NLP with Ruby](https://github.com/arbox/nlp-with-ruby#readme)
	- [Question Answering](https://github.com/seriousran/awesome-qa#readme) - 使用机器以自然语言提问和回答的科学.
	- [Natural Language Generation](https://github.com/accelerated-text/awesome-nlg#readme) - 生成用于数据到文本、会话代理和叙述生成应用程序的文本.
...
- [Apache Spark](https://github.com/awesome-spark/awesome-spark#readme) - 统一的大规模数据处理引擎.
- [Qlik](https://github.com/ambster-public/awesome-qlik#readme) - 用于数据可视化、分析和报告应用程序的商业智能平台.
- [Splunk](https://github.com/sduff/awesome-splunk#readme) - 用于实时搜索、监控和分析结构化和非结构化机器生成的大数据的平台.
...
- [GitHub](https://github.com/phillipadsmith/awesome-github#readme) - Git 存储库的托管服务.
	...
	- [Pinned Gists](https://github.com/matchai/awesome-pinned-gists#readme) - 为您的 GitHub 配置文件动态固定要点.
...
- [PowerShell](https://github.com/janikvonrotz/awesome-powershell#readme) - 跨平台的面向对象外壳.
- [Alfred Workflows](https://github.com/alfred-workflows/awesome-alfred-workflows#readme) - 适用于 macOS 的生产力应用程序.
- [Terminals Are Sexy](https://github.com/k4m4/terminals-are-sexy#readme)
- [GitHub Actions](https://github.com/sdras/awesome-actions#readme) - 创建任务以自动化您的工作流程并与 GitHub 上的其他人共享.
...
- [GIF](https://github.com/davisonio/awesome-gif#readme) - 以动画图像着称的图像格式.
...
- [FFmpeg](https://github.com/transitive-bullshit/awesome-ffmpeg#readme) - 用于记录、转换和流式传输音频和视频的跨平台解决方案.
...
- [Electronics](https://github.com/kitspace/awesome-electronics#readme) - 适用于电子工程师和爱好者.
...
- [SNMP](https://github.com/eozer/awesome-snmp#readme) - 一种用于收集、修改和组织有关 IP 网络上受管设备信息的协议.
...
- [Creative Tech Events](https://github.com/danvoyce/awesome-creative-tech-events#readme) - 全球各地的创意编码、技术、设计、音乐、艺术和酷炫活动.
...
- [Playwright](https://github.com/mxschmitt/awesome-playwright#readme) - Node.js 库，用于使用单个 API 自动化 Chromium、Firefox 和 WebKit.
...
- [Scientific Writing](https://github.com/writing-resources/awesome-scientific-writing#readme) - 使用 Markdown、reStructuredText 和 Jupyter notebooks 进行无干扰的科学写作.
...
- [Gulp](https://github.com/alferov/awesome-gulp#readme) - 任务亚军.
...
- [Citizen Science](https://github.com/dylanrees/citizen-science#readme) - 对于基于社区和非机构的科学家.
...
- [TikZ](https://github.com/xiaohanyu/awesome-tikz#readme) - 用于 TeX/LaTeX/ConTeXt 的绘图包.
- [Ad-Free](https://github.com/johnjago/awesome-ad-free#readme) - 无广告替代品.
- [Esolangs](https://github.com/angrykoala/awesome-esolangs#readme) - 设计用于实验或作为笑话而不是实际使用的编程语言.
...
- [Ledger](https://github.com/sfischer13/awesome-ledger#readme) - 命令行上的复式记账.
...
- [Crypto Currency Tools & Algorithms](https://github.com/Zheaoli/awesome-coins#readme) - 使用加密来规范单位生成和验证传输的数字货币.
...
- [inspectIT](https://github.com/inspectit-labs/awesome-inspectit#readme) - 开源 Java 应用程序性能管理工具.
- [Open Source Maintainers](https://github.com/nayafia/awesome-maintainers#readme) - 成为开源维护者的经历.
- [Calculators](https://github.com/xxczaki/awesome-calculators#readme) - 每个平台的计算器.
- [Captcha](https://github.com/ZYSzys/awesome-captcha#readme) - 一种用于计算的挑战-响应测试，以确定用户是否是人类.
...
- [Board Games](https://github.com/edm00se/awesome-board-games#readme) - 所有人的桌面游戏乐趣.
...
- [Advertising](https://github.com/cenoura/awesome-ads#readme) - 网站广告和程序化媒体.
...
- [Awesome Viewer](https://awesome.digitalbunker.dev) - 上述所有精彩列表的可视化工具.
