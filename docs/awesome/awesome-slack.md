...
- [Slack.Webhooks](https://github.com/nerdfury/Slack.Webhooks) - 更轻松地使用 Slack webhook 的库
...
- [slack-php-app-framework](https://github.com/slack-php/slack-php-app-framework) - 强大的 PHP 框架，用于在 PHP 中构建 Slack 应用程序
...
- [simple-slack-api](https://github.com/Ullink/simple-slack-api) - Java 中的 Slack 客户端库
- [tasks-app](https://github.com/slackapi/tasks-app) - 由 Slack 制作的简单任务管理应用程序
