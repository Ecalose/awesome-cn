...
* [exkad](https://github.com/rozap/exkad) - 一个 [kademlia](https://en.wikipedia.org/wiki/Kademlia) 在 Elixir 中实现.
...
* [graphex](https://github.com/stocks29/graphex) - 用于在 elixir 中编写和执行任务图的库. [Docs](https://hexdocs.pm/graphex)
...
* [minmaxlist](https://github.com/seantanly/elixir-minmaxlist) - 扩展 `Enum.min_by/2`、`Enum.max_by/2` 和 `Enum.min_max_by/2` 的 Elixir 库返回结果列表而不是仅返回一个结果列表.
...
* [ueberauth_foursquare](https://github.com/borodiychuk/ueberauth_foursquare) - 适用于 Überauth 的 Foursquare OAuth2 策略.
...
* [sweetconfig](https://github.com/d0rc/sweetconfig) - 从您应用程序的任何位置读取 YAML 配置文件.
...
* [http_router](https://github.com/sugar-framework/elixir-http-router) - 带有各种宏的 HTTP 路由器，可帮助开发您的应用程序和组织您的代码.
...
* [meseeks](https://github.com/mischov/meeseeks) - 一个使用 CSS 或 XPath 选择器从 HTML 和 XML 中解析和提取数据的库.
...
* [Mechanize](https://github.com/gushonorato/mechanize) - 轻松构建网络抓取工具并自动与 Elixir 中的网站进行交互！
...
* [sparql_client](https://github.com/marcelotto/sparql_client) - 一个 [SPARQL protocol](https://www.w3.org/TR/sparql11-protocol/) Elixir 的客户端.
...
* [dummy](https://github.com/Vesuvium/dummy) - 一个 Elixir 模拟库，通过以正确的方式公开 meck 变得有意义 
...
* [near_api](https://github.com/alexfilatov/near_api) - 一个 [NEAR](https://near.org) Elixir 中的 API - 用于在 NEAR 区块链平台上开发 DApps 的库.
* [neotomex](https://github.com/jtmoulia/neotomex) - 一个 [PEG](http://bford.info/packrat/) 使用令人愉快的 Elixir DSL 实现.
...
* [riemann](https://github.com/koudelka/elixir-riemann) - 一个 [Riemann](http://riemann.io/) Elixir 的客户端.
...
* [getatrex](https://github.com/alexfilatov/getatrex) - Gettext 语言环境的自动翻译工具，带有用于 Elixir/Phoenix 项目的 Google Translate.
...
* [plugmap](https://github.com/nerdslabs/plugmap) - Plugmap 是 Plug/Phoenix Framework 的站点地图生成库. [Doc](https://hexdocs.pm/plugmap/readme.html)
...
* [meeseeks](https://github.com/mischov/meeseeks) - 一个使用 CSS 或 XPath 选择器从 HTML 和 XML 中解析和提取数据的库.
...
* [Elixir in Action](https://www.manning.com/books/elixir-in-action-second-edition) - Saša Jurić（2015 年）简要介绍了该语言，然后更详细地介绍了如何在 Elixir 中构建生产就绪系统.
