...
## Communication
- [Adium](http://www.alfredforum.com/topic/1274-adium-workflow/) - 与列表中的人聊天的 Adium 工作流程.
...
- [Slack](https://github.com/yannickglt/alfred-slack) - Alfred 工作流与服务 Slack 交互并执行各种功能.
...
- [caniuse](https://github.com/willfarrell/alfred-caniuse-workflow) - Caniuse.com 工作流查询 HTML / CSS 支持.
- [caniuse.rs](https://github.com/robjtede/alfred-caniuse-rs) - Rust 功能支持和版本信息来自 [caniuse.rs](https://caniuse.rs).
- [CDN](https://github.com/willfarrell/alfred-cdn-workflow) - 检查包托管在哪些 CDN 上.
- [Colors](http://www.packal.org/workflow/colors) - 转换颜色格式并访问 OS X 颜色面板.
- [Dash](https://kapeli.com/dash) - 允许您查询 Dash 以获取开发人员文档.
- [DevDocs](https://github.com/yannickglt/alfred-devdocs)  - Dash 的替代品. 允许您查询 [devdocs.io](https://devdocs.io/) 用于文档.
- [Fakeum](https://github.com/deanishe/alfred-fakeum) - 生成各种测试数据.
- [Font Awesome](https://github.com/ruedap/alfred2-font-awesome-workflow) - 快速查找很棒的字体图标并将所需的图标添加到剪贴板.
...
- [Pandoctor](https://github.com/smargh/alfred_pandoctor) - 阿尔弗雷德接口 [pandoc](http://pandoc.org)，一种允许在文本格式（Markdown、LaTeX、DOC、DOCX 等）之间进行转换的工具.
- [Unicode Text Search](https://github.com/bevesce/unicode-symbols-search) - 搜索 Unicode 符号.
- [VSCodeDiff](https://github.com/logicxd/alfred-vscodediff) - 使用 VSCode 显示剪贴板历史记录中最后 2 项的差异.

## Scientific
- [Convert](https://github.com/deanishe/alfred-convert) - 单位和（加密）货币的离线转换.
- [DOITools](https://github.com/hbuschme/doi-tools-alfred-workflow/) - 解析、打开、缩短 DOI 编号甚至将其转换为 bibtex 的工具.
- [Scientific Workflow](https://github.com/andrewning/alfred-workflows-scientific) - 对科学家有用的工作流程：例如 LaTeX，在 bibtex 中导入参考文献.
...
- [iMessage 2FA](https://github.com/squatto/alfred-imessage-2fa) - 在最近的 iMessage 消息中查找双因素身份验证代码.
...
- [Timing](https://github.com/skibitsky/alfred-timing) - 与互动 [Timing](https://timing应用程序.com/) 应用程序.
- [Todoist](https://github.com/moranje/alfred-workflow-todoist) - 添加任务到Todoist.
...
- [Kaomoji](https://github.com/vinkla/alfred-kaomoji) - 从文本中找到相关的颜文字.
...
## Security
- [LastPass Vault Manager](https://github.com/bachya/lp-vault-manager) - 与 LastPass 保险库交互的工作流程.
- [Password Generator](https://github.com/deanishe/alfred-pwgen) - 可配置的离线密码生成器.
- [Random MAC](http://www.packal.org/workflow/random-mac) - 分配一个随机 MAC 地址给 `en0`（例如免费 wifi）.
...
- [Finder New item](https://github.com/danielbayley/alfred-finder-new-item) - 在支持模板的 Finder 中快速创建新项目.
- [Fkill](https://github.com/SamVerschueren/alfred-fkill) - 出色地搜索和终止进程.
- [Keyboard Maestro](https://github.com/iansinnott/alfred-maestro) - 执行来自 Alfred 的 Keyboard Maestro 宏.
- [Keylue](https://github.com/zhaocai/alfred2-keylue-workflow) - Key Clue、菜单栏和 Keyboard Maestro 热键搜索
...
- [TemporaryMute](http://www.packal.org/workflow/temporary-mute) - 在指定的时间内将计算机的音量静音.
...
- [Alfy](https://github.com/sindresorhus/alfy) - Node.js 库可轻松创建 Alfred 工作流.
- [AwGo](https://github.com/deanishe/awgo) - 用于 Go 的全功能库，可快速构建闪电般快速的工作流程.
- [Fuzzy Search](https://github.com/deanishe/alfred-fuzzy) - 将模糊搜索添加到任何脚本过滤器.
- [OneUpdater](https://github.com/vitorgalvao/alfred-workflows/tree/master/OneUpdater) - 将自动更新添加到您的工作流程中的最小配置方法.

## Other Lists
这里有一个有用的 alfred collections 的其他集合的列表.
...
在法律允许的范围内， [Daniel Pittman (SlippyCheeze)](https://github.com/slippycheeze) 已放弃该作品的所有版权和相关或邻接权.
