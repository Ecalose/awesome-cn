...
* [d-SEAMS](https://github.com/d-SEAMS/seams-core)  - 使用 Nix 的 C++ 和 Lua 分子动力学轨迹分析引擎. 它是 Deferred Structural Elucidation Analysis for Molecular Simulations 的缩写.  [通用公共许可证] [website](https://dseams.info)
...
* [robin-hood-hashing](https://github.com/martinus/robin-hood-hashing)  - 基于 C++14 的罗宾汉哈希的快速和内存高效哈希表.  [麻省理工学院]
...
* [toy engine](https://github.com/hugoam/toy) - toy 是一个精简和模块化的 c++ 游戏引擎，提供简单的表达性 c++ 习语，以快速迭代设计功能齐全的 2D 或 3D 游戏.
...
* [ONNX runtime](https://github.com/microsoft/onnxruntime)  - 用于训练和推理 ONNX 模型的 C 和 C++ 库.  ONNX 是 AI 模型可以转换成的标准，无论它们使用哪个库进行训练.  [麻省理工学院] [website](https://onnxruntime.ai/)
...
* [Boost.Beast](https://github.com/boostorg/beast)  :zap: - HTTP 和 WebSocket 在 C ++ 11 中基于 Boost.Asio 构建.  [BSL-1.0] [website](https://www.boost.org/libs/beast)
...
* [Restinio](https://github.com/Stiffstream/restinio)  - 一个仅包含标头的 C++14 库，可为您提供嵌入式 HTTP/Websocket 服务器.  [BSD]
...
* [H2O](https://github.com/h2o/h2o)  - 支持 HTTP/1.x 和 HTTP/2 的优化 HTTP 服务器. 它也可以用作图书馆.  [麻省理工学院]
...
* [Muduo](https://github.com/chenshuo/muduo)  - 用于 Linux 中多线程服务器的 C++ 非阻塞网络库.  [BSD]
...
* [Proxygen](https://github.com/facebook/proxygen)  - Facebook 的 C++ HTTP 库集合，包括易于使用的 HTTP 服务器.  [BSD]
...
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus)  - 多平台 C++ 网络嗅探和数据包解析和制作框架.  [未授权]
...
* [PoDoFo](http://podofo.sourceforge.net/)  - 处理 PDF 文件格式的库.  [LGPL]
...
* [Box2D](https://github.com/erincatto/Box2D)  - 用于游戏的 2D 物理引擎.  [类 BSD]
...
* [LiquidFun](https://github.com/google/liquidfun)  - 用于游戏的 2D 物理引擎.  [类 BSD]
...
* [ofxBox2d](https://github.com/vanderlin/ofxBox2d)  - Box2D 的 openFrameworks 包装器.  [类 BSD]
...
* [SOFA](https://github.com/sofa-framework/sofa)  - SOFA是一个以实时仿真为目标的开源框架，侧重于医学仿真.  [LGPL] [website](https://www.sofa-framework.org)

## Reflection

* [config-loader](https://github.com/netcan/config-loader)  - 一个 C++17 静态反射框架，从解析配置文件到本地数据结构.  [麻省理工学院]
...
* [visit_struct](https://github.com/cbeck88/visit_struct)  - 用于 C++ 中结构域反射的微型库.  [BSL-1.0]
...
* [Hyperscan](https://github.com/intel/hyperscan)  - Hyperscan 是 Intel 的高性能多正则表达式匹配库. 提供大量正则表达式（最多数万）的同时匹配. 通常用于 DPI 库堆栈.  [BSD]
* [Oniguruma](https://github.com/kkos/oniguruma)  - 现代且灵活的正则表达式库，支持多种字符编码.  [BSD]
...
* [sregex](https://github.com/openresty/sregex)  - 一个非回溯的基于 NFA/DFA 的 Perl 兼容的正则表达式引擎库，用于匹配大数据流.  [BSD]
...
* [Robotics Library (RL)](http://www.roboticslibrary.org/)  - 用于机器人运动学、运动规划和控制的独立 C++ 库.  [BSD]
* [RobWork](https://gitlab.com/sdurobotics/RobWork)  - 用于机器人系统仿真和控制的 C++ 库的集合.  [阿帕奇2] [website](http://www.robwork.dk/)
...
* [AMGCL](https://github.com/ddemidov/amgcl)  - 用于使用代数多重网格求解大型稀疏线性系统的仅标头 C++ 库.  [麻省理工学院]
* [FFTW](http://www.fftw.org/)  - 用于计算一维或多维 DFT 的 AC 库.  [通用公共许可证]
* [GSL](http://www.gnu.org/software/gsl/)  - GNU 科学图书馆.  [通用公共许可证]
* [preCICE](https://github.com/precice/precice)  - 用于分区多物理仿真（FSI、CHT 等）的耦合库.  [LGPL] [website](https://precice.org/)
* [TileDB](https://github.com/TileDB-Inc/TileDB)  - 快速密集和稀疏多维数组 DBMS.  [麻省理工学院] [website](https://tiledb.io/)
* [Trilinos](https://github.com/trilinos/Trilinos)  - 高性能 PDE 求解器.  [BSD]
* [Torch](https://github.com/torch/torch7)  - 广泛支持机器学习算法的科学计算框架，将 GPU 放在首位.  [BSD-3-条款] [website](http://torch.ch/)
...
* [SIP](https://riverbankcomputing.com/software/sip/intro)  - Python v2 和 v3 的 C 或 C++ 绑定生成器.  [通用公共许可证]
...
* [V8](https://v8.dev)  - Google 的快速 JavaScript 引擎，可以嵌入到任何 C++ 应用程序中.  [BSD]
...
* [cppcodec](https://github.com/tplgy/cppcodec)  - 仅标头的 C++11 库使用一致、灵活的 API 编码/解码 base64、base32 和 hex.  [麻省理工学院]
...
* [FlatBuffers](https://github.com/google/flatbuffers)  - 内存高效的序列化库.  [阿帕奇2]
* [MessagePack](https://github.com/msgpack/msgpack-c)  - 用于 C 和 C++ 的高效二进制序列化格式“类似于 JSON”.  [阿帕奇2] [website](http://msgpack.org/)
* [mrpt-serialization](https://github.com/mrpt/mrpt/)  - 二进制或文本格式的版本序列化.  [BSD] [website](https://docs.mrpt.org/reference/latest/group_mrpt_serialization_grp.html)
...
* [pdqsort](https://github.com/orlp/pdqsort)  - 模式失败的快速排序.  [zlib]
* [Timsort](https://github.com/gfx/cpp-TimSort)  - 一个模板化的稳定排序函数，它优于基于快速排序的算法，包括 std::sort，用于反向或半排序数据.  [麻省理工学院]
* [Indiesort](https://github.com/mattreecebentley/plf_indiesort)  - 一个排序包装器，它允许将 std::sort （和其他随机访问排序函数）与非随机访问容器一起使用，并且还提高了随机访问容器中大型/非平凡可复制类型的排序性能和阵列.  [zLib] [website](https://plflib.org/indiesort.htm)
...
* [Vireo](https://github.com/twitter/vireo/)  - Twitter 的轻量级多功能视频处理库.  [麻省理工学院]

## Virtual Machines

* [CarpVM](https://github.com/tekknolagi/carp)  - C 中“有趣的”VM.让我们看看这是怎么回事.  [GPLv3]
...
* [facil.io](https://github.com/boazsegev/facil.io)  - 支持 HTTP、WebSockets、SSE 等的事件式高性能 C Web 框架.  [麻省理工学院] [website](http://facil.io)
* [Kore](https://kore.io/) - 超快速和灵活的网络服务器/用 C 语言开发的网络应用程序框架. [ISC]
* [libOnion](http://www.coralbits.com/libonion/)  - 帮助您用 C 编程语言创建网络服务器的轻量级库.  [LGPLv3]
* [lwan](https://github.com/lpereira/lwan)  - 实验性的、可扩展的、高性能的 HTTP 服务器.  [GPL2]
* [oat++](https://github.com/oatpp/oatpp)  - 用于创建高性能 Web 服务的轻型、零依赖框架.  [Apache-2.0] [website](https://oatpp.io/)
* [Pistache](http://pistache.io/)  - Pistache 是一个用纯 C++11 编写的 C++ REST 框架，没有外部依赖.  [阿帕奇2]
* [QDjango](https://github.com/jlaine/qdjango/)  - 一个用 C++ 编写并构建在 Qt 库之上的 Web 框架. 在可能的情况下，它会尝试遵循 django 的 API，因此得名.  [LGPL]
...
* [userver](https://github.com/userver-framework/userver)  - 异步 C++17 框架，具有丰富的抽象和数据库驱动程序集，可快速轻松地创建高效的微服务、服务和实用程序.  [Apache-2.0] [website](https://userver.tech/)
* [Wt](http://www.webtoolkit.eu/wt)  - 用于开发 Web 应用程序的 C++ 库.  [GPL/商业]

## XML
 *XML 是废话. 真的. 没有任何借口.  XML 对人类来说很难解析，即使对计算机来说解析也是一场灾难. 没有理由存在那种可怕的废话.  - 莱纳斯·托沃兹*

* [Boost.PropertyTree](http://www.boost.org/doc/libs/1_55_0/doc/html/property_tree.html)  - 可用于解析 XML/JSON/INI/Info 文件的属性树解析器/生成器.  [促进]
* [Expat](http://www.libexpat.org/) - 用 C 语言编写的 XML 解析器库.[麻省理工学院]
...
* [RapidXml](http://rapidxml.sourceforge.net/)  - 尝试尽可能创建最快的 XML 解析器，同时保持可用性、可移植性和合理的 W3C 兼容性.  [促进]
...
* [mini-yaml](https://github.com/jimmiebergmann/mini-yaml)  - 单标头 YAML 1.0 C++11 序列化器/反序列化器.  [麻省理工学院]
* [yaml-cpp](https://github.com/jbeder/yaml-cpp) - C++ 中的 YAML 解析器和发射器 [MIT]
* [rapidyaml](https://github.com/biojppm/rapidyaml) - Rapid YAML 是一个 C++ 库，用于解析和发出 YAML [麻省理工学院]
...
* [Argon2](https://github.com/P-H-C/phc-winner-argon2)  - 密码哈希 Argon2，PHC 获胜者.  [CC0/Apache2]
* [Better String](http://bstring.sourceforge.net)  - C 的字符串库的替代品，功能更强大，并且没有缓冲区溢出溢出问题. 还包括一个 C++ 包装器.  [BSD, GPL2]
* [Boost.Signals](http://www.boost.org/doc/libs/1_56_0/doc/html/signals.html)  - 托管信号和插槽系统的实现.  [促进]
* [Concord](https://github.com/Cogmasters/concord) - 用 C 编写的 Discord API 包装器库.[麻省理工学院] [website](https://cogmasters.github.io/concord)
* [CPPItertools](https://github.com/ryanhaining/cppitertools)  - 受 Python 内置函数和 itertools 库启发的基于范围的 for 循环附加组件.  [BSD-2-条款]
* [D++ (DPP)](https://github.com/brainboxdotcc/DPP)  - 用于创建 Discord Bots 的轻量级、高性能和可扩展的 C++ 库.  [阿帕奇2] [website](https://dpp.dev)
...
* [{fmt}](https://github.com/fmtlib/fmt)  :zap: - 用于 C++ 的小型、安全和快速的格式化库.  [简化的 BSD]
...
* [QtVerbalExpressions](https://github.com/VerbalExpressions/QtVerbalExpressions)  - 此 Qt 库基于 C++ VerbalExpressions 库.  [麻省理工学院]
...
* [jwt-cpp](https://github.com/Thalhammer/jwt-cpp)  - 用于在 C++ 中创建和验证 JSON Web 令牌的仅标头库.  [麻省理工学院]
...
* [libusb](https://libusb.info/)  - 一个通用 USB 库，允许对 USB 设备进行便携式访问.  [LGPL2]
...
* [value-category-cheatsheet](https://github.com/jeaye/value-category-cheatsheet) 左值、右值等的 PDF 备忘单.  [简版左版]
* [VarTypes](https://github.com/szi/vartypes)  - 一个功能丰富的面向对象的框架，用于管理 C++/Qt4 中的变量.  [LGPL]
* [ZBar](http://zbar.sourceforge.net/)  - 条码扫描器库，允许扫描照片/图像/视频流中的条码并返回它们的值.  [LGPL2]
* [ZXing](https://github.com/zxing/zxing/)  - 一个用 Java 实现的开源、多格式 1D/2D 条形码图像处理库，具有其他语言的端口.  [阿帕奇]
* [pprint](https://github.com/p-ranav/pprint)  - 适用于现代 C++ 的漂亮打印机.  [麻省理工学院]
* [pspsdk](https://github.com/pspdev/pspsdk)  - 用于 PSP 自制软件开发的开源 SDK.  [BSD/GNU GPL3]
...
* [8cc](https://github.com/rui314/8cc) - 一个小型 C 编译器.
* [c](https://github.com/ryanmjacobs/c)  - 一次编译并执行 C“脚本”！  [麻省理工学院]
* [Clang](http://clang.llvm.org/)  - 用于 LLVM 的 AC 编译器. 支持 C++11/14/1z C11. 由 LLVM 团队开发.  [国家安全局]
...
* [LLVM](http://llvm.org/) - 模块化和可重复使用的编译器和工具链技术的集合.
...
* [Open WatCom](https://github.com/open-watcom)  - Watcom C、C++ 和 Fortran 交叉编译器和工具.  [Sybase Open Watcom 公共许可证]
* [Oracle Solaris Studio](http://www.oracle.com/technetwork/server-storage/solarisstudio/overview/index.html)  - 适用于 SPARC 和 x86 的 C、C++ 和 Fortran 编译器. 支持 C++11. 在 Linux 和 Solaris 上可用.  [OTN 开发者许可证]
...
* [Ideone](http://ideone.com/) - 在线编译器和调试工具，允许您编译源代码并在线执行 60 多种编程语言.
* [repl.it](https://repl.it) - 面向教育工作者、学习者和开发人员的强大而简单的工具和平台.
* [Rextester](http://rextester.com/runcode) - 提供多种编译器（Clang、GCC、MSVC）和多种编辑器的在线编译器.
* [Try It Online](https://tio.run/) - TIO 是一个在线解释器系列，适用于不断增长的实用和娱乐编程语言列表.
* [Wandbox](http://melpon.org/wandbox/) - 带有 Boost 的在线 Clang/GCC 编译器.
* [paiza.io](https://paiza.io/en) - 一个在线 C/C++ 编译器，具有多文件支持功能、Github(gist) 集成和协作编辑.
...
* [Metashell](https://metashell.readthedocs.org) - 一个交互式模板元编程 shell，其中包括 MDB 元调试器.
...
* [color_coded](https://github.com/jeaye/color_coded)  - 用于基于 libclang 的突出显示的 vim 插件.  [麻省理工学院]
...
* [Embarcadero Dev-CPP](https://github.com/Embarcadero/Dev-Cpp)  - 预装了新主题和现代编译器的 Dev-C++ 分支.  [GPLv2] [website](https://www.embarcadero.com/free-tools/dev-cpp)
...
* [Microsoft Visual Studio](https://www.visualstudio.com/) - Microsoft 的 IDE.
* [Microsoft Visual Studio Code](https://code.visualstudio.com/)  :zap: - 来自 Microsoft 的开源 IDE.  [麻省理工学院]
* [NetBeans](https://netbeans.org/) - 一个主要使用 Java 进行开发的 IDE，但也可以使用其他语言进行开发，尤其是 PHP、C/C++ 和 HTML5.
...
* [YouCompleteMe](https://github.com/ycm-core/YouCompleteMe) - YouCompleteMe 是 Vim 的一个快速的、键入时模糊搜索代码完成引擎.
...
* [MesonBuild](http://mesonbuild.com) - 一个开源构建系统意味着速度非常快，更重要的是，它尽可能对用户友好.
* [Ninja](https://ninja-build.org/) - 一个专注于速度的小型构建系统.
* [Scons](http://www.scons.org/) - 一个用Python脚本配置的软件构建工具.
* [Sconsolidator](http://www.sconsolidator.com/) - Scons build system integration for Eclipse CDT.
* [Spack](https://spack.io/)  - 一个灵活的包管理器，支持多个版本、配置、平台和编译器.  [Apache-2.0/麻省理工学院]
...
* [Premake](http://premake.github.io) - 配置有 Lua 脚本的工具，用于为 Visual Studio、GNU Make、Xcode、Code::Blocks 等跨 Windows、Mac OS X 和 Linux 生成项目文件.
...
* [Cppcheck](http://cppcheck.sourceforge.net/)  - 静态 C/C++ 代码分析工具.  - [source](https://github.com/danmar/cppcheck)
* [CppDepend](https://www.cppdepend.com/) - 通过分析和可视化代码依赖性、定义设计规则、进行影响分析以及比较不同版本的代码，简化管理复杂的 C/C++ 代码库.
...
* [IKOS](https://github.com/NASA-SW-VnV/ikos)  - 基于抽象解释理论的C/C++静态分析器.  [NOSA 1.3]
...
* [Free C++ Books](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-langs.md#cpp) - vhf/免费编程书籍/C++.
...
* [C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines) - “官方”C++ 指南集，由 C++ 作者审阅.
* [C++ Dos and Don'ts](http://www.chromium.org/developers/coding-style/cpp-dos-and-donts) - Chromium 项目 &gt; 面向开发人员 &gt; 编码风格 &gt; C++ 的注意事项.
* [google-styleguide](https://github.com/google/styleguide) - 谷歌发起的开源项目的风格指南.
...
* [高清 C 编程教程 [高清]](https://www.youtube.com/playlist?list=PLCB9F975ECF01953C) - 面向初学者和新程序员的详细 C 编程语言教程集.
* [C++](https://www.youtube.com/playlist?list=PL2F919ADECA5E39A6) - 来自 VoidRealms.
* [C++ Qt Programming](https://www.youtube.com/playlist?list=PL2D1942A4688E9D63) - 来自 VoidRealms.
...
* [C++ Programming Tutorials from thenewboston](https://www.youtube.com/playlist?list=PLF541C2C1F671AEF6) - 这些都是 thenewboston 的 C++ 编程教程.
...
* [C++ Hints](http://cpphints.com/) - 每个工作日都会提示 PVS-Studio 团队最常见的 C++ 错误以及解决这些错误的方法.
* [C++ tutorial](https://hackr.io/tutorials/learn-c-plus-plus) - 一个用户排名的在线教程银行站点，显示多个课程以学习 C++.
