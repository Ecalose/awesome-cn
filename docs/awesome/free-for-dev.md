...
## Source Code Repos
  ...
  * [GitHub](https://github.com/)  — 无限的公共存储库和无限的私有存储库（有无限的合作者）. 除此之外，提供的其他一些免费服务（还有更多，但我们在这里列出主要的）是：
       ...
       - [Codespaces](https://github.com/codespaces)  - 托管在云中的开发环境. 每月免费提供 120 个核心小时.
...
## APIs, Data and ML
  ...
  * [Data Fetcher](https://datafetcher.com)  - 无需代码即可将 Airtable 连接到任何应用程序或 API. 类似 Postman 的接口，用于在 Airtable 中运行 API 请求. 与数十个应用程序的预构建集成. 免费计划包括每月 100 次运行.
  ...
  * [PromptLoop](https://www.promptloop.com/)  - 使用 AI 和 GPT-3 等大型语言模型和一个简单的电子表格公式来转换、理解和分析 Google 表格中的文本. 每月前 2,000 个积分免费.
  ...
  * [Webhook Store](https://www.openwebhook.io)  - 用于存储第三方 webhook 并在 localhost 上调试它们的工具（ngrok 风格）. 开源和自托管. 免费的个人域 *username*.github.webhook.store，免费的公共域 *anything*.webhook.store. 
  ...
  * [Volca](https://volca.io#api)  - 免费 API 提供技术列表，例如编程语言和数据库系统. 无限制的免费请求.
...
## Tools for Teams and Collaboration
  ...
  * [Hackmd.io](https://hackmd.io/)  - 用于降价格式文档/文件的实时协作和编写工具. 与 GoogleDocs 类似，但用于降价文件. 免费无限数量的“笔记”，但私人笔记和模板的协作者（被邀请者）数量 [will be limited](https://hackmd.io/pricing).
  ...
  * [Rocket.Chat](https://rocket.chat/) - 具有全渠道功能、矩阵联盟、与其他应用程序桥接、无限消息传递和完整消息传递历史记录的开源通信平台.
...
## CI and CD
  ...
  * [Make](https://www.make.com/en)  — 工作流程自动化工具，可让您使用 UI 连接应用程序并自动化工作流程，它支持许多应用程序和最流行的 API. 公共 GitHub 存储库免费，免费层级为 100 Mb、1000 次操作和 15 分钟的最小间隔.
...
## Security and PKI
  ...
  * [CyberChef](https://gchq.github.io/CyberChef/)  — 一个简单、直观的网络应用程序，用于分析和解码/编码数据，而无需处理复杂的工具或编程语言. 就像一把密码学和加密的瑞士军刀. 所有功能都可以免费使用，没有限制. 开源，如果你想自托管.
  ...
  * [Escape GraphQL Quickscan](https://escape.tech/)  - 一键安全扫描您的 GraphQL 端点. 免费，无需登录.
...
## Authentication, Authorization and User Management
  ...
  * [ZITADEL Cloud](https://zitadel.com)  — 适用于您并支持多租户 (B2B) 用例的统包式用户和访问管理. 免费提供多达 25,000 个经过身份验证的请求，并具有所有安全功能（OTP、无密码、策略等没有付费墙）.
...
## Monitoring
  ...
  * [appspector.com](https://appspector.com/)  - 任务控制，用于远程 iOS/Android/Flutter 调试. 免费用于小流量使用（64MB 日志）.
...
## Search
  ...
  * [CommandBar](https://www.commandbar.com/)  - 统一的搜索栏即服务，基于 Web 的 UI 小部件/插件，允许您的用户在您的产品中搜索内容、导航、功能等，这有助于提高可发现性. 免费提供多达 1000 名每月活跃用户，无限命令.
...
## Email
  ...
  * [Tutanota](https://tutanota.com/)  - 内置端到端加密、无广告、无跟踪的免费安全电子邮件帐户服务提供商. 免费 1GB 存储空间. 这也部分 [open source](https://github.com/tutao/tutanota)，因此您可以选择自托管.
...
## BaaS
  ...
  * [pusher.com](https://pusher.com/beams)  — 为 2000 名每月活跃用户提供免费、无限制的推送通知. 适用于 iOS 和 Android 设备的单一 API.
   * [engagespot.co](https://engagespot.co/)  — 开发人员的通知基础设施. 每月最多 100 位活跃用户免费.
...
## Domain
  ...
  * [Dee.al](https://domain.dee.al) — 免费 .dee.al、.gal.aw、.devz.id 即时域，适用于您的博客网站和其他，享受
...
## IaaS
  ...
  * [Storj](https://storj.io/)  — 用于应用程序和开发人员的去中心化私有云存储. 免费计划每月提供 1 个项目、150 GB 存储空间、150 GB 带宽.
...
## DBaaS
   ...
   * [codehooks.io](https://codehooks.io/)  — JavaScript 无服务器 API/后端和数据库服务，具有功能、Mongdb-ish 查询、键/值查找、作业系统和消息队列. 每个项目免费 1 个实例，每月免费 5000 条记录和 5000 次调用，包括 3 名开发人员. 无需信用卡.
   ...
   * [Planetscale](https://planetscale.com/) - PlanetScale 是一个 MySQL 兼容的无服务器数据库平台，由 Vitess 提供支持，1 个免费数据库，1 个生产分支和 1 个开发分支，5GB 存储，每个数据库每月读取 10 亿行，每个数据库每月写入 1000 万行.
   * [YugabyteDB](https://cloud.yugabyte.com)  - YugabyteDB 是一个与 PostgresSQL 兼容的分布式 SQL 数据库. 云免费层是 2 个 vCPU、4GB RAM、10GB 磁盘.
   * [filess.io](https://filess.io) - files.io 是一个平台，您可以在其中免费创建以下 DBMS 的 1 个数据库：MySQL、MariaDB、MongoDB、PostgreSQL.
...
## Storage and Media Processing
   ...
   * [AndroidFileHost](https://androidfilehost.com/) - 具有无限速度、带宽、文件数、下载数等的免费文件共享平台.主要针对 Android 开发相关文件，如 APK 构建、自定义 ROM 和修改等.但似乎也接受任何其他文件.
   ...
   * [GoFile.io](https://gofile.io/)  - 免费的文件共享和存储平台，可通过基于 Web 的 UI 和 API 使用. 文件大小、带宽、下载次数等不受限制.但是当文件变为非活动状态（超过 10 天没有下载）时，它将被删除.
...
## Design and UI
  ...
  * [Branition](https://branition.com/colors) - 最适合品牌的手工策划彩色托盘.
...
## IDE and Code Editing
   ...
   * [GitPod](https://www.gitpod.io)  — 用于 GitHub 项目的即时、可编写代码的开发环境. 免费套餐包括 50 小时/月.
...
## Game Development
  ...
  * [3DModelsCC0](https://www.3dmodelscc0.com/) - 为游戏开发制作的公共领域 3D 模型库.
