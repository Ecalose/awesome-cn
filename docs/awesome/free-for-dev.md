...
## APIs, Data and ML
  ...
  * [Frontend Zero to One](https://www.fezto.xyz/)  — 根据您的 OpenAPI 或 Swagger 规范立即启动应用程序，了解合作伙伴如何体验您的 API. 自由. 定制和代码的付费层.
  ...
  * [Query.me](https://query.me)  - 以类似脚本的方式执行的协作数据笔记本，允许通过 SQL、API 和越来越多的自定义块（如 Slack 和电子邮件）获取和发送数据. 小型团队免费.
...
## Tools for Teams and Collaboration
  ...
  * [vadoo.tv](https://vadoo.tv/)  — 视频托管和营销变得简单. 单击一下即可上传视频. 记录、管理、共享等. 免费层提供最多 10 个视频、1 GB 存储空间、10 GB 带宽/月
  ...
  * [shtab.app](https://shtab.app/) - 项目管理服务，通过基于 AI 的跟踪器实现办公室协作和远程透明化.
...
## Security and PKI
  ...
  * [Bridgecrew](https://bridgecrew.io/) — Infrastructure as code (IaC) security powered by the open source tool - [Checkov](https://github.com/bridgecrewio/checkov) . 核心 Bridgecrew 平台免费提供多达 50 个 IaC 资源.
...
## Authentication, Authorization and User Management
  ...
  * [PropelAuth](https://propelauth.com) — A 通过几行代码立即销售给任何规模的公司，免费提供多达 200 名用户和 10k 交易电子邮件（带有水印品牌：“由 PropelAuth 提供支持”）.
...
## Messaging and Streaming
  ...
  * [connectycube.com](https://connectycube.com)  - 无限聊天消息、p2p 语音和视频通话、文件附件和推送通知.  MAU 高达 20K 的应用免费.
...
## Email
  ...
  * [mailboxlayer.com](https://mailboxlayer.com/)  — 开发人员的电子邮件验证和验证 JSON API.  100 个免费 API 请求/月
  ...
  * [Tutanota](https://tutanota.com/) - Free secure email account service provider with built-in end-to-end encryption, no ads, no tracking. Free 1GB storage. Which also partially [open source](https://github.com/tutao/tutanota)，因此您可以选择自托管.
...
## BaaS
  ...
  * [hasura.io](https://hasura.io/)  — Hasura 扩展您现有的数据库，无论它位于何处，并提供一个即时的 GraphQL API，可以为 Web、移动和数据集成工作负载安全访问. 每月 1GB 的数据直通免费.
...
## Domain
  ...
  * [Open Domains](https://open-domains.net) - 个人网站、开源项目等的免费子域.
  ...
  * [is-an.app & 1bt.uk](https://github.com/tarampampam/free-domains) - 免费的 .is-an.app 和 .1bt.uk 子域（支持通配符、A、NS、AAAA、CNAME、TXT 记录）.
...
## Issue Tracking and Project Management
   ...
   * [Ilograph](https://www.ilograph.com/)   — 允许用户从多个角度和详细程度查看其基础架构的交互式图表. 图表可以用代码表示. 免费层有无限的私人图表，最多 3 个查看者.
...
## Design and UI
  ...
  * [designer.io](https://www.designer.io/)  — 用于 UI、插图等的设计工具. 有一个本机应用程序. 自由.
...
## Miscellaneous
  ...
  * [PDFMonkey](https://www.pdfmonkey.io/)  — 在仪表板中管理 PDF 模板，使用动态数据调用 API，下载您的 PDF. 每月提供 300 个免费文件.
