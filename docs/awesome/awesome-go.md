 ...
 **Awesome Go 没有月费**_，但我们有员工 **努力工作** 保持运行. 筹到的钱，可以回报每一个人的付出！ 您可以看到我们如何计算我们的计费和分配，因为它对整个社区开放. 想成为项目的支持者点击 [here](https://github.com/avelino/awesome-go/blob/master/mailto:avelinorun+oss@gmail.com?subject=awesome-go%3A%20project%20support)._
...
- [authboss](https://github.com/volatiletech/authboss)  - 用于网络的模块化身份验证系统. 它试图尽可能多地删除样板文件和“困难的东西”，这样每次你在 Go 中启动一个新的 Web 项目时，你都可以插入、配置它并开始构建你的应用程序，而不必每次都构建身份验证系统.
...
- [casbin](https://github.com/hsluoyz/casbin) - 授权库，支持 ACL、RBAC 和 ABAC 等访问控制模型.
...
- [jwt](https://github.com/cristalhq/jwt) - 用于 Go 的安全、简单、快速的 JSON Web 令牌.
...
- [telebot](https://github.com/tucnak/telebot) - Telegram bot 框架是用 Go 编写的.
...
- [Bitcask](https://git.mills.io/prologic/bitcask) - Bitcask 是一个可嵌入、持久且快速的键值 (KV) 数据库，使用纯 Go 编写，具有可预测的读/写性能、低延迟和高吞吐量，这要归功于 bitcask 磁盘布局 (LSM+WAL).
...
- [go-anytime](https://github.com/ijt/go-anytime) - 解析日期/时间，如“下一个 12 月 22 日下午 3 点”和“从今天到下个星期四”等范围，而无需提前知道格式.
...
- [Kitex](https://github.com/cloudwego/kitex)  - 一个高性能和强扩展性的 Golang RPC 框架，帮助开发者构建微服务. 如果您在开发微服务时主要关注性能和可扩展性，那么 Kitex 可能是一个不错的选择.
...
- [Ebitengine](https://github.com/hajimehoshi/ebiten) - Go 中死的简单 2D 游戏引擎.
...
- [go-workerpool](https://github.com/zenthangplus/go-workerpool) - 受 Java 线程池启发，Go WorkerPool 旨在控制繁重的 Go 例程.
...
- [routine](https://github.com/timandy/routine)  - `routine` 是 go 库的 `ThreadLocal`. 它封装并提供了一些易于使用、非竞争性、高性能的`goroutine`上下文访问接口，可以帮助你更优雅地访问协程上下文信息.
...
- [Wails](https://wails.io) - 使用内置 OS HTML 渲染器的带有 HTML UI 的 Mac、Windows、Linux 桌面应用程序.
...
- [mob](https://github.com/erni27/mob)  - mob 是一个基于泛型的简单中介器/事件聚合器库. 它支持进程内请求/事件处理.
...
- [caps](https://github.com/chanced/caps) - 案例转换库.
...
- [bun](https://github.com/uptrace/bun)  - SQL-first Golang ORM.  go-pg 的继任者.
...
- [gup](https://github.com/nao1215/gup) - 更新“go install”安装的二进制文件.
...
- [go-instrument](https://github.com/nikolaydubina/go-instrument) - 自动为所有方法和函数添加跨度.
...
- 测试框架
  ...
  - [diff](https://github.com/terrastruct/diff) - 漂亮的 Git 风格差异，可以轻松比较预期与实际.
...
- [go-recipe](https://github.com/kkyr/go-recipe) - 从网站上抓取食谱的软件包.
...
- [swag](https://github.com/zc2638/swag)  - 没有评论，简单的 go 包装器来创建兼容 swagger 2.0 的 API. 支持大部分路由框架，如内置、gin、chi、mux、echo、httprouter、fasthttp等.
...
- [graterm](https://github.com/skovtunenko/graterm) - 提供原语以在 Go 应用程序中执行有序（顺序/并发）GRAceful TERMination（又名关闭）.
...
- [scan](https://github.com/wroge/scan) - 将 sql 行扫描成任何由泛型提供支持的类型.
...
- [cli](https://gitlab.com/gitlab-org/cli) - 一个开源 GitLab 命令行工具，将 GitLab 的酷炫功能带入您的命令行.
...
- [echo-middleware](https://github.com/faabiosr/echo-middleware) - 带有日志和指标的 Echo 框架的中间件.
...
- [Fleet device management](https://github.com/fleetdm/fleet) - 用于服务器和工作站的轻量级、可编程遥测.
...
- [Creative DIY Microcontroller Project With TinyGo and WebAssembly](https://www.packtpub.com/product/creative-diy-microcontroller-projects-with-tinygo-and-webassembly/9781800560208) - 介绍涉及 Arduino 和 WebAssembly 的项目的 TinyGo 编译器.
...
- [Explore Go Libraries & Projects](https://kandi.openweaver.com/explore/go) - 在 kandi 上发现并查找热门和新 Go 库、顶级作者、趋势项目工具包、讨论、教程和学习资源的精选列表.
